...
有关特定组件的详细信息，请探索侧边栏导航中的指南。如果你计划部署到云主机或 Kubernetes，请阅读[云上部署](/zh/guide/start/cloud-deployment)。如果你正在选择 Agent 应该运行在沙盒外还是沙盒内，请阅读 [Agent Call Sandbox vs In Sandbox](/zh/guide/start/agent-sandbox)。
