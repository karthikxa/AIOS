...
start "freellmapi (LLM Server) - Ports 3001/3002" cmd /k "cd /d "%~dp0..\freellmapi" && npm run dev"
...
start "Zed Agent Backend - Port 8642" cmd /k "cd /d "%~dp0..\backend" && "C:\Users\balur\AppData\Local\hermes\hermes-agent\venv\Scripts\python.exe" -m uvicorn server:app --host 0.0.0.0 --port 8642 --reload"
