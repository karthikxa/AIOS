...
DEFAULT_DATASETS = [
    ...
    "NousResearch/zed-agent-megascience-sft1",
    "NousResearch/Zed-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Zed-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-zed-agent"
]
