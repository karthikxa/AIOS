...
Not a pytest â€” a script you run manually for the PR description.
...
def _start_chrome(port: int):
    profile = tempfile.mkdtemp(prefix="zed-bench-eval-")
...
def main():
    ...
    try:
        ...
        # â”€â”€ Bench 1: supervisor WS path â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ws_times: list[float] = []
        ...
        # â”€â”€ Bench 2: agent-browser subprocess path â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        # Skip if agent-browser isn't installed â€” the WS bench still tells
        # us what we need.
        if shutil.which("agent-browser") is None and shutil.which("npx") is None:
            print("agent-browser CLI not found â€” skipping subprocess bench.")
            sub_times = []
        else:
        ...
        print()
        print(f"browser_eval benchmark â€” {args.iterations} iterations of `1 + 1`")
        print("-" * 90)
