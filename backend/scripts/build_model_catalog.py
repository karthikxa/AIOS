#!/usr/bin/env python3
"""Build the Zed Model Catalog â€” a centralized JSON manifest of curated models.
...
Zed CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Zed release.
...
manifest in sync â€” not a source of truth.
...
# Ensure ZED_HOME is set for imports that touch it at module level.
os.environ.setdefault("ZED_HOME", os.path.join(os.path.expanduser("~"), ".zed"))

from zed_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
