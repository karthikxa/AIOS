...
"platform android is not supported" â€” even though psutil compiles fine
...
def main() -> int:
    ...
    print(
        "â†’ Termux/Android: prebuilding psutil with Linux source path "
    ...
    print("âœ“ psutil installed via Android compatibility shim")
    return 0
