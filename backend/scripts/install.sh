...
# Configuration
REPO_URL_SSH="git@github.com:zedteam/zed-agent.git"
REPO_URL_HTTPS="https://github.com/zedteam/zed-agent.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://zed-agent.zedteam.com/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
