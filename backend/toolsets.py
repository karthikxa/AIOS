...
TOOLSETS = {
    ...
    "swarm": {
        "description": "10 multi-agent orchestration patterns powered by delegate_task sub-agents",
        "tools": [
            "concurrent_swarm", "sequential_swarm", "hierarchical_swarm",
            "agent_rearrange_swarm", "graph_swarm", "mixture_of_agents_swarm",
            "group_chat_swarm", "heavy_swarm", "forest_swarm", "swarm_router",
    ...
    "coding": {
        ...
        # non-configurable-toolset recovery loop in zed_cli/tools_config.py).
        "posture": True,
    },
    ...
    "zed-cron": {
        ...
        "description": "Default cron toolset - same core tools as zed-cli; gated by `zed tools`",
        "tools": _ZED_CORE_TOOLS,
        "includes": []
    },
    ...
    "zed-email": {
        "description": "Email bot toolset - interact with Zed via email (IMAP/SMTP)",
        "tools": _ZED_CORE_TOOLS,
        "includes": []
    },
    ...
    "zed-sms": {
        "description": "SMS bot toolset - interact with Zed via SMS (Twilio)",
        "tools": _ZED_CORE_TOOLS,
        "includes": []
    },
    ...
    "zed-gateway": {
        ...
        "tools": [],
        "includes": ["zed-telegram", "zed-discord", "zed-whatsapp", "zed-slack", "zed-signal", "zed-bluebubbles", "zed-homeassistant", "zed-email", "zed-sms", "zed-mattermost", "zed-matrix", "zed-dingtalk", "zed-feishu", "zed-wecom", "zed-wecom-callback", "zed-weixin", "zed-qqbot", "zed-webhook", "zed-yuanbao"]
    }
}
        ...
        if include_registry and name.startswith("zed-"):
            ...
            try:
                ...
                if platform_registry.is_registered(platform_name):
                    plugin_tools = set(_ZED_CORE_TOOLS)
                    try:
                        from tools.registry import registry
                        plugin_tools.update(
