...
is_interrupted() which checks the CURRENT thread â€” no argument needed.
...
# Opt-in debug tracing â€” pairs with ZED_DEBUG_INTERRUPT in
...
def is_interrupted() -> bool:
    ...
    Safe to call from any thread â€” each thread only sees its own
    interrupt state.
    """
...
class _ThreadAwareEventProxy:
    ...
    def wait(self, timeout: float | None = None) -> bool:
        """Not truly supported â€” returns current state immediately."""
        return self.is_set()
