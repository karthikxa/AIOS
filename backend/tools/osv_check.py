...
(MAL-* IDs).  Regular CVEs are ignored â€” only confirmed malware is blocked.
...
def check_package_for_malware(
    ...
    if not ecosystem:
        return None  # not npx/uvx â€” skip
    ...
    try:
        ...
        # Fail-open: network errors, timeouts, parse failures â†’ allow
...
def _query_osv(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "zed-agent-osv-check/1.0",
        },
        method="POST",
    )
    ...
    # Only malware advisories â€” ignore regular CVEs
