...
Dependencies (optional):
    ...
    or: pip install zed-agent[voice]
"""
...
def detect_audio_environment() -> dict:
    ...
    # Docker/Podman container detection â€” honor host audio forwarding.
...
_TEMP_DIR = os.path.join(tempfile.gettempdir(), "zed_voice")
...
def check_voice_requirements() -> Dict[str, Any]:
    ...
    if not stt_enabled:
        ...
        details_parts.append(
            "STT provider: MISSING (uv pip install faster-whisper â€” "
