...
When running Zed inside Docker, the default `network_mode: host` gives the
...
The Zed [SECURITY.md](../../SECURITY.md) Â§2 defines the trust model. The
...
â”‚   â”‚ zed-agent â”‚   â”‚ zed-dashboard â”‚   â”‚
â”‚   â””â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”˜   â””â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜   â”‚
â”‚          â”‚                    â”‚              â”‚
â”‚          â–¼                    â”‚              â”‚
â”‚   â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”            â”‚              â”‚
â”‚   â”‚ zed-gtw   â”‚â—„â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜              â”‚
â”‚   â””â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”˜                           â”‚
â”‚          â”‚                                   â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
           â”‚
â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚  Docker Network: egress (internet-capable)   â”‚
â”‚          â”‚                                   â”‚
â”‚          â–¼                                   â”‚
â”‚   â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”                        â”‚
â”‚   â”‚ egress-proxy     â”‚â”€â”€â–º allowlisted hosts  â”‚
â”‚   â”‚ (squid / envoy)  â”‚                       â”‚
...
- **`internal`** â€” no default route, no internet access. The agent, dashboard,
  and gateway run here.
- **`egress`** â€” has internet access. Only services that need to reach external
...
#
# Usage:
#   ZED_UID=$(id -u) ZED_GID=$(id -g) docker compose up -d
#
...
services:
  gateway:
    ...
    environment:
      ...
      - NO_PROXY=zed,zed-dashboard,localhost
...
docker compose exec gateway \
  curl -sf --max-time 5 http://zed-dashboard:9119/health && echo "OK: internal reachable" || echo "FAIL"
...
- [SECURITY.md](../../SECURITY.md) â€” Zed trust model and vulnerability reporting
- [Terminal backends](../../README.md) â€” sandboxed execution targets
- [docker-compose.yml](../../docker-compose.yml) â€” default compose configuration
