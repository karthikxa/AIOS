...
This adapter lets Zed use the ``google-gemini-cli`` provider as if it were
...
# =============================================================================
# Request translation: OpenAI â†’ Gemini
# =============================================================================
    ...
    if isinstance(content, list):
        ...
        for p in content:
            if isinstance(p, str):
                ...
                # Multimodal (image_url, etc.) â€” stub for now; log and skip
...
def _translate_tool_call_to_gemini(tool_call: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        # Sentinel signature â€” matches opencode-gemini-auth's approach.
...
def _build_gemini_contents(
    ...
    for msg in messages:
        ...
        # Tool result message â€” emit a user-role turn with functionResponse
...
# =============================================================================
# Response translation: Gemini â†’ OpenAI
# =============================================================================
...
def _translate_gemini_response(
    ...
    for i, part in enumerate(parts or []):
        if not isinstance(part, dict):
            continue
        # Thought parts are model's internal reasoning â€” surface as reasoning,
...
def _translate_stream_event(
    ...
    fresh, unique OpenAI ``index`` â€” keying by function name would collide
...
# =============================================================================
# GeminiCloudCodeClient â€” OpenAI-compatible facade
# =============================================================================
...
class GeminiCloudCodeClient:
    ...
    def __init__(
        ...
        **_: Any,
        ...
        # `api_key` here is a dummy â€” real auth is the OAuth access token
    ...
    def _create_chat_completion(
        ...
        **_: Any,
        ...
        headers = {
            ...
            "User-Agent": "zed-agent (gemini-cli-compat)",
            "X-Goog-Api-Client": "gl-python/zed",
...
def _gemini_http_error(response: httpx.Response) -> CodeAssistError:
    ...
    the failure â€” ``status_code`` enables the rate_limit / auth classification
    ...
    messages so the user sees something better than a 500-char JSON dump:
        ...
        MODEL_CAPACITY_EXHAUSTED â†’ "Gemini model capacity exhausted for
            <model>. This is a Google-side throttle..."
        RESOURCE_EXHAUSTED w/o reason â†’ quota-style message
        404 â†’ "Model <name> not found at cloudcode-pa..."
    """
    ...
    if status == 429 and error_reason == "MODEL_CAPACITY_EXHAUSTED":
        ...
        message = (
            ...
            f"not a Zed issue). Try a different Gemini model or set a "
