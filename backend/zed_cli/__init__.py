"""
Zed CLI - Unified command-line interface for Zed Agent.

Provides subcommands for:
- zed chat          - Interactive chat (same as ./zed)
- zed gateway       - Run gateway in foreground
- zed gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    The CLI prints box-drawing characters (â”Œâ”‚â”œâ””â”€) and the âš• glyph in the setup
    ...
    can even start â€” e.g. `zed setup` on a fresh Pi.
    ...
    zed_cli/stdio.py::configure_windows_stdio() runs later from the entry
