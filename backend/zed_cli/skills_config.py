"""
Skills configuration for Zed Agent.
`zed skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.zed/config.yaml under:
...
from zed_cli.config import cfg_get, load_config, save_config
from zed_cli.colors import Colors, color
from zed_cli.platforms import PLATFORMS as _PLATFORMS
...
# â”€â”€â”€ Skill Discovery â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€â”€ Platform Selection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€â”€ Category Toggle â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def _toggle_by_category(skills: List[dict], disabled: Set[str]) -> Set[str]:
    ...
    chosen = curses_checklist(
        "Categories â€” toggle entire categories",
    ...
    for i, cat in enumerate(categories):
        cat_skills = {s["name"] for s in skills if (s["category"] or "uncategorized") == cat}
        if i in chosen:
            new_disabled -= cat_skills  # category enabled â†’ remove from disabled
        else:
            new_disabled |= cat_skills  # category disabled â†’ add to disabled
    return new_disabled
...
def skills_command(args=None):
    ...
    # Step 2: Select mode â€” individual or by category
    print()
    ...
    if mode == "2":
        ...
        # Build labels and map indices â†’ skill names
        labels = [
            f"{s['name']}  ({s['category'] or 'uncategorized'})  â€”  {s['description'][:55]}"
            for s in skills
        ]
        # "selected" = enabled (not disabled) â€” matches the [âœ“] convention
    ...
    print(color(f"âœ“ Saved: {enabled_count} enabled, {len(new_disabled)} disabled ({platform_label}).", Colors.GREEN))
