"""Zed CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.zed/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Zed Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! âš•"              # Shown on exit
      response_label: " âš• Zed "       # Response box header label
      prompt_symbol: "â¯"                 # Input prompt symbol (bare token; renderers add trailing space)
...
.. code-block:: python
    ...
    from zed_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Zed Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.zed/skins/
...
- ``daylight`` â€” Light background theme with dark text and blue accents
- ``warm-lightmode`` â€” Warm brown/gold text for light terminal backgrounds

USER SKINS
==========

Drop a YAML file in ``~/.zed/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces ZED_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces ZED_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Zed â€” gold and kawaii",
        "colors": {
        ...
        "branding": {
            ...
            "welcome": "Welcome to Zed Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! âš•",
            "response_label": " âš• Zed ",
            "prompt_symbol": "â¯",
    ...
    "ares": {
        "name": "ares",
        "description": "War-god theme â€” crimson and bronze",
        "colors": {
        ...
        "spinner": {
            "waiting_faces": ["(âš”)", "(â›¨)", "(â–²)", "(<>)", "(/)"],
            "thinking_faces": ["(âš”)", "(â›¨)", "(â–²)", "(âŒ)", "(<>)"],
            "thinking_verbs": [
        ...
        "branding": {
            ...
            "goodbye": "Farewell, warrior! âš”",
            "response_label": " âš” Ares ",
            "prompt_symbol": "âš”",
            "help_header": "(âš”) Available Commands",
        },
        "tool_prefix": "â•Ž",
        "banner_logo": """[bold #A3261F] â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—       â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—  â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ•—   â–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—[/]
...
[#EB6C32]â•šâ•â•  â•šâ•â•â•šâ•â•  â•šâ•â•â•šâ•â•â•â•â•â•â•â•šâ•â•â•â•â•â•â•      â•šâ•â•  â•šâ•â• â•šâ•â•â•â•â•â• â•šâ•â•â•â•â•â•â•â•šâ•â•  â•šâ•â•â•â•   â•šâ•â•[/]""",
        "banner_hero": """[#9F1C1C]â €â €â €â €â €â €â €â €â €â €â €â €â €â£¤â£¤â €â €â €â €â €â €â €â €â €â €â €â €â €[/]
...
[dim #6B1717]â €â €â €â €â €â €â €â €war god onlineâ €â €â €â €â €â €â €â €[/]""",
    },
    "mono": {
        "name": "mono",
        "description": "Monochrome â€” clean grayscale",
        "colors": {
    ...
    "slate": {
        "name": "slate",
        "description": "Cool blue â€” developer-focused",
        "colors": {
    ...
    "warm-lightmode": {
        "name": "warm-lightmode",
        "description": "Warm light mode â€” dark brown/gold text for light terminal backgrounds",
        "colors": {
    ...
    "poseidon": {
        "name": "poseidon",
        "description": "Ocean-god theme â€” deep blue and seafoam",
        "colors": {
        ...
        "spinner": {
            "waiting_faces": ["(â‰ˆ)", "(Î¨)", "(âˆ¿)", "(â—Œ)", "(â— )"],
            "thinking_faces": ["(Î¨)", "(âˆ¿)", "(â‰ˆ)", "(âŒ)", "(â—Œ)"],
            "thinking_verbs": [
        ...
        "branding": {
            ...
            "goodbye": "Fair winds! Î¨",
            "response_label": " Î¨ Poseidon ",
            "prompt_symbol": "Î¨",
            "help_header": "(Î¨) Available Commands",
        },
        "tool_prefix": "â”‚",
        "banner_logo": """[bold #B8E8FF]â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—  â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—  â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ•—   â–ˆâ–ˆâ•—       â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—  â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ•—   â–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—[/]
...
[#1B4F95]â•šâ•â•      â•šâ•â•â•â•â•â• â•šâ•â•â•â•â•â•â•â•šâ•â•â•â•â•â•â•â•šâ•â•â•šâ•â•â•â•â•â•  â•šâ•â•â•â•â•â• â•šâ•â•  â•šâ•â•â•â•      â•šâ•â•  â•šâ•â• â•šâ•â•â•â•â•â• â•šâ•â•â•â•â•â•â•â•šâ•â•  â•šâ•â•â•â•   â•šâ•â•[/]""",
        "banner_hero": """[#2A6FB9]â €â €â €â €â €â €â €â €â €â €â €â¢€â£€â¡€â €â €â €â €â €â €â €â €â €â €â €[/]
...
[dim #153C73]â €â €â €â €â €â €â €deep waters holdâ €â €â €â €â €â €â €[/]""",
    },
    "sisyphus": {
        "name": "sisyphus",
        "description": "Sisyphean theme â€” austere grayscale with persistence",
        "colors": {
        ...
        "spinner": {
            "waiting_faces": ["(â—‰)", "(â—Œ)", "(â—¬)", "(â¬¤)", "(::)"],
            "thinking_faces": ["(â—‰)", "(â—¬)", "(â—Œ)", "(â—‹)", "(â—)"],
            "thinking_verbs": [
        ...
        "branding": {
            ...
            "goodbye": "The boulder waits. â—‰",
            "response_label": " â—‰ Sisyphus ",
            "prompt_symbol": "â—‰",
            "help_header": "(â—‰) Available Commands",
        },
        "tool_prefix": "â”‚",
        "banner_logo": """[bold #F5F5F5]â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•—   â–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ•—  â–ˆâ–ˆâ•—â–ˆâ–ˆâ•—   â–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—       â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—  â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ•—   â–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—[/]
...
[#626262]â•šâ•â•â•â•â•â•â•â•šâ•â•â•šâ•â•â•â•â•â•â•   â•šâ•â•   â•šâ•â•     â•šâ•â•  â•šâ•â• â•šâ•â•â•â•â•â• â•šâ•â•â•â•â•â•â•      â•šâ•â•  â•šâ•â• â•šâ•â•â•â•â•â• â•šâ•â•â•â•â•â•â•â•šâ•â•  â•šâ•â•â•â•   â•šâ•â•[/]""",
        "banner_hero": """[#B7B7B7]â €â €â €â €â €â €â €â €â €â €â¢€â£€â£€â£€â¡€â €â €â €â €â €â €â €â €â €â €[/]
...
[dim #4A4A4A]â €â €â €â €â €â €â €â €â €the boulderâ €â €â €â €â €â €â €â €â €[/]""",
    },
    "charizard": {
        "name": "charizard",
        "description": "Volcanic theme â€” burnt orange and ember",
        "colors": {
        ...
        "spinner": {
            "waiting_faces": ["(âœ¦)", "(â–²)", "(â—‡)", "(<>)", "(ðŸ”¥)"],
            "thinking_faces": ["(âœ¦)", "(â–²)", "(â—‡)", "(âŒ)", "(ðŸ”¥)"],
            "thinking_verbs": [
        ...
        "branding": {
            ...
            "goodbye": "Flame out! âœ¦",
            "response_label": " âœ¦ Charizard ",
            "prompt_symbol": "âœ¦",
            "help_header": "(âœ¦) Available Commands",
        },
        "tool_prefix": "â”‚",
        "banner_logo": """[bold #FFF0D4] â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•—  â–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—        â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—  â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ•—   â–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—[/]
...
[#7A3511] â•šâ•â•â•â•â•â•â•šâ•â•  â•šâ•â•â•šâ•â•  â•šâ•â•â•šâ•â•  â•šâ•â•â•šâ•â•â•šâ•â•â•â•â•â•â•â•šâ•â•  â•šâ•â•â•šâ•â•  â•šâ•â•â•šâ•â•â•â•â•â•       â•šâ•â•  â•šâ•â• â•šâ•â•â•â•â•â• â•šâ•â•â•â•â•â•â•â•šâ•â•  â•šâ•â•â•â•   â•šâ•â•[/]""",
        "banner_hero": """[#FFD39A]â €â €â €â €â €â €â €â €â£€â£¤â ¶â ¶â ¶â£¤â£€â €â €â €â €â €â €â €â €[/]
...
[dim #7A3511]â €â €â €â €â €â €â €tail flame litâ €â €â €â €â €â €â €â €[/]""",
    },
}
...
def _build_skin_config(data: Dict[str, Any]) -> SkinConfig:
    ...
    return SkinConfig(
        ...
        spinner=spinner,
        branding=branding,
        tool_prefix=data.get("tool_prefix", default.get("tool_prefix", "â”Š")),
...
def get_active_prompt_symbol(fallback: str = "â¯") -> str:
...
def get_active_goodbye(fallback: str = "Goodbye! âš•") -> str:
