...
def build_setup_parser(subparsers, *, cmd_setup: Callable) -> None:
    ...
    setup_parser = subparsers.add_parser(
        ...
        description="Configure Zed Agent with an interactive wizard. "
        "Run a specific section: zed setup model|tts|terminal|gateway|tools|agent",
    )
    ...
    setup_parser.add_argument(
        ...
        "compatibility â€” a bare 'zed setup' now does this.",
    )
    setup_parser.add_argument(
        "--quick",
        action="store_true",
