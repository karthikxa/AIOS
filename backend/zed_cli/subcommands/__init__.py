"""CLI subcommand parser builders for ``zed <subcommand>``.

``zed_cli/main.py:main()`` historically built the entire argparse tree
inline â€” 179 ``add_parser`` calls across ~26 subcommand groups, all wedged
