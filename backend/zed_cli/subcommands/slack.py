...
def build_slack_parser(subparsers, *, cmd_slack: Callable) -> None:
    ...
    slack_parser = subparsers.add_parser(
        ...
        description="Slack integration helpers for Zed.",
    )
    ...
    slack_manifest = slack_sub.add_parser(
        ...
        description=(
            ...
            "output into Slack app config â†’ Features â†’ App Manifest â†’ "
    ...
    slack_manifest.add_argument(
        ...
        "writes to $ZED_HOME/slack-manifest.json.",
    )
    slack_manifest.add_argument(
        "--name",
        default=None,
        help='Bot display name (default: "Zed")',
    )
    slack_manifest.add_argument(
        "--description",
        default=None,
