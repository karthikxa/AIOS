...
Implements the same 3-step registration flow as dingtalk-openclaw-connector:
  1. POST /app/registration/init   â†’ get nonce
  2. POST /app/registration/begin  â†’ get device_code + verification_uri_complete
  3. POST /app/registration/poll   â†’ poll until SUCCESS â†’ get client_id + client_secret
...
# â”€â”€ Core flow â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def begin_registration() -> dict:
    ...
    # Step 2: begin â†’ device_code, verification_uri_complete
...
# â”€â”€ QR code rendering â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def _ensure_qrcode_installed() -> bool:
    ...
    # Try uv first (Zed convention), then pip
    for cmd in (
...
# â”€â”€ High-level entry point for the setup wizard â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def dingtalk_qr_auth() -> Optional[Tuple[str, str]]:
    ...
    """
    from zed_cli.setup import print_info, print_success, print_warning, print_error

    print()
    print_info("  Initializing DingTalk device authorization...")
    print_info("  Note: the scan page is branded 'OpenClaw' â€” DingTalk's")
