...
Token type support (per GitHub docs):
  gho_          OAuth token           âœ“  (default via copilot login)
  github_pat_   Fine-grained PAT      âœ“  (needs Copilot Requests permission)
  ghu_          GitHub App token      âœ“  (via environment variable)
  ghp_          Classic PAT           âœ—  NOT SUPPORTED
...
def validate_copilot_token(token: str) -> tuple[bool, str]:
    ...
    if token.startswith(_CLASSIC_PAT_PREFIX):
        return False, (
            ...
            "  â†’ `copilot login` or `zed model` to authenticate via OAuth\n"
            "  â†’ A fine-grained PAT (github_pat_*) with Copilot Requests permission\n"
            "  â†’ `gh auth login` with the default device code flow (produces gho_* tokens)"
        )
...
# â”€â”€â”€ OAuth Device Code Flow â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def copilot_device_code_login(
    *,
    ...
    try:
        ...
        print(f"  âœ— Failed to start device authorization: {exc}")
        return None
    ...
    if not device_code or not user_code:
        print("  âœ— GitHub did not return a device code.")
        return None
    ...
    while time.monotonic() < deadline:
        ...
        if error == "authorization_pending":
            ...
            print()
            print("  âœ— Device code expired. Please try again.")
            return None
        elif error == "access_denied":
            print()
            print("  âœ— Authorization was denied.")
            return None
        elif error:
            print()
    ...
    print()
    print("  âœ— Timed out waiting for authorization.")
    return None


# â”€â”€â”€ Copilot Token Exchange â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€â”€ Copilot API Headers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
