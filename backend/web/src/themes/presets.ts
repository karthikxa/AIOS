 ...
 * themes produces visible changes beyond just color â€” fonts, density, and
 * corner-radius all shift to match the theme's personality.
 *
 * Theme names must stay in sync with the backend's
 * `_BUILTIN_DASHBOARD_THEMES` list in `zed_cli/web_server.py`.
 */
...
/** Default system stack â€” neutral, safe fallback for every platform. */
const SYSTEM_SANS =
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Zed Teal",
  description: "Classic dark teal â€” the canonical Zed look",
  palette: {
...
export const emberTheme: DashboardTheme = {
  name: "ember",
  label: "Ember",
  description: "Warm crimson and bronze â€” forge vibes",
  palette: {
...
export const monoTheme: DashboardTheme = {
  name: "mono",
  label: "Mono",
  description: "Clean grayscale â€” minimal and focused",
  palette: {
...
export const cyberpunkTheme: DashboardTheme = {
  name: "cyberpunk",
  label: "Cyberpunk",
  description: "Neon green on black â€” matrix terminal",
  palette: {
...
export const roseTheme: DashboardTheme = {
  name: "rose",
  label: "RosÃ©",
  description: "Soft pink and warm ivory â€” easy on the eyes",
  palette: {
...
/**
 * Nous Blue â€” the inverted "light mode" Zed look, ported from the
 ...
 * inversion converts them to their visual complements at paint time â€”
 ...
 * nousnet-web's <body> is white; zed-agent's App root is `bg-black`,
 * so we leave the bg layer's blend mode at the `difference` default â€”
...
export const nousBlueTheme: DashboardTheme = {
  name: "nous-blue",
  label: "Nous Blue",
  description: "Light mode â€” vivid Nous-blue accents on cream canvas",
  palette: {
  ...
  // a `#000000` source paints as visual white â€” i.e. a proper light-mode
  ...
  componentStyles: {
    backdrop: {
      ...
      // heavy cloud/marble pattern â€” especially on near-empty pages
  ...
  // bright Nous-blue canvas â€” the coral is the "red" users see for
  // Output values without these overrides. Source â†’ on-screen:
  //   Input:  #ffe6cb â†’ #001934 (dark navy)        â† unchanged
  //   Output: #ffac02 â†’ #0053fd (vivid Nous-blue)  â† brand accent
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Zed Teal (Large)",
  description: "Zed Teal with bigger fonts and roomier spacing",
