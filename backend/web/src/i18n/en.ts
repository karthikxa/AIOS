...
export const en: Translations = {
  common: {
    ...
    pluginLoadFailed:
      "Could not load this pluginâ€™s script. Check the Network tab (dashboard-plugins/â€¦) and the serverâ€™s plugin path.",
    pluginNotRegistered:
      "The pluginâ€™s script did not call register(), or the script errored. Open the browser console for details.",
  },
  ...
  status: {
    ...
    restartingGateway: "Restarting gatewayâ€¦",
    running: "Running",
    runningRemote: "Running (remote)",
    startFailed: "Start failed",
    starting: "Starting",
    startedInBackground: "Started in background â€” check logs for progress",
    stopped: "Stopped",
    updateZed: "Update Zed",
    updatingZed: "Updating Zedâ€¦",
    waitingForOutput: "Waiting for outputâ€¦",
  },
  ...
  profiles: {
    ...
    soulPlaceholder: "# How this agent should behaveâ€¦",
    saveSoul: "Save SOUL",
    ...
    confirmDeleteMessage:
      "This permanently deletes profile '{name}' â€” config, keys, memories, sessions, skills, cron jobs. Cannot be undone.",
    created: "Created",
    deleted: "Deleted",
    renamed: "Renamed",
    ...
    gatewayRunningWarning:
      "This profile's gateway is running â€” it will be stopped.",
    aliasBadge: "alias",
    ...
    modelLoading: "Loading modelsâ€¦",
    modelNone: "No authenticated providers â€” set a key first",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Zed plugins (`zed plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.zed/plugins/?",
    removeHint: "Only user-installed plugins under ~/.zed/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.zed/skills/",
    ...
    managingProfile:
      "Managing profile \u201c{name}\u201d â€” toggles apply to that profile, not this dashboard\u2019s.",
  },
  ...
  config: {
    ...
    confirmResetScope: "Reset all {scope} settings to their defaults? This only updates the form â€” changes aren't written to config.yaml until you press Save.",
    resetScopeToast: "{scope} reset to defaults â€” review and Save to persist",
    ...
    configImported: "Config imported â€” review and save",
  ...
  oauth: {
    ...
    initiatingLogin: "Initiating login flowâ€¦",
    exchangingCode: "Exchanging code for tokensâ€¦",
    connectedClosing: "Connected! Closingâ€¦",
    ...
    waitingAuth: "Waiting for you to authorize in the browserâ€¦",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Zed badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Zed session history. First scan can take 5â€“10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Zed more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    scan: {
      building_headline: "Building achievement profileâ€¦",
      building_detail:
        "Reading sessions, tool calls, model metadata, and unlock state.",
      starting_headline: "Starting achievement scanâ€¦",
      progress_detail:
        "Scanned {scanned} of {total} sessions Â· {pct}%. Badges unlock as more history streams in.",
      idle_detail:
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Zed sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Zed is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    empty: {
      ...
      no_secrets_body:
        "Clue: secrets usually start from unusual failure or power-user patterns â€” port conflicts, permission walls, missing env vars, YAML mistakes, Docker collisions, rollback/checkpoint use, cache hits, or tiny fixes after lots of red text.",
    },
    filters: {
      all_categories: "All",
      visibility_all: "all",
    ...
    share: {
      ...
      hint:
        "Share on X opens a pre-filled post in a new tab. Click Copy image first if you want the 1200Ã—630 badge attached â€” X lets you paste it right into the tweet composer. Download PNG saves the file for use anywhere.",
      clipboard_unsupported:
        "Clipboard image copy not supported in this browser â€” use Download instead.",
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Zed Agent â˜¤",
    },
  },

  kanban: {
    loading: "Loading Kanban boardâ€¦",
    ...
    newBoardDescription:
      "Boards let you separate unrelated streams of work â€” one per project, repo, or domain. Workers on one board never see another board's tasks.",
    slug: "Slug",
    slugHint: "â€” lowercase, hyphens, e.g. atm10-server",
    ...
    loadingLog: "Loading logâ€¦",
    noWorkerLog:
      "â€” no worker log yet (task hasn't spawned or log was rotated away) â€”",
    noDescription: "â€” no description â€”",
    noComments: "â€” no comments â€”",
    edit: "edit",
    save: "Save",
    ...
    children: "Children:",
    none: "none",
    addParent: "â€” add parent â€”",
    addChild: "â€” add child â€”",
    ...
    wsAuthFailed:
      "WebSocket auth failed â€” reload the page to refresh the session token.",
    ...
    bulkFailed: "Bulk: ",
    completionBlockedHallucination: "âš  Completion blocked â€” phantom card ids",
    suspectedHallucinatedReferences: "âš  Prose referenced phantom card ids",
    ...
    columnHelp: {
      triage: "Raw ideas â€” a specifier will flesh out the spec",
      todo: "Waiting on dependencies or unassigned",
      scheduled: "Waiting on a known time delay or scheduled follow-up",
      ready: "Dependencies satisfied; assign a profile to dispatch",
      running: "Claimed by a worker â€” in-flight",
