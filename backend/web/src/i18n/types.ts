...
export interface Translations {
  ...
  app: {
    ...
    system: string;
    webUi: string;
    /** Optional â€” fall back to English literals until translated. */
  ...
  theme: {
    title: string;
    switchTheme: string;
    /** Font-override section (optional â€” locales fall back to English). */
    fontTitle?: string;
    fontDefault?: string;
  ...
  // â”€â”€ Achievements plugin (plugins/zed-achievements) â”€â”€
  achievements: {
    hero: {
      kicker: string;
      title: string;
