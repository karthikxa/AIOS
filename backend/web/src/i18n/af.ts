...
export const af: Translations = {
  common: {
    ...
    pluginLoadFailed:
      "Kon nie hierdie inprop se skrip laai nie. Kontroleer die Netwerk-oortjie (dashboard-plugins/â€¦) en die bediener se inprop-pad.",
    pluginNotRegistered:
  ...
  status: {
    ...
    restartingGateway: "Besig om gateway te herbeginâ€¦",
    running: "Loop",
    runningRemote: "Loop (afgeleÃ«)",
    startFailed: "Begin het misluk",
    starting: "Begin",
    startedInBackground: "Begin in agtergrond â€” kyk logs vir vordering",
    stopped: "Gestop",
    updateZed: "Werk Zed op",
    updatingZed: "Besig om Zed op te werkâ€¦",
    waitingForOutput: "Wag vir uitsetâ€¦",
  },
  ...
  sessions: {
    ...
    deleteEmpty: "Skrap leÃ«",
    deleteEmptyConfirmTitle: "Skrap leÃ« sessies?",
    ...
    emptySessionsDeleted: "{count} leÃ« sessies geskrap",
    failedToDeleteEmpty: "Kon nie leÃ« sessies skrap nie",
  ...
  logs: {
    ...
    component: "Komponent",
    lines: "ReÃ«ls",
    noLogLines: "Geen logreÃ«ls gevind nie",
  },
  ...
  profiles: {
    ...
    soulPlaceholder: "# Hoe hierdie agent moet optreeâ€¦",
    saveSoul: "Stoor SOUL",
    ...
    confirmDeleteMessage:
      "Dit skrap profiel '{name}' permanent â€” konfigurasie, sleutels, geheue, sessies, vaardighede, cron-take. Kan nie ongedaan gemaak word nie.",
    created: "Geskep",
    deleted: "Geskrap",
    renamed: "Hernoem",
  },
  ...
  pluginsPage: {
    ...
    enableAfterInstall: "Aktiveer nÃ¡ installasie",
    enableRuntime: "Aktiveer",
    forceReinstall: "Forseer herinstallasie (skrap eers bestaande gids)",
    headline:
      "Ontdek, installeer, aktiveer en werk Zed-inproppe op (`zed plugins` ekwivalent).",
    ...
    pluginListHeading: "GeÃ¯nstalleerde inproppe",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.zed/plugins/?",
    removeHint: "Slegs gebruiker-geÃ¯nstalleerde inproppe onder ~/.zed/plugins kan verwyder word.",
    rescanHeading: "SPA-inprop-register",
    rescanHint: "Herskandeer nÃ¡ die byvoeg van lÃªers op skyf sodat die dashboard-sybalk nuwe manifeste optel.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.zed/skills/",
  ...
  config: {
    ...
    confirmResetScope: "Stel alle {scope}-instellings terug na hul verstek? Dit werk slegs die vorm op â€” veranderinge word nie na config.yaml geskryf voordat jy Stoor druk nie.",
    resetScopeToast: "{scope} teruggestel na verstek â€” kontroleer en Stoor om te behou",
    ...
    configImported: "Konfigurasie ingevoer â€” kontroleer en stoor",
    invalidJson: "Ongeldige JSON-lÃªer",
    categories: {
      general: "Algemeen",
      agent: "Agent",
      terminal: "Terminaal",
  ...
  env: {
    ...
    confirmClearMessage:
      "Die gestoorde waarde vir hierdie veranderlike sal uit jou .env-lÃªer verwyder word. Dit kan nie vanaf die UI ongedaan gemaak word nie.",
  ...
  oauth: {
    ...
    initiatingLogin: "Aanmeldvloei word beginâ€¦",
    exchangingCode: "Kode word vir tokens omgeruilâ€¦",
    connectedClosing: "Gekoppel! Besig om toe te maakâ€¦",
    ...
    waitingAuth: "Wag vir jou om in die blaaier te magtigâ€¦",
    ...
    pkceStep2: "Kopieer die magtigingskode wat nÃ¡ magtiging vertoon word.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare Zed-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "Zed-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5â€“10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik Zed meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    scan: {
      building_headline: "Prestasieprofiel word gebouâ€¦",
      building_detail:
        "Sessies, gereedskaproepe, modelmetadata en ontsluitstatus word gelees.",
      starting_headline: "Prestasieskandering beginâ€¦",
      progress_detail:
        "{scanned} van {total} sessies geskandeer Â· {pct}%. Kentekens ontsluit soos meer geskiedenis instroom.",
      idle_detail:
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra Zed 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "Zed skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
    ...
    empty: {
      ...
      no_secrets_body:
        "Wenk: geheime begin gewoonlik by ongewone mislukkings of magsgebruikerspatrone â€” poortbotsings, toestemmingsmure, ontbrekende env-veranderlikes, YAML-foute, Docker-botsings, terugrol/kontrolepunt-gebruik, kasterugslae of klein regstellings na baie rooi teks.",
    },
    filters: {
    ...
    share: {
      ...
      hint:
        "Deel op X maak 'n vooraf-ingevulde plasing in 'n nuwe oortjie oop. Klik eers op Kopieer beeld as jy die 1200Ã—630-kenteken aangeheg wil hÃª â€” X laat jou dit direk in die tweet-skrywer plak. Laai PNG af stoor die lÃªer om enige plek te gebruik.",
      clipboard_unsupported:
        "BeeldkopiÃ«ring na knipbord word nie in hierdie blaaier ondersteun nie â€” gebruik eerder Aflaai.",
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Zed Agent â˜¤",
    },
  },
  kanban: {
    loading: "Kanban-bord word gelaaiâ€¦",
    ...
    newBoardDescription:
      "Borde laat u toe om onverwante werkstrome te skei â€” een per projek, repositorium of domein. Werkers op een bord sien nooit 'n ander bord se take nie.",
    slug: "Slug",
    slugHint: "â€” kleinletters, koppeltekens, bv. atm10-server",
    ...
    cancel: "Kanselleer",
    creating: "Word geskepâ€¦",
    createBoard: "Skep bord",
    search: "Soek",
    filterCards: "Filter kaarteâ€¦",
    tenant: "Huurder",
    ...
    noTasks: "â€” geen take â€”",
    unassigned: "nie toegewys nie",
    untitled: "(sonder titel)",
    loadingDetail: "Word gelaaiâ€¦",
    addComment: "Voeg 'n opmerking byâ€¦ (Enter om in te dien)",
    comment: "Opmerking",
    status: "Status",
    ...
    loadingLog: "Log word gelaaiâ€¦",
    noWorkerLog:
      "â€” nog geen werker-log nie (taak is nog nie ontketen nie of die log is geroteer) â€”",
    noDescription: "â€” geen beskrywing â€”",
    noComments: "â€” geen opmerkings â€”",
    edit: "redigeer",
    save: "Stoor",
    ...
    children: "Kinders:",
    none: "geen",
    addParent: "â€” voeg ouer by â€”",
    addChild: "â€” voeg kind by â€”",
    ...
    reclaim: "Heroor",
    reassign: "Hertoeken",
    renderingError: "Kanban-oortjie het 'n weergawefout teÃ«gekom",
    reloadView: "Herlaai aansig",
    wsAuthFailed:
      "WebSocket-verifikasie het misluk â€” herlaai die bladsy om die sessietoken te verfris.",
    ...
    completionBlockedHallucination: "âš  Voltooiing geblokkeer â€” spook-kaart-ID's",
    suspectedHallucinatedReferences: "âš  Teks het na spook-kaart-ID's verwys",
    ...
    columnHelp: {
      triage: "Rou idees â€” 'n spesifiseerder sal die spesifikasie uitwerk",
      ...
      running: "Deur 'n werker geÃ«is â€” in vlug",
    ...
    logTruncated: "(toon laaste 100 KB â€” volledige log by ",
    logAt: ")",
  },
};
