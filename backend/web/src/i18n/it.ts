...
export const it: Translations = {
  common: {
    ...
    pluginLoadFailed:
      "Impossibile caricare lo script di questo plugin. Controlla la scheda Network (dashboard-plugins/â€¦) e il percorso dei plugin del server.",
    pluginNotRegistered:
  ...
  status: {
    ...
    restartingGateway: "Riavvio del gatewayâ€¦",
    running: "In esecuzione",
    runningRemote: "In esecuzione (remoto)",
    startFailed: "Avvio non riuscito",
    starting: "Avvio in corso",
    startedInBackground: "Avviato in background â€” controlla i log per i progressi",
    stopped: "Arrestato",
    updateZed: "Aggiorna Zed",
    updatingZed: "Aggiornamento di Zedâ€¦",
    waitingForOutput: "In attesa di outputâ€¦",
  },
  ...
  sessions: {
    ...
    confirmDeleteMessage:
      "Questa operazione rimuove definitivamente la conversazione e tutti i suoi messaggi. Non puÃ² essere annullata.",
    ...
    deleteEmptyConfirmMessage:
      "Questa azione rimuove in modo permanente {count} sessioni senza messaggi. Le sessioni attive e archiviate vengono ignorate. L'azione non puÃ² essere annullata.",
    ...
    deleteSelectedConfirmMessage:
      "Verranno eliminate definitivamente {count} sessioni selezionate e tutti i loro messaggi. L'operazione non puÃ² essere annullata.",
  ...
  analytics: {
    ...
    topSkills: "Competenze piÃ¹ usate",
    skill: "Competenza",
  ...
  cron: {
    confirmDeleteMessage:
      "Questa operazione rimuove l'attivitÃ  dalla pianificazione. Non puÃ² essere annullata.",
    confirmDeleteTitle: "Eliminare l'attivitÃ  pianificata?",
    newJob: "Nuova attivitÃ  cron",
    ...
    scheduledJobs: "AttivitÃ  pianificate",
    noJobs: "Nessuna attivitÃ  cron configurata. Creane una sopra.",
    last: "Ultima",
    next: "Prossima",
    pause: "Pausa",
    resume: "Riprendi",
  ...
  profiles: {
    ...
    soulSection: "SOUL.md (personalitÃ  / prompt di sistema)",
    soulPlaceholder: "# Come dovrebbe comportarsi questo agenteâ€¦",
    saveSoul: "Salva SOUL",
    ...
    confirmDeleteMessage:
      "Questa operazione elimina definitivamente il profilo '{name}' â€” configurazione, chiavi, memorie, sessioni, competenze, attivitÃ  cron. Non puÃ² essere annullata.",
    created: "Creato",
    deleted: "Eliminato",
    renamed: "Rinominato",
  },
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Zed (paritÃ  con `zed plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.zed/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.zed/plugins possono essere rimossi.",
    rescanHeading: "Registro plugin SPA",
    rescanHint: "Riscansiona dopo aver aggiunto file su disco affinchÃ© la barra laterale rilevi i nuovi manifest.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.zed/skills/",
  ...
  config: {
    ...
    confirmResetScope: "Ripristinare tutte le impostazioni di {scope} ai valori predefiniti? Questa operazione aggiorna solo il modulo â€” le modifiche non vengono scritte in config.yaml finchÃ© non premi Salva.",
    resetScopeToast: "{scope} ripristinato ai valori predefiniti â€” controlla e Salva per rendere persistente",
    ...
    configImported: "Configurazione importata â€” controlla e salva",
  ...
  env: {
    ...
    confirmClearMessage:
      "Il valore memorizzato per questa variabile sarÃ  rimosso dal tuo file .env. Non puÃ² essere annullato dall'interfaccia.",
  ...
  oauth: {
    ...
    initiatingLogin: "Avvio del flusso di accessoâ€¦",
    exchangingCode: "Scambio del codice per i tokenâ€¦",
    connectedClosing: "Connesso! Chiusuraâ€¦",
    ...
    waitingAuth: "In attesa che tu autorizzi nel browserâ€¦",
    enterCodePrompt: "Ãˆ stata aperta una nuova scheda. Inserisci questo codice se richiesto:",
    pkceStep1: "Ãˆ stata aperta una nuova scheda su claude.ai. Accedi e clicca Autorizza.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge Zed da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finchÃ© non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni Zed in corso. La prima scansione puÃ² richiedere 5â€“10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      highest_tier: "Livello piÃ¹ alto",
      highest_tier_hint: "Copper â†’ Silver â†’ Gold â†’ Diamond â†’ Olympian",
      latest: "PiÃ¹ recente",
      latest_hint_empty: "usa Zed di piÃ¹",
    ...
    scan: {
      building_headline: "Costruzione del profilo achievementâ€¦",
      building_detail:
        "Lettura di sessioni, chiamate agli strumenti, metadati del modello e stato di sblocco.",
      starting_headline: "Avvio della scansione achievementâ€¦",
      progress_detail:
        "Scansionate {scanned} di {total} sessioni Â· {pct}%. I badge si sbloccano man mano che viene elaborata altra cronologia.",
      idle_detail:
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando Zed rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "Zed sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non Ã¨ bloccato nulla se richiede qualche secondo.",
    ...
    empty: {
      ...
      no_secrets_body:
        "Indizio: i segreti di solito partono da fallimenti inusuali o pattern da utente esperto â€” conflitti di porte, muri di permessi, variabili d'ambiente mancanti, errori YAML, collisioni Docker, uso di rollback/checkpoint, cache hit o piccole correzioni dopo molto testo rosso.",
    },
    filters: {
    ...
    share: {
      ...
      hint:
        "Condividi su X apre un post precompilato in una nuova scheda. Clicca prima su Copia immagine se vuoi allegare il badge 1200Ã—630 â€” X ti permette di incollarlo direttamente nell'editor del tweet. Scarica PNG salva il file per l'uso ovunque.",
      clipboard_unsupported:
        "La copia delle immagini negli appunti non Ã¨ supportata in questo browser â€” usa Scarica invece.",
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Zed Agent â˜¤",
    },
  },
  kanban: {
    loading: "Caricamento bacheca Kanbanâ€¦",
    ...
    newBoardDescription:
      "Le bacheche ti permettono di separare flussi di lavoro non correlati â€” una per progetto, repository o dominio. I worker su una bacheca non vedono mai le attivitÃ  di un'altra.",
    slug: "Slug",
    slugHint: "â€” minuscolo, trattini, ad es. atm10-server",
    ...
    apply: "Applica",
    clear: "Cancella",
    createTask: "Crea attivitÃ  in questa colonna",
    noTasks: "â€” nessuna attivitÃ  â€”",
    unassigned: "non assegnato",
    untitled: "(senza titolo)",
    loadingDetail: "Caricamentoâ€¦",
    addComment: "Aggiungi un commentoâ€¦ (Enter per inviare)",
    comment: "Commento",
    status: "Stato",
    workspace: "Workspace",
    skills: "Competenze",
    ...
    loadingLog: "Caricamento logâ€¦",
    noWorkerLog:
      "â€” nessun log del worker ancora (l'attivitÃ  non Ã¨ stata avviata o il log Ã¨ stato ruotato) â€”",
    noDescription: "â€” nessuna descrizione â€”",
    noComments: "â€” nessun commento â€”",
    edit: "modifica",
    save: "Salva",
    ...
    children: "Figli:",
    none: "nessuno",
    addParent: "â€” aggiungi padre â€”",
    addChild: "â€” aggiungi figlio â€”",
    ...
    tasksNeedAttention: "attivitÃ  richiedono attenzione",
    taskNeedsAttention: "1 attivitÃ  richiede attenzione",
    ...
    wsAuthFailed:
      "Autenticazione WebSocket non riuscita â€” ricarica la pagina per aggiornare il token di sessione.",
    markDone: "Contrassegnare {n} attivitÃ  come completate?",
    markArchived: "Archiviare {n} attivitÃ ?",
    warning: "Avviso",
    ...
    archiveBoardConfirm:
      "Archiviare la bacheca '{name}'? VerrÃ  spostata in boards/_archived/ in modo da poterla recuperare in seguito. Le attivitÃ  di questa bacheca non appariranno piÃ¹ da nessuna parte nell'UI.",
    ...
    taskCreatedWarning: "AttivitÃ  creata, ma: ",
    moveFailed: "Spostamento non riuscito: ",
    bulkFailed: "Massivo: ",
    completionBlockedHallucination: "âš  Completamento bloccato â€” ID schede fantasma",
    suspectedHallucinatedReferences: "âš  Il testo ha fatto riferimento a ID schede fantasma",
    pickProfileFirst: "Scegli prima un profilo.",
    unblockedMessage: "Sbloccato {id}. L'attivitÃ  Ã¨ pronta per il prossimo tick.",
    unblockFailed: "Sblocco non riuscito: ",
    reclaimedMessage: "Recuperato {id}. L'attivitÃ  Ã¨ di nuovo pronta.",
    ...
    columnHelp: {
      triage: "Idee grezze â€” un specifier elaborerÃ  la specifica",
      ...
      running: "Preso in carico da un worker â€” in esecuzione",
      blocked: "Il worker ha richiesto input umano",
      done: "Completato",
      archived: "Archiviato",
    },
    confirmDone:
      "Contrassegnare questa attivitÃ  come completata? La presa in carico del worker viene rilasciata e i figli dipendenti diventano pronti.",
    confirmArchive:
      "Archiviare questa attivitÃ ? SparirÃ  dalla vista predefinita della bacheca.",
    confirmBlocked:
      "Contrassegnare questa attivitÃ  come bloccata? La presa in carico del worker viene rilasciata.",
    completionSummary:
      "Riepilogo di completamento per {label}. Memorizzato come result dell'attivitÃ .",
    completionSummaryRequired:
      "Il riepilogo di completamento Ã¨ obbligatorio prima di contrassegnare un'attivitÃ  come completata.",
    triagePlaceholder: "Idea approssimativa â€” l'IA la specificherÃ â€¦",
    taskTitlePlaceholder: "Titolo della nuova attivitÃ â€¦",
    specifier: "specifier",
    assigneePlaceholder: "assegnatario",
    priority: "PrioritÃ ",
    skillsPlaceholder:
      "competenze (facoltative, separate da virgole): translation, github-code-review",
    noParent: "â€” nessun padre â€”",
    ...
    logTruncated: "(mostrando ultimi 100 KB â€” log completo in ",
    logAt: ")",
  },
};
