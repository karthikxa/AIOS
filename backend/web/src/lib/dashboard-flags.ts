declare global {
  interface Window {
     ...
     */
    __ZED_DASHBOARD_EMBEDDED_CHAT__?: boolean;
  }
}
 ...
 * an unconditional part of the dashboard â€” the desktop app and the in-browser
 * Chat tab both depend on it â€” so this always returns `true`. The function is
