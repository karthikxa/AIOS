 ...
 *
 * Values mirror zed_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Zed default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown â†’ `medium` (Zed' default when unset). */
