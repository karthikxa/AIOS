...
These are the built-in automations Zed can offer a new user out of the box â€”
...
CATALOG: List[CatalogEntry] = [
    ...
    CatalogEntry(
        ...
        "that actually needs attention â€” never the newsletters.",
        job_spec={
            "prompt": (
                ...
                "--threshold 7 --criteria ...` from the zed-agent install â€” "
