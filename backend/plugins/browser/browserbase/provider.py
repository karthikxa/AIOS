"""Browserbase cloud browser provider â€” plugin form.
...
credentials. Managed Nous gateway support has been removed â€” the Nous
...
class BrowserbaseBrowserProvider(BrowserProvider):
    ...
    Direct credentials only â€” managed-Nous-gateway support lives on the
    ...
    def create_session(self, task_id: str) -> Dict[str, object]:
        ...
        try:
            ...
            # Handle 402 â€” paid features unavailable
    ...
    def close_session(self, session_id: str) -> bool:
        try:
            ...
            logger.warning(
                "Cannot close Browserbase session %s â€” missing credentials", session_id
            )
            return False
    ...
    def emergency_cleanup(self, session_id: str) -> None:
        ...
        if config is None:
            logger.warning(
                "Cannot emergency-cleanup Browserbase session %s â€” missing credentials",
                session_id,
            )
            return
        try:
