...
def _xai_image_field(source: str) -> Dict[str, str]:
    ...
    # Local file path â†’ base64 data URI.
    import base64
    import os as _os
...
class XAIImageGenProvider(ImageGenProvider):
    ...
    def get_setup_schema(self) -> Dict[str, Any]:
        ...
        # hook (``zed_cli/tools_config.py``); identical to the TTS / video
        # gen entries so users see the same OAuth-or-API-key choice for every
        # xAI service.
        return {
            "name": "xAI Grok Imagine (image)",
            "badge": "paid",
            "tag": "grok-imagine-image â€” text-to-image & image editing; uses xAI Grok OAuth or XAI_API_KEY",
            "env_vars": [],
            "post_setup": "xai_grok",
        }
    ...
    def generate(
        ...
        **kwargs: Any,
        ...
        # Parse response â€” xAI returns data[0].b64_json or data[0].url
        ...
        if b64:
            ...
            # URLs that 404 within minutes â€” by the time Telegram's
