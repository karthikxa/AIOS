...
class HomeAssistantAdapter(BasePlatformAdapter):
    ...
    async def _handle_ha_event(self, event: Dict[str, Any]) -> None:
        ...
        # Apply domain/entity watch filters (closed by default â€” require
        ...
        if self._watch_domains or self._watch_entities:
            ...
            # No filters configured and watch_all is off â€” drop the event
            return
...
# ---------------------------------------------------------------------------
# Standalone (out-of-process) sender â€” used by cron deliver=homeassistant
# ---------------------------------------------------------------------------
...
async def _standalone_send(
    ...
    *,
    ...
    no native threading or attachment model â€” these arguments are ignored.
    """
    if not AIOHTTP_AVAILABLE:
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # HA notification message cap â€” matches MAX_MESSAGE_LENGTH on the
        # adapter class above.
