"""Exa web search + content extraction â€” plugin form.
...
def _get_exa_client() -> Any:
    ...
    try:
        ...
        pass
    except Exception as exc:  # noqa: BLE001 â€” lazy_deps surfaces install hints
        raise ImportError(str(exc))

    from exa_py import Exa  # noqa: WPS433 â€” deliberately lazy

    client = Exa(api_key=api_key)
    client.headers["x-exa-integration"] = "zed-agent"
...
class ExaWebSearchProvider(WebSearchProvider):
    ...
    Both methods are sync â€” Exa's SDK is sync-only. The web_extract_tool
    ...
    def search(self, query: str, limit: int = 5) -> Dict[str, Any]:
        ...
        except Exception as exc:  # noqa: BLE001 â€” surface as failure
