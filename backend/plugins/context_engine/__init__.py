...
Context engines are separate from the general plugin system â€” they live
...
def discover_context_engines() -> List[Tuple[str, str, bool]]:
    ...
    Does NOT import the engines â€” just reads plugin.yaml for metadata
...
def _load_engine_from_dir(engine_dir: Path) -> Optional["ContextEngine"]:
    ...
    - A top-level class that extends ContextEngine â€” we instantiate it
    """
