...
class AudioBridge:
    ...
    def __init__(self, name_prefix: str = "zed_meet") -> None:
    ...
    # â”€â”€ public properties â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        if self._platform == "linux" and self._module_ids:
            ...
            for mod_id in reversed(self._module_ids):
                try:
                    ...
                    # Best-effort teardown â€” never raise from here.
                    pass
            self._module_ids = []
        self._torn_down = True

    # â”€â”€ platform impls â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        try:
            sink_out = subprocess.run(
                [
                    ...
                    f"sink_properties=device.description=ZedMeetSink",
                ],
                check=True,
                capture_output=True,
                text=True,
            ...
            raise RuntimeError(
                "pactl not found â€” install PulseAudio/pipewire-pulse"
            ) from exc
