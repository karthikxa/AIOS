...
Lives at ``$ZED_HOME/workspace/meetings/nodes.json``. The gateway
...
def _default_path() -> Path:
    return Path(get_zed_home()) / "workspace" / "meetings" / "nodes.json"


class NodeRegistry:
    """Simple file-backed registry. Not concurrent-safe across processes
    â€” single writer assumed (the gateway CLI)."""
