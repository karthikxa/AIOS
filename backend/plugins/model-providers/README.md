...
â”œâ”€â”€ openrouter/
â”‚   â”œâ”€â”€ __init__.py      # registers the ProviderProfile
â”‚   â””â”€â”€ plugin.yaml      # manifest: name, kind, version, description
â”œâ”€â”€ anthropic/
...
`$ZED_HOME/plugins/model-providers/`) the first time anything calls
...
User plugins at `$ZED_HOME/plugins/model-providers/<name>/` override
bundled plugins of the same name â€” last-writer-wins in
...
quirks â€” see `plugins/model-providers/openrouter/__init__.py` for
