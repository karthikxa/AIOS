...
gmi = ProviderProfile(
    ...
    description="GMI Cloud â€” multi-model direct API (slash-form model IDs)",
    signup_url="https://www.gmicloud.ai/",
    env_vars=("GMI_API_KEY", "GMI_BASE_URL"),
    base_url="https://api.gmi-serving.com/v1",
    auth_type="api_key",
    # Attribution so GMI can identify traffic from Zed Agent.
    ...
    default_headers={"User-Agent": f"ZedAgent/{_ZED_VERSION}"},
