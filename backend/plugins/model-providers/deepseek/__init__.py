...
echo it back; combined with how Zed replays history this lands on the
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    if m.startswith("deepseek-v") and not m.startswith("deepseek-v3"):
        # deepseek-v4-*, deepseek-v5-*, etc. â€” every V4+ generation has
...
class DeepSeekProfile(ProviderProfile):
    """DeepSeek â€” extra_body.thinking + top-level reasoning_effort."""
    ...
    def build_api_kwargs_extras(
        ...
        if not _model_supports_thinking(model):
            # V3 / unknown â€” leave wire format untouched, current behavior.
        ...
        # Effort mapping.  Pass low/medium/high through; xhigh/max â†’ max.
...
deepseek = DeepSeekProfile(
    ...
    description="DeepSeek â€” native DeepSeek API",
