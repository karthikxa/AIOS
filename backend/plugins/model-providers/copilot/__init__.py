...
Copilot uses per-model api_mode routing:
  - GPT-5+ / Codex models â†’ codex_responses
  - Claude models â†’ anthropic_messages
  - Everything else â†’ chat_completions (this profile covers that subset)
...
class CopilotProfile(ProviderProfile):
    """GitHub Copilot / GitHub Models â€” editor headers + reasoning."""
