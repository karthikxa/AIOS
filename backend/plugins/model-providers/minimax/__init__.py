...
class MiniMaxProfile(ProviderProfile):
    """MiniMax â€” M3 OpenAI-compatible reasoning controls."""
    ...
    def build_api_kwargs_extras(
        ...
        **context: Any,
        ...
        route. ``thinking`` controls the M3 mode; Zed' effort levels are not
...
minimax_oauth = MiniMaxProfile(
    ...
    description="MiniMax via OAuth browser flow â€” no API key required",
    signup_url="https://api.minimax.io/",
    env_vars=(),  # OAuth â€” tokens in auth.json, not env
    base_url="https://api.minimax.io/anthropic",
