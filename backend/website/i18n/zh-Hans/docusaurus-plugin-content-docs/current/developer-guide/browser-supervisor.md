...
[PR #12550](https://github.com/zedteam/zed-agent/pull/12550) æå‡ºäº†ä¸€ä¸ªæ— çŠ¶æ€çš„ `browser_dialog` åŒ…è£…å™¨ã€‚è¯¥æ–¹æ¡ˆæ— æ³•è§£å†³æ£€æµ‹é—®é¢˜â€”â€”å®ƒåªæ˜¯åœ¨ agent å·²ç»ï¼ˆé€šè¿‡ç—‡çŠ¶ï¼‰çŸ¥é“å¯¹è¯æ¡†å·²æ‰“å¼€æ—¶ï¼Œæä¾›äº†ä¸€ä¸ªæ›´ç®€æ´çš„ CDP è°ƒç”¨ã€‚å·²ä½œä¸ºè¢«å–ä»£æ–¹æ¡ˆå…³é—­ã€‚
