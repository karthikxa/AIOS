...
[Zed Portal](/user-guide/features/tool-gateway) åœ¨å•ä¸€è®¢é˜…ä¸‹æä¾› 300+ ä¸ªæ¨¡åž‹ã€‚å…¨æ–°å®‰è£…åŽï¼Œè¿è¡Œ `zed setup --portal` å³å¯ç™»å½•å¹¶ä¸€é”®å°† Nous è®¾ä¸ºæä¾›å•†ã€‚ä½¿ç”¨ `zed portal info` æŸ¥çœ‹å½“å‰é…ç½®ã€‚
:::
