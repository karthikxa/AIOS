---
title: "ç”Ÿç‰©ä¿¡æ¯å­¦ â€” æ¥è‡ª bioSkills å’Œ ClawBio çš„ 400+ ç”Ÿç‰©ä¿¡æ¯å­¦æŠ€èƒ½ç½‘å…³"
sidebar_label: "ç”Ÿç‰©ä¿¡æ¯å­¦"
description: "æ¥è‡ª bioSkills å’Œ ClawBio çš„ 400+ ç”Ÿç‰©ä¿¡æ¯å­¦æŠ€èƒ½ç½‘å…³"
---
...
æ¥è‡ª bioSkills å’Œ ClawBio çš„ 400+ ç”Ÿç‰©ä¿¡æ¯å­¦æŠ€èƒ½ç½‘å…³ã€‚æ¶µç›–åŸºå› ç»„å­¦ã€è½¬å½•ç»„å­¦ã€å•ç»†èƒžåˆ†æžã€å˜å¼‚æ£€æµ‹ã€è¯ç‰©åŸºå› ç»„å­¦ã€å®åŸºå› ç»„å­¦ã€ç»“æž„ç”Ÿç‰©å­¦ç­‰é¢†åŸŸã€‚æŒ‰éœ€èŽ·å–ç‰¹å®šé¢†åŸŸçš„å‚è€ƒèµ„æ–™ã€‚

## æŠ€èƒ½å…ƒæ•°æ®

| | |
|---|---|
| æ¥æº | å¯é€‰ â€” ä½¿ç”¨ `zed skills install official/research/bioinformatics` å®‰è£… |
| è·¯å¾„ | `optional-skills/research/bioinformatics` |
| ç‰ˆæœ¬ | `1.0.0` |
| å¹³å° | linux, macos |
| æ ‡ç­¾ | `bioinformatics`, `genomics`, `sequencing`, `biology`, `research`, `science` |

## å‚è€ƒï¼šå®Œæ•´ SKILL.md

:::info
ä»¥ä¸‹æ˜¯ Zed åœ¨è§¦å‘è¯¥æŠ€èƒ½æ—¶åŠ è½½çš„å®Œæ•´æŠ€èƒ½å®šä¹‰ã€‚è¿™æ˜¯ Agent åœ¨æŠ€èƒ½æ¿€æ´»æ—¶æ‰€çœ‹åˆ°çš„æŒ‡ä»¤å†…å®¹ã€‚
:::

# ç”Ÿç‰©ä¿¡æ¯å­¦æŠ€èƒ½ç½‘å…³

å½“è¢«é—®åŠç”Ÿç‰©ä¿¡æ¯å­¦ã€åŸºå› ç»„å­¦ã€æµ‹åºã€å˜å¼‚æ£€æµ‹ã€åŸºå› è¡¨è¾¾ã€å•ç»†èƒžåˆ†æžã€è›‹ç™½è´¨ç»“æž„ã€è¯ç‰©åŸºå› ç»„å­¦ã€å®åŸºå› ç»„å­¦ã€ç³»ç»Ÿå‘è‚²å­¦æˆ–ä»»ä½•è®¡ç®—ç”Ÿç‰©å­¦ä»»åŠ¡æ—¶ä½¿ç”¨ã€‚

æœ¬æŠ€èƒ½æ˜¯ä¸¤ä¸ªå¼€æºç”Ÿç‰©ä¿¡æ¯å­¦æŠ€èƒ½åº“çš„ç½‘å…³ã€‚å®ƒä¸æ‰“åŒ…æ•°ç™¾ä¸ªç‰¹å®šé¢†åŸŸçš„æŠ€èƒ½ï¼Œè€Œæ˜¯å¯¹å…¶å»ºç«‹ç´¢å¼•å¹¶æŒ‰éœ€èŽ·å–æ‰€éœ€å†…å®¹ã€‚

## æ¥æº

â—† **bioSkills** â€” 385 ä¸ªå‚è€ƒæŠ€èƒ½ï¼ˆä»£ç æ¨¡å¼ã€å‚æ•°æŒ‡å—ã€å†³ç­–æ ‘ï¼‰
  ä»“åº“ï¼šhttps://github.com/GPTomics/bioSkills
  æ ¼å¼ï¼šæ¯ä¸ªä¸»é¢˜ä¸€ä¸ª SKILL.mdï¼Œå«ä»£ç ç¤ºä¾‹ã€‚æ”¯æŒ Python/R/CLIã€‚

â—† **ClawBio** â€” 33 ä¸ªå¯è¿è¡Œçš„æµç¨‹æŠ€èƒ½ï¼ˆå¯æ‰§è¡Œè„šæœ¬ã€å¯å¤çŽ°æ€§åŒ…ï¼‰
  ä»“åº“ï¼šhttps://github.com/ClawBio/ClawBio
  æ ¼å¼ï¼šå¸¦æ¼”ç¤ºçš„ Python è„šæœ¬ã€‚æ¯æ¬¡åˆ†æžå¯¼å‡º report.md + commands.sh + environment.ymlã€‚

## å¦‚ä½•èŽ·å–å¹¶ä½¿ç”¨æŠ€èƒ½

1. ä»Žä¸‹æ–¹ç´¢å¼•ä¸­ç¡®å®šé¢†åŸŸå’ŒæŠ€èƒ½åç§°ã€‚
2. å…‹éš†ç›¸å…³ä»“åº“ï¼ˆæµ…å…‹éš†ä»¥èŠ‚çœæ—¶é—´ï¼‰ï¼š
   ```bash
   # bioSkillsï¼ˆå‚è€ƒèµ„æ–™ï¼‰
   git clone --depth 1 https://github.com/GPTomics/bioSkills.git /tmp/bioSkills

   # ClawBioï¼ˆå¯è¿è¡Œæµç¨‹ï¼‰
   git clone --depth 1 https://github.com/ClawBio/ClawBio.git /tmp/ClawBio
   ```
3. è¯»å–å…·ä½“æŠ€èƒ½ï¼š
   ```bash
   # bioSkills â€” æ¯ä¸ªæŠ€èƒ½ä½äºŽï¼š<category>/<skill-name>/SKILL.md
   cat /tmp/bioSkills/variant-calling/gatk-variant-calling/SKILL.md

   # ClawBio â€” æ¯ä¸ªæŠ€èƒ½ä½äºŽï¼šskills/<skill-name>/
   cat /tmp/ClawBio/skills/pharmgx-reporter/README.md
   ```
4. å°†èŽ·å–çš„æŠ€èƒ½ä½œä¸ºå‚è€ƒèµ„æ–™ä½¿ç”¨ã€‚è¿™äº›**ä¸æ˜¯** Zed æ ¼å¼çš„æŠ€èƒ½â€”â€”è¯·å°†å…¶è§†ä¸ºä¸“å®¶é¢†åŸŸæŒ‡å—ã€‚å®ƒä»¬åŒ…å«æ­£ç¡®çš„å‚æ•°ã€åˆé€‚çš„å·¥å…·æ ‡å¿—å’Œç»è¿‡éªŒè¯çš„æµç¨‹ã€‚

## æŒ‰é¢†åŸŸåˆ’åˆ†çš„æŠ€èƒ½ç´¢å¼•
...
ClawBio:
  seq-wrangler â€” åºåˆ—è´¨æŽ§ã€æ¯”å¯¹ä¸Ž BAM å¤„ç†ï¼ˆå°è£… FastQCã€BWAã€SAMtoolsï¼‰
...
ClawBio:
  vcf-annotator â€” ç»“åˆç¥–å…ˆèƒŒæ™¯çš„ VEP + ClinVar + gnomAD æ³¨é‡Š
  variant-annotation â€” å˜å¼‚æ³¨é‡Šæµç¨‹

### å·®å¼‚è¡¨è¾¾ï¼ˆBulk RNA-seqï¼‰
bioSkills:
...
ClawBio:
  rnaseq-de â€” å«è´¨æŽ§ã€å½’ä¸€åŒ–å’Œå¯è§†åŒ–çš„å®Œæ•´å·®å¼‚è¡¨è¾¾æµç¨‹
  diff-visualizer â€” å·®å¼‚è¡¨è¾¾ç»“æžœçš„ä¸°å¯Œå¯è§†åŒ–ä¸ŽæŠ¥å‘Š
...
ClawBio:
  scrna-orchestrator â€” å®Œæ•´ Scanpy æµç¨‹ï¼ˆè´¨æŽ§ã€èšç±»ã€æ ‡è®°åŸºå› ã€æ³¨é‡Šï¼‰
  scrna-embedding â€” åŸºäºŽ scVI çš„æ½œåœ¨åµŒå…¥ä¸Žæ‰¹æ¬¡æ•´åˆ
...
ClawBio:
  methylation-clock â€” è¡¨è§‚é—ä¼ å¹´é¾„ä¼°ç®—

### è¯ç‰©åŸºå› ç»„å­¦ä¸Žä¸´åºŠ
bioSkills:
...
ClawBio:
  pharmgx-reporter â€” åŸºäºŽ 23andMe/AncestryDNA çš„ PGx æŠ¥å‘Šï¼ˆ12 ä¸ªåŸºå› ã€31 ä¸ª SNPã€51 ç§è¯ç‰©ï¼‰
  drug-photo â€” è¯ç‰©ç…§ç‰‡ â†’ ä¸ªæ€§åŒ– PGx å‰‚é‡å¡ï¼ˆé€šè¿‡è§†è§‰è¯†åˆ«ï¼‰
  clinpgx â€” ç”¨äºŽåŸºå› -è¯ç‰©æ•°æ®å’Œ CPIC æŒ‡å—çš„ ClinPGx API
  gwas-lookup â€” è·¨ 9 ä¸ªåŸºå› ç»„æ•°æ®åº“çš„è”åˆå˜å¼‚æŸ¥è¯¢
  gwas-prs â€” åŸºäºŽæ¶ˆè´¹è€…åŸºå› æ•°æ®çš„å¤šåŸºå› é£Žé™©è¯„åˆ†
  nutrigx_advisor â€” åŸºäºŽæ¶ˆè´¹è€…åŸºå› æ•°æ®çš„ä¸ªæ€§åŒ–è¥å…»å»ºè®®
...
ClawBio:
  claw-ancestry-pca â€” åŸºäºŽ SGDP å‚è€ƒé¢æ¿çš„ç¥–å…ˆ PCA åˆ†æž

### å®åŸºå› ç»„å­¦ä¸Žå¾®ç”Ÿç‰©ç»„
bioSkills:
...
ClawBio:
  claw-metagenomics â€” é¸Ÿæžªæ³•å®åŸºå› ç»„åˆ†æžï¼ˆåˆ†ç±»ã€è€è¯ç»„ã€åŠŸèƒ½é€šè·¯ï¼‰
...
ClawBio:
  struct-predictor â€” æœ¬åœ° AlphaFold/Boltz/Chai ç»“æž„é¢„æµ‹ä¸Žæ¯”è¾ƒ
...
ClawBio:
  proteomics-de â€” è›‹ç™½è´¨ç»„å­¦å·®å¼‚è¡¨è¾¾åˆ†æž

### é€šè·¯åˆ†æžä¸ŽåŸºå› ç½‘ç»œ
bioSkills:
...
ClawBio:
  repro-enforcer â€” å°†ä»»æ„åˆ†æžå¯¼å‡ºä¸ºå¯å¤çŽ°æ€§åŒ…ï¼ˆConda çŽ¯å¢ƒ + Singularity + æ ¡éªŒå’Œï¼‰
  galaxy-bridge â€” è®¿é—® usegalaxy.org ä¸Šçš„ 8,000+ Galaxy å·¥å…·
...
ClawBio:
  profile-report â€” åˆ†æžæ¦‚å†µæŠ¥å‘Š
  data-extractor â€” ä»Žç§‘å­¦å›¾åƒä¸­æå–æ•°å€¼æ•°æ®ï¼ˆé€šè¿‡è§†è§‰è¯†åˆ«ï¼‰
  lit-synthesizer â€” PubMed/bioRxiv æ£€ç´¢ã€æ‘˜è¦ä¸Žå¼•ç”¨å›¾è°±
  pubmed-summariser â€” åŸºå› /ç–¾ç—… PubMed æ£€ç´¢ä¸Žç»“æž„åŒ–ç®€æŠ¥
...
ClawBio:
  ukb-navigator â€” è·¨ 12,000+ UK Biobank å­—æ®µçš„è¯­ä¹‰æœç´¢
  clinical-trial-finder â€” ä¸´åºŠè¯•éªŒå‘çŽ°
...
ClawBio:
  claw-semantic-sim â€” ç–¾ç—…æ–‡çŒ®è¯­ä¹‰ç›¸ä¼¼åº¦ç´¢å¼•ï¼ˆPubMedBERTï¼‰
  omics-target-evidence-mapper â€” è·¨ç»„å­¦æ¥æºçš„é¶ç‚¹çº§è¯æ®èšåˆ

## çŽ¯å¢ƒé…ç½®

è¿™äº›æŠ€èƒ½å‡è®¾åœ¨ç”Ÿç‰©ä¿¡æ¯å­¦å·¥ä½œç«™ä¸Šè¿è¡Œã€‚å¸¸è§ä¾èµ–é¡¹ï¼š
...
# CLI å·¥å…·ï¼ˆUbuntu/Debianï¼‰
sudo apt install samtools bcftools ncbi-blast+ minimap2 bedtools

# CLI å·¥å…·ï¼ˆmacOSï¼‰
brew install samtools bcftools blast minimap2 bedtools

# æˆ–é€šè¿‡ Condaï¼ˆæŽ¨èï¼Œä¾¿äºŽå¤çŽ°ï¼‰
conda install -c bioconda samtools bcftools blast minimap2 bedtools fastp kraken2
```

## æ³¨æ„äº‹é¡¹

- èŽ·å–çš„æŠ€èƒ½**ä¸æ˜¯** Zed SKILL.md æ ¼å¼ã€‚å®ƒä»¬ä½¿ç”¨å„è‡ªçš„ç»“æž„ï¼ˆbioSkillsï¼šä»£ç æ¨¡å¼æ‰‹å†Œï¼›ClawBioï¼šREADME + Python è„šæœ¬ï¼‰ã€‚è¯·å°†å…¶ä½œä¸ºä¸“å®¶å‚è€ƒèµ„æ–™é˜…è¯»ã€‚
- bioSkills æ˜¯å‚è€ƒæŒ‡å—â€”â€”å±•ç¤ºæ­£ç¡®çš„å‚æ•°å’Œä»£ç æ¨¡å¼ï¼Œä½†ä¸æ˜¯å¯æ‰§è¡Œçš„æµç¨‹ã€‚
- ClawBio æŠ€èƒ½æ˜¯å¯æ‰§è¡Œçš„â€”â€”è®¸å¤šå…·æœ‰ `--demo` æ ‡å¿—ï¼Œå¯ç›´æŽ¥è¿è¡Œã€‚
- ä¸¤ä¸ªä»“åº“å‡å‡è®¾å·²å®‰è£…ç”Ÿç‰©ä¿¡æ¯å­¦å·¥å…·ã€‚è¿è¡Œæµç¨‹å‰è¯·æ£€æŸ¥å‰ç½®æ¡ä»¶ã€‚
- å¯¹äºŽ ClawBioï¼Œè¯·å…ˆåœ¨å…‹éš†çš„ä»“åº“ä¸­è¿è¡Œ `pip install -r requirements.txt`ã€‚
- åŸºå› ç»„æ•°æ®æ–‡ä»¶å¯èƒ½éžå¸¸å¤§ã€‚ä¸‹è½½å‚è€ƒåŸºå› ç»„ã€SRA æ•°æ®é›†æˆ–æž„å»ºç´¢å¼•æ—¶è¯·æ³¨æ„ç£ç›˜ç©ºé—´ã€‚