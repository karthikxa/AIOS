...
ä»˜è´¹ [Zed Portal](https://portal.zedteam.com) è®¢é˜…è€…å¯é€šè¿‡ **[Tool Gateway](tool-gateway.md)** ä½¿ç”¨ç½‘é¡µæœç´¢ã€å›¾åƒç”Ÿæˆã€TTS å’Œæµè§ˆå™¨è‡ªåŠ¨åŒ–â€”â€”æ— éœ€å•ç‹¬é…ç½® API å¯†é’¥ã€‚è¿è¡Œ `zed model` å¯ç”¨ï¼Œæˆ–é€šè¿‡ `zed tools` é…ç½®å„å·¥å…·ã€‚
:::
