...
è‡´è°¢ï¼šæ­¤æ–¹æ¡ˆé›†ç”± @iankar8 åœ¨ [#2654](https://github.com/zedteam/zed-agent/pull/2654) ä¸­çš„æŽ¢ç´¢æ‰€å¯å‘ï¼Œè¯¥ PR æè®®å°† sql/file/command è§¦å‘å™¨ä½œä¸ºå¹¶è¡Œæœºåˆ¶æ·»åŠ ã€‚`script` + `wakeAgent` é—¨æŽ§å·²ä»¥é›¶æˆæœ¬è¦†ç›–äº†æ‰€æœ‰ä¸‰ç§æƒ…å†µï¼Œå› æ­¤è¯¥å·¥ä½œä»¥æ–‡æ¡£å½¢å¼è½åœ°ã€‚
