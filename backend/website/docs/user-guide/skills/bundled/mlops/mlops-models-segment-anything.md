---
title: "Segment Anything Model â€” SAM: zero-shot image segmentation via points, boxes, masks"
...
{
    "segmentation": np.ndarray,  # HÃ—W binary mask
...
- **[Advanced Usage](https://github.com/NousResearch/zed-agent/blob/main/skills/mlops/models/segment-anything/references/advanced-usage.md)** - Batching, fine-tuning, integration
- **[Troubleshooting](https://github.com/NousResearch/zed-agent/blob/main/skills/mlops/models/segment-anything/references/troubleshooting.md)** - Common issues and solutions
