---
title: "Simplify Code â€” Parallel 3-agent cleanup of recent code changes"
...
- Report findings as a concrete list: `file:line â†’ problem â†’ suggested fix`.
...
4. **Apply** the surviving fixes directly with `patch` / `write_file` â€” unless
