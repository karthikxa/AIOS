---
title: "Popular Web Designs â€” 54 real design systems (Stripe, Linear, Vercel) as HTML/CSS"
...
| Version | `1.0.0` |
| Author | Zed Agent + Teknium (design systems sourced from VoltAgent/awesome-design-md) |
| License | MIT |
...
- **`claude-design`** â€” use for the design *process and taste* (scoping a brief,
...
- **`design-md`** â€” use when the deliverable is a formal DESIGN.md token spec
...
Each template includes a **Zed Implementation Notes** block at the top with:
...
for sohne-var), follow the template's weight, size, and letter-spacing values closely â€”
