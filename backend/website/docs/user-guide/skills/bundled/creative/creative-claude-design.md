---
title: "Claude Design â€” Design one-off HTML artifacts (landing, deck, prototype)"
...
Zed has three design-related skills under `skills/creative/`. They do different jobs â€” load the right one (or combine them):
