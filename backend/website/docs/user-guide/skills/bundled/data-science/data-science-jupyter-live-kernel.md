---
title: "Jupyter Live Kernel â€” Iterative Python via live Jupyter kernel (hamelnb)"
...
| `execute_code` | One-shot scripts needing zed tool access (web_search, file ops). Stateless. |
