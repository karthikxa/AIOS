---
title: "Openhue â€” Control Philips Hue lights, scenes, rooms via OpenHue CLI"
...
- Bridge must be on the same local network as the machine running Zed
...
- Light and room names are case-sensitive â€” use `openhue get light` to check exact names
