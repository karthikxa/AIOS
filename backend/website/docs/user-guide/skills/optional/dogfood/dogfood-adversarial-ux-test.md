---
title: "Adversarial Ux Test â€” Roleplay the most difficult, tech-resistant user for your product"
...
| | |
|---|---|
| Source | Optional â€” install with `zed skills install official/dogfood/adversarial-ux-test` |
...
Roleplay the worst-case user for your product â€” the person who hates technology, doesn't want your software, and will find every reason to complain. Then filter their feedback through a pragmatism layer to separate real UX problems from "I hate computers" noise.

Think of it as an automated "mom test" â€” but angry.
...
2. **What is their tech comfort level?** (the lower the better â€” WhatsApp-only, paper notebooks, wife set up their email)
...
> **"Big Mick" McAllister** â€” 58-year-old S&C coach. Uses WhatsApp and that's it. His "spreadsheet" is a paper notebook. "If I can't figure it out in 10 seconds I'm going back to my notebook." Needs to log session results for 25 players. Hates small text, jargon, and passwords.

### Bad Persona Example
> "A user who doesn't like the app" â€” too vague, no constraints, no voice.
...
2. **Fully inhabit the persona** â€” their frustrations, limitations, goals
...
5. Test these friction categories:
   - **First impression** â€” would they even bother past the landing page?
   - **Core workflow** â€” the ONE thing they need to do most often
   - **Error recovery** â€” what happens when they do something wrong?
   - **Readability** â€” text size, contrast, information density
   - **Speed** â€” does it feel faster than their current method?
   - **Terminology** â€” any jargon they wouldn't understand?
   - **Navigation** â€” can they find their way back? do they know where they are?
...
Write the feedback AS THE PERSONA â€” in their voice, with their frustrations. This is not a bug report. This is a real human venting.
...
## Step 4: The Pragmatism Filter (Critical â€” Do Not Skip)

Step OUT of the persona. Evaluate each complaint as a product person:

- **RED: REAL UX BUG** â€” Any user would have this problem, not just grumpy ones. Fix it.
- **YELLOW: VALID BUT LOW PRIORITY** â€” Real issue but only for extreme users. Note it.
- **WHITE: PERSONA NOISE** â€” "I hate computers" talking, not a product problem. Skip it.
- **GREEN: FEATURE REQUEST** â€” Good idea hidden in the complaint. Consider it.

### Filter Criteria
1. Would a 35-year-old competent-but-busy user have the same complaint? â†’ RED
2. Is this a genuine accessibility issue (font size, contrast, click targets)? â†’ RED
3. Is this "I want it to work like paper" resistance to digital? â†’ WHITE
4. Is this a real workflow inefficiency the persona stumbled on? â†’ YELLOW or RED
5. Would fixing this add complexity for the 80% who are fine? â†’ WHITE
6. Does the complaint reveal a missing onboarding moment? â†’ GREEN
...
**Max 10 tickets per session** â€” focus on the worst issues.

## Step 6: Report

Deliver:
1. The persona rant (Step 3) â€” entertaining and visceral
2. The filtered assessment (Step 4) â€” pragmatic and actionable
3. Tickets created (Step 5) â€” with links
...
- **Register as a NEW user when possible.** Don't use pre-seeded admin accounts â€” the cold start experience is where most friction lives.
...
- **Check known issues in project docs AFTER the test.** If the persona found a bug that's already in the known issues list, that's actually the most damning finding â€” it means the team knew about it but never felt the user's pain.
...
These are starting points â€” customize for your specific product:
...
- Be genuinely mean but fair â€” find real problems, not manufactured ones
