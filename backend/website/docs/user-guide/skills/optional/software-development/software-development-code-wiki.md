...
- [`path/to/main.py`](https://github.com/zedteam/zed-agent/blob/main/optional-skills/software-development/code-wiki/<link>) â€” <what runs when you start it>
- [`path/to/cli.py`](https://github.com/zedteam/zed-agent/blob/main/optional-skills/software-development/code-wiki/<link>) â€” <CLI surface>

## High-Level Architecture

<2-3 sentences. Detail goes in architecture.md.>

See [architecture.md](https://github.com/zedteam/zed-agent/blob/main/optional-skills/software-development/code-wiki/architecture.md).

## Module Map

| Module | Purpose |
|---|---|
| [`<module>`](https://github.com/zedteam/zed-agent/blob/main/optional-skills/software-development/code-wiki/modules/<module>.md) | <one-line purpose> |

## Getting Started

See [getting-started.md](https://github.com/zedteam/zed-agent/blob/main/optional-skills/software-development/code-wiki/getting-started.md).
````
...
- **<Component>** â€” <1-2 sentences>. See [`modules/<module>.md`](https://github.com/zedteam/zed-agent/blob/main/optional-skills/software-development/code-wiki/modules/<module>.md).
...
1. **<Step>** â€” [`<file>`](https://github.com/zedteam/zed-agent/blob/main/optional-skills/software-development/code-wiki/<link>)
2. **<Step>** â€” [`<file>`](https://github.com/zedteam/zed-agent/blob/main/optional-skills/software-development/code-wiki/<link>)
...
- [`<module>/<file>`](https://github.com/zedteam/zed-agent/blob/main/optional-skills/software-development/code-wiki/<link>) â€” <what it does>
...
1. **User input** â€” [`cli.py:ZedCLI.run_session`](https://github.com/zedteam/zed-agent/blob/main/optional-skills/software-development/code-wiki/<link>)
2. **Message dispatch** â€” [`run_agent.py:AIAgent.chat`](https://github.com/zedteam/zed-agent/blob/main/optional-skills/software-development/code-wiki/<link>)
````
...
- Architecture: [architecture.md](https://github.com/zedteam/zed-agent/blob/main/optional-skills/software-development/code-wiki/architecture.md)
- Module reference: [README.md#module-map](https://github.com/zedteam/zed-agent/blob/main/optional-skills/software-development/code-wiki/README.md#module-map)
````
