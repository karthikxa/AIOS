---
title: "Duckduckgo Search â€” Free web search via DuckDuckGo â€” text, news, images, videos"
sidebar_label: "Duckduckgo Search"
description: "Free web search via DuckDuckGo â€” text, news, images, videos"
---
...
Free web search via DuckDuckGo â€” text, news, images, videos. No API key needed. Prefer the `ddgs` CLI when installed; use the Python DDGS library only after verifying that `ddgs` is available in the current runtime.

## Skill metadata

| | |
|---|---|
| Source | Optional â€” install with `zed skills install official/research/duckduckgo-search` |
