---
title: "Drug Discovery â€” Pharmaceutical research assistant for drug discovery workflows"
...
| | |
|---|---|
| Source | Optional â€” install with `zed skills install official/research/drug-discovery` |
...
1. **State raw values first** â€” MW, LogP, HBD, HBA, TPSA, RotBonds
2. **Apply rule sets** â€” Ro5 (Lipinski), Veber, Ghose filter where relevant
3. **Flag liabilities** â€” metabolic hotspots, hERG risk, high TPSA for CNS penetration
4. **Suggest optimizations** â€” bioisosteric replacements, prodrug strategies, ring truncation
5. **Cite the source API** â€” ChEMBL, PubChem, OpenFDA, or OpenTargets
