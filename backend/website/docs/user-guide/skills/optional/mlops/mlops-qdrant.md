---
title: "Qdrant Vector Search â€” High-performance vector similarity search engine for RAG and semantic search"
...
| | |
|---|---|
| Source | Optional â€” install with `zed skills install official/mlops/qdrant` |
...
| `EUCLID` | Spatial data, image features | 0 to âˆž |
| `DOT` | Recommendations, unnormalized | -âˆž to âˆž |
| `MANHATTAN` | Sparse features, discrete data | 0 to âˆž |
...
- **[Advanced Usage](https://github.com/NousResearch/zed-agent/blob/main/optional-skills/mlops/qdrant/references/advanced-usage.md)** - Distributed mode, hybrid search, recommendations
- **[Troubleshooting](https://github.com/NousResearch/zed-agent/blob/main/optional-skills/mlops/qdrant/references/troubleshooting.md)** - Common issues, debugging, performance tuning
