---
title: "Clip â€” OpenAI's model connecting vision and language"
sidebar_label: "Clip"
...
| | |
|---|---|
| Source | Optional â€” install with `zed skills install official/mlops/clip` |
...
- Cross-modal retrieval (imageâ†’text, textâ†’image)
...
6. **GPU recommended** - 10-50Ã— faster
