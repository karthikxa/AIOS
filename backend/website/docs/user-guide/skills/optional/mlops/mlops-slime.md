---
title: "Slime Rl Training â€” Provides guidance for LLM post-training with RL using slime, a Megatron+SGLang framework"
...
| | |
|---|---|
| Source | Optional â€” install with `zed skills install official/mlops/slime` |
...
- You need enterprise-grade stability features â†’ use **miles**
- You want flexible backend swapping â†’ use **verl**
- You need PyTorch-native abstractions â†’ use **torchforge**
