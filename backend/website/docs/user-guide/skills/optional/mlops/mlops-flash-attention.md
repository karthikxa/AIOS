...
| | |
|---|---|
| Source | Optional â€” install with `zed skills install official/mlops/flash-attention` |
...
- [ ] Step 1: Check PyTorch version (â‰¥2.2)
...
# Should be â‰¥(7, 5) for Turing+
```

Flash Attention requires:
- Ampere (A100, A10): âœ… Full support
- Turing (T4): âœ… Supported
- Volta (V100): âŒ Not supported
...
**Integration with HuggingFace Transformers**: See [references/transformers-integration.md](https://github.com/NousResearch/zed-agent/blob/main/optional-skills/mlops/flash-attention/references/transformers-integration.md) for enabling Flash Attention in BERT, GPT, Llama models.

**Performance benchmarks**: See [references/benchmarks.md](https://github.com/NousResearch/zed-agent/blob/main/optional-skills/mlops/flash-attention/references/benchmarks.md) for detailed speed and memory comparisons across GPUs and sequence lengths.
