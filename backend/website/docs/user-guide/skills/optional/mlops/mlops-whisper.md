---
title: "Whisper â€” OpenAI's general-purpose speech recognition model"
...
| | |
|---|---|
| Source | Optional â€” install with `zed skills install official/mlops/whisper` |
...
9. **Use faster-whisper** - 4Ã— faster than openai-whisper
...
*Real-time factor: 0.1 = 10Ã— faster than real-time*
...
- **GitHub**: https://github.com/openai/whisper â­ 72,900+
