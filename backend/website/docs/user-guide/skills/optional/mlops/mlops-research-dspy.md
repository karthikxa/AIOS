---
title: "Dspy â€” DSPy: declarative LM programs, auto-optimize prompts, RAG"
sidebar_label: "Dspy"
...
| | |
|---|---|
| Source | Optional â€” install with `zed skills install official/mlops/dspy` |
...
# Define a signature (input â†’ output)
...
Signatures define the structure of your AI task (inputs â†’ outputs):
