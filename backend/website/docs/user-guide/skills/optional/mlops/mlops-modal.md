---
title: "Modal Serverless Gpu â€” Serverless GPU cloud platform for running ML workloads"
...
| | |
|---|---|
| Source | Optional â€” install with `zed skills install official/mlops/modal` |
...
| Decorator | Use Case |
|-----------|----------|
| `@modal.fastapi_endpoint()` | Simple function â†’ API |
...
- **[Advanced Usage](https://github.com/NousResearch/zed-agent/blob/main/optional-skills/mlops/modal/references/advanced-usage.md)** - Multi-GPU, distributed training, cost optimization
- **[Troubleshooting](https://github.com/NousResearch/zed-agent/blob/main/optional-skills/mlops/modal/references/troubleshooting.md)** - Common issues and solutions
