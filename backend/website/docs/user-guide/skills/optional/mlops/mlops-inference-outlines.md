---
title: "Outlines â€” Outlines: structured JSON/regex/Pydantic LLM generation"
...
| | |
|---|---|
| Source | Optional â€” install with `zed skills install official/mlops/outlines` |
...
# âœ… Good: With constraints
class User(BaseModel):
    name: str = Field(min_length=1, max_length=100)
    age: int = Field(ge=0, le=120)
    email: str = Field(pattern=r"^[\w\.-]+@[\w\.-]+\.\w+$")

# âŒ Bad: No constraints
class User(BaseModel):
    name: str
    age: int
    email: str
...
|---------|----------|------------|----------|------|
| Pydantic Support | âœ… Native | âœ… Native | âŒ No | âŒ No |
| JSON Schema | âœ… Yes | âœ… Yes | âš ï¸ Limited | âœ… Yes |
| Regex Constraints | âœ… Yes | âŒ No | âœ… Yes | âœ… Yes |
| Local Models | âœ… Full | âš ï¸ Limited | âœ… Full | âœ… Full |
| API Models | âš ï¸ Limited | âœ… Full | âœ… Full | âœ… Full |
| Zero Overhead | âœ… Yes | âŒ No | âš ï¸ Partial | âœ… Yes |
| Automatic Retrying | âŒ No | âœ… Yes | âŒ No | âŒ No |
