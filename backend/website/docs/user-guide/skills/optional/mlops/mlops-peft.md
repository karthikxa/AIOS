---
title: "Peft Fine Tuning â€” Parameter-efficient fine-tuning for LLMs using LoRA, QLoRA, and 25+ methods"
...
| | |
|---|---|
| Source | Optional â€” install with `zed skills install official/mlops/peft` |
...
- **[Advanced Usage](https://github.com/NousResearch/zed-agent/blob/main/optional-skills/mlops/peft/references/advanced-usage.md)** - DoRA, LoftQ, rank stabilization, custom modules
- **[Troubleshooting](https://github.com/NousResearch/zed-agent/blob/main/optional-skills/mlops/peft/references/troubleshooting.md)** - Common errors, debugging, optimization
