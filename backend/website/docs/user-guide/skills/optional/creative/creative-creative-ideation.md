---
title: "Ideation â€” Generate project ideas via creative constraints"
...
| | |
|---|---|
| Source | Optional â€” install with `zed skills install official/creative/creative-ideation` |
...
1. **Pick a constraint** from the library below â€” random, or matched to the user's domain/mood
2. **Interpret it broadly** â€” a coding prompt can become a hardware project, an art prompt can become a CLI tool
3. **Generate 3 concrete project ideas** that satisfy the constraint
4. **If they pick one, build it** â€” create the project, write the code, ship it

## The Rule

Every prompt is interpreted as broadly as possible. "Does this include X?" â†’ Yes. The prompts provide direction and mild constraint. Without either, there is no creativity.
...
Pick something you admire â€” a tool, an artwork, an interface. Recreate it from scratch. The learning is in the gap between your version and theirs.
...
Think of something that would be a funny sentence. Work backwards to make it real. "I taught my thermostat to gaslight me" â†’ now build it.
...
| User says | Pick from |
|-----------|-----------|
| "I want to build something" (no direction) | Random â€” any constraint |
...
1. **[One-line pitch]**
   ...
   â± [weekend / week / month] â€¢ ðŸ”§ [stack]
...
1. **`git whatsup` â€” show what happened while you were away**
   ...
   â± weekend â€¢ ðŸ”§ Python, GitPython, click

2. **`explain 503` â€” HTTP status codes for humans**
   ...
   â± weekend â€¢ ðŸ”§ Rust or Go, static dataset

3. **`deps why <package>` â€” why is this in my dependency tree**
   ...
   â± weekend â€¢ ðŸ”§ Node.js, npm/yarn lockfile parsing
```

After the user picks one, start building â€” create the project, write the code, iterate.
