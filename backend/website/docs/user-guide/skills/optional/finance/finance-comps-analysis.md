...
description: "Build comparable company analysis in Excel â€” operating metrics, valuation multiples, statistical benchmarking vs peer sets"
---
...
Build comparable company analysis in Excel â€” operating metrics, valuation multiples, statistical benchmarking vs peer sets. Pairs with excel-author. Use for public-company valuation, IPO pricing, sector benchmarking, or outlier detection.

## Skill metadata

| | |
|---|---|
| Source | Optional â€” install with `zed skills install official/finance/comps-analysis` |
...
## âš ï¸ CRITICAL: Data Source Priority (READ FIRST)
...
## âš ï¸ CRITICAL: Formulas Over Hardcodes + Step-by-Step Verification

**Formulas, not hardcodes:**
- Every derived value (margin, multiple, statistic) MUST be an Excel formula referencing input cells â€” never a pre-computed number pasted in
- When using Python/openpyxl to build the sheet: write `cell.value = "=E7/C7"` (formula string), NOT `cell.value = 0.687` (computed result)
- The only hardcoded values should be raw input data (revenue, EBITDA, share price, etc.) â€” and every one of those gets a cell comment with its source
- Why: the model must update automatically when an input changes. A hardcoded margin is a silent bug waiting to happen.

**Verify step-by-step with the user:**
- After setting up the structure â†’ show the user the header layout before filling data
- After entering raw inputs â†’ show the user the input block and confirm sources/periods before building formulas
- After building operating metrics formulas â†’ show the calculated margins and sanity-check with the user before moving to valuation
- After building valuation multiples â†’ show the multiples and confirm they look reasonable before adding statistics
- Do NOT build the entire sheet end-to-end and then present it â€” catch errors early by confirming each section
...
Row 2: [List of Companies with Tickers] â€¢ [Company 1 (TICK1)] â€¢ [Company 2 (TICK2)] â€¢ [Company 3 (TICK3)]
...
**Default Color & Shading â€” Professional Blue/Grey Palette (minimal is better):**
- **Keep it restrained** â€” only blues and greys. Do NOT introduce greens, oranges, reds, or multiple accent colors. A clean comps sheet uses 3-4 colors total.
...
3. **Enterprise Value** - Market Cap Â± Net Debt/Cash
...
â†’ Focus on: EV/Revenue, EV/EBITDA, P/E, Market Cap
â†’ Skip: Operational details, growth metrics

**"Which company is most efficient?"**
â†’ Focus on: Gross Margin, EBITDA Margin, FCF Margin, Asset Turnover
â†’ Skip: Size metrics, absolute dollar amounts

**"Which company is growing fastest?"**
â†’ Focus on: Revenue Growth %, EBITDA CAGR, User/Customer Growth
â†’ Skip: Margin metrics, leverage ratios

**"Which is the best cash generator?"**
â†’ Focus on: FCF, FCF Margin, FCF Conversion, CapEx intensity
â†’ Skip: EBITDA, P/E ratios
...
2. **Add cell comments to ALL hard-coded inputs** - Right-click cell â†’ Insert Comment â†’ Document source OR assumption
   ...
   **For sourced data, cite exactly where it came from:**
   ...
   - **Include hyperlinks when possible**: Right-click cell â†’ Link â†’ paste URL to SEC filing, data source, or report
...
âŒ Mixing market cap and enterprise value in formulas
âŒ Using different time periods for numerator and denominator (LTM vs quarterly)
âŒ Hardcoding numbers into formulas instead of cell references
âŒ **Hard-coded inputs without cell comments citing the source OR explaining the assumption**
âŒ Missing hyperlinks to SEC filings or data sources when available
âŒ Including too many metrics without clear purpose
âŒ Including non-comparable companies (different business models)
âŒ Using outdated data without disclosure
âŒ Calculating averages of percentages incorrectly (should be median)
...
â”‚ TECHNOLOGY - COMPARABLE COMPANY ANALYSIS                    â”‚
â”‚ Microsoft â€¢ Alphabet â€¢ Amazon                               â”‚
â”‚ As of Q4 2024 | All figures in USD Millions                â”‚
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
â”‚ OPERATING METRICS                                           â”‚
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
â”‚ Company  â”‚ Revenue â”‚ Growth  â”‚ Gross    â”‚ EBITDA  â”‚ EBITDA â”‚
â”‚          â”‚ (LTM)   â”‚ (YoY)   â”‚ Margin   â”‚ (LTM)   â”‚ Margin â”‚
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”¤
...
â”‚ Median   â”‚ =MEDIAN â”‚ =MEDIAN â”‚ =MEDIAN  â”‚ =MEDIAN â”‚=MEDIAN â”‚
â”‚ 75th %   â”‚ =QUART  â”‚ =QUART  â”‚ =QUART   â”‚ =QUART  â”‚=QUART  â”‚
â”‚ 25th %   â”‚ =QUART  â”‚ =QUART  â”‚ =QUART   â”‚ =QUART  â”‚=QUART  â”‚
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
â”‚ VALUATION MULTIPLES                                         â”‚
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
â”‚ Company  â”‚ Mkt Cap  â”‚ EV       â”‚ EV/Rev   â”‚ EV/EBITDA â”‚ P/Eâ”‚
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”¤
...
â”‚          â”‚          â”‚          â”‚          â”‚           â”‚    â”‚ [blank row]
â”‚ Median   â”‚ =MEDIAN  â”‚ =MEDIAN  â”‚ =MEDIAN  â”‚ =MEDIAN   â”‚=MEDâ”‚
â”‚ 75th %   â”‚ =QUART   â”‚ =QUART   â”‚ =QUART   â”‚ =QUART    â”‚=QRTâ”‚
â”‚ 25th %   â”‚ =QUART   â”‚ =QUART   â”‚ =QUART   â”‚ =QUART    â”‚=QRTâ”‚
...
### Data Quality Issues
ðŸš© Inconsistent time periods (mixing quarterly and annual)  
ðŸš© Missing data without explanation  
ðŸš© Significant differences between data sources (>10% variance)

### Valuation Red Flags
ðŸš© Negative EBITDA companies being valued on EBITDA multiples (use revenue multiples instead)  
ðŸš© P/E ratios >100x without hypergrowth story  
ðŸš© Margins that don't make sense for the industry

### Comparability Issues
ðŸš© Different fiscal year ends (causes timing problems)  
ðŸš©ixing pure-play and conglomerates  
ðŸš© Materially different business models labeled as "comps"
...
3. **Choose metrics for your question** - Valuation analysis â‰  efficiency analysis
