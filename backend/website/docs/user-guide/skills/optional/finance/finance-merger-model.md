---
title: "Merger Model â€” Build accretion/dilution (merger) models in Excel â€” pro-forma P&L, synergies, financing mix, EPS impact"
sidebar_label: "Merger Model"
description: "Build accretion/dilution (merger) models in Excel â€” pro-forma P&L, synergies, financing mix, EPS impact"
---
...
Build accretion/dilution (merger) models in Excel â€” pro-forma P&L, synergies, financing mix, EPS impact. Pairs with excel-author. Use for M&A pitches, board materials, or deal evaluation.

## Skill metadata

| | |
|---|---|
| Source | Optional â€” install with `zed skills install official/finance/merger-model` |
...
- Include purchase price allocation â€” goodwill and intangible amortization matter for GAAP EPS
- Synergy phase-in is critical â€” Year 1 is often only 25-50% of run-rate synergies
