---
title: "Minecraft Modpack Server â€” Host modded Minecraft servers (CurseForge, Modrinth)"
...
| | |
|---|---|
| Source | Optional â€” install with `zed skills install official/gaming/minecraft-modpack-server` |
...
- **Server name / MOTD** â€” what should it say in the server list?
- **Seed** â€” specific seed or random?
- **Difficulty** â€” peaceful / easy / normal / hard?
- **Gamemode** â€” survival / creative / adventure?
- **Online mode** â€” true (Mojang auth, legit accounts) or false (LAN/cracked friendly)?
- **Player count** â€” how many players expected? (affects RAM & view distance tuning)
- **RAM allocation** â€” or let agent decide based on mod count & available RAM?
- **View distance / simulation distance** â€” or let agent pick based on player count & hardware?
- **PvP** â€” on or off?
- **Whitelist** â€” open server or whitelist only?
- **Backups** â€” want automated backups? How often?
...
### 2. Install Java
- Minecraft 1.21+ â†’ Java 21: `sudo apt install openjdk-21-jre-headless`
- Minecraft 1.18-1.20 â†’ Java 17: `sudo apt install openjdk-17-jre-headless`
- Minecraft 1.16 and below â†’ Java 8: `sudo apt install openjdk-8-jre-headless`
- Verify: `java -version`
...
## Pitfalls
- ALWAYS set `allow-flight=true` for modded â€” mods with jetpacks/flight will kick players otherwise
- `max-tick-time=180000` or higher â€” modded servers often have long ticks during worldgen
- First startup is SLOW (several minutes for big packs) â€” don't panic
...
- The pack's startserver.sh often has an auto-restart loop â€” make a clean launch script without it
