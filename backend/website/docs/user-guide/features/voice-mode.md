...
A paid [Nous Portal](/user-guide/features/tool-gateway) subscription supplies the LLM (step 2) **and** OpenAI TTS via the Tool Gateway â€” no separate OpenAI key needed. On a fresh install, `zed setup --portal` wires both up at once.
:::
