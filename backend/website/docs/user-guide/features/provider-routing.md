...
:::tip
Traffic routed through [Zed Portal](/integrations/nous-portal) still respects per-model routing and priority configs â€” and Portal subscribers get 10% off token-billed providers.
:::
