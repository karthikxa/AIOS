...
:::tip
This recipe hits web search, summarization, and optional TTS â€” all bundled in a Portal subscription. The fastest setup is `zed setup --portal`. See [Zed Portal](/integrations/nous-portal).
:::
