...
import type { ModelOptionsResponse, SessionInfo } from '@/types/zed'
 ...
 *
 * Only the leading status prefix (e.g. "Zed is thinking...") and the
 * obvious placeholder echoes are stripped. We deliberately do NOT trim
 * the delta â€” reasoning streams as small chunks (often individual tokens
 ...
 * outside media roots") on a local path the gateway can't read yet â€” flashing a
