...
function placeholderChild(parentId: string): TreeNode {
  return { id: `${parentId}::${PLACEHOLDER_ID}`, isDirectory: false, name: 'Loadingâ€¦', placeholder: 'loading' }
}
...
export interface UseProjectTreeResult {
  ...
  data: TreeNode[]
  /** Directory actually displayed â€” differs from the requested cwd when the
 ...
 *  prefers the configured default project dir). Local connections only â€”
