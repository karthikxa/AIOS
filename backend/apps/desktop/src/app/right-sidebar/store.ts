...
const TAKEOVER_KEY = 'zed.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Zed can't clear via the API â€” the user
 *  sees exactly what runs instead of Zed silently deleting their creds. */
