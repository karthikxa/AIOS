import type { zedReviewFile } from '@/global'
...
export function buildReviewFlatList(files: zedReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: zedReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
