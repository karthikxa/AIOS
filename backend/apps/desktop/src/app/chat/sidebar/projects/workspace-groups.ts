...
import type { ProjectInfo, SessionInfo } from '@/zed'
 ...
 * repo shows its branches/worktrees even when they have no zed sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: zedGitWorktree[]
): SidebarSessionGroup[] {
