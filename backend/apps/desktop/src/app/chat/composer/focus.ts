...
const FOCUS_EVENT = 'zed:composer-focus'
const INSERT_EVENT = 'zed:composer-insert'
const INSERT_REFS_EVENT = 'zed:composer-insert-refs'
...
/** Insert typed ref chips (carrying a display label) into a composer â€” the
