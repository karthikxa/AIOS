...
import { getGlobalModelInfo } from '@/zed'
...
import type { ModelOptionsResponse } from '@/types/zed'
...
export function useModelControls({ activeSessionId, queryClient, requestGateway }: ModelControlsOptions) {
  ...
  // default â€” that lives in Settings â†’ Model â€” so picking a model here can't
