...
// Edge inset used when no left-side native controls take up that space â€”
...
// shared <Button size="icon-titlebar"> (used polymorphically via asChild) â€”
...
// Title row inside the header â€” must stay in the flex truncate chain.
...
export function titlebarControlsPosition(
  windowButtonPosition: ZedConnection['windowButtonPosition'] | undefined,
  isFullscreen = false
) {
