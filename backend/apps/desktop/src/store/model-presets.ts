...
const STORAGE_KEY = 'zed.desktop.model-presets'
 ...
 *  fall back to the Zed default (medium effort, no fast). */
 ...
 *  No-ops without a session â€” the gateway's `config.set` reasoning/fast fall
