...
import { getActionStatus, restartGateway } from '@/zed'
import { translateNow } from '@/i18n'
import { notifyError } from '@/store/notifications'
import type { ActionResponse } from '@/types/zed'

const POLL_ATTEMPTS = 18
const POLL_INTERVAL_MS = 1200
const POLL_TIMEOUT_S = 180

// True while a gateway restart is in flight â€” drives the statusbar gateway
...
// indicator. Self-contained and never rejects, so every trigger â€” Cmd+K, the
// messaging save/toggle toasts â€” gets identical feedback from a plain
