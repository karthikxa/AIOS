...
const SIDEBAR_PINNED_STORAGE_KEY = 'zed.desktop.pinnedSessions'
const SIDEBAR_AGENTS_GROUPED_STORAGE_KEY = 'zed.desktop.agentsGroupedByWorkspace'
const SIDEBAR_CRON_OPEN_STORAGE_KEY = 'zed.desktop.sidebarCronOpen'
const SIDEBAR_MESSAGING_OPEN_STORAGE_KEY = 'zed.desktop.sidebarMessagingOpen'
const SIDEBAR_SESSION_ORDER_STORAGE_KEY = 'zed.desktop.sessionOrder'
const SIDEBAR_SESSION_ORDER_MANUAL_STORAGE_KEY = 'zed.desktop.sessionOrder.manual'
const SIDEBAR_WORKSPACE_ORDER_STORAGE_KEY = 'zed.desktop.workspaceOrder'
const SIDEBAR_WORKSPACE_PARENT_ORDER_STORAGE_KEY = 'zed.desktop.workspaceParentOrder'
const PANES_FLIPPED_STORAGE_KEY = 'zed.desktop.panesFlipped'
...
// scheduler's `[IMPORTANT: â€¦]` first-message previews don't spam recents.
...
// preview rail move to the left â€” a mirror of the default layout.
...
// Hotkey â†’ focus the sessions search field. Opens the sidebar first, then lets
// the field (which only mounts when the sidebar is open) subscribe + focus.
export const SESSION_SEARCH_FOCUS_EVENT = 'zed:focus-session-search'
