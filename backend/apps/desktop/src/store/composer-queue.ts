...
const STORAGE_KEY = 'zed.desktop.composerQueue.v1'
 ...
 * idle and has pending entries, NOT only on an observed busy true â†’ false edge.
 * A backend bounce / websocket reconnect remounts the composer and resets the
 * busy ref to the current value, swallowing the settle edge â€” an edge-gated
