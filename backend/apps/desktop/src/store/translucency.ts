 ...
 *
 * One lever, 0â€“100. 0 = off (fully opaque, the default). Higher = more of the
 * desktop shows through the whole window â€” the main process maps it to the
...
const KEY = 'zed.desktop.translucency.v1'
...
if (typeof window !== 'undefined') {
  $translucency.subscribe(intensity => {
    ...
    window.zedDesktop?.setTranslucency?.({ intensity })
  })
}
