...
const desktopWindow = window as unknown as { zedDesktop?: Window['zedDesktop'] }
const initialZedDesktop = desktopWindow.zedDesktop
...
function installBridge(
  openSessionWindow?: Window['zedDesktop']['openSessionWindow'],
  openNewSessionWindow?: Window['zedDesktop']['openNewSessionWindow']
) {
  desktopWindow.zedDesktop = {
    ...(openSessionWindow ? { openSessionWindow } : {}),
    ...(openNewSessionWindow ? { openNewSessionWindow } : {})
  } as unknown as Window['zedDesktop']
}
...
afterEach(() => {
  if (initialZedDesktop) {
    desktopWindow.zedDesktop = initialZedDesktop
  } else {
    delete desktopWindow.zedDesktop
  }
})
