...
const POPOUT_ENABLED_STORAGE_KEY = 'zed.desktop.composerPopout.enabled'
const POPOUT_POSITION_STORAGE_KEY = 'zed.desktop.composerPopout.position'
...
function readPosition(): PopoutPosition {
  ...
  try {
    ...
    // Corrupt value â€” fall back to the default corner.
  }
...
/** Move the box (state only). Used per-frame during a drag â€” no IO. Returns the
