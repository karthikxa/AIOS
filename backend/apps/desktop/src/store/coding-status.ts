...
import type { zedGitWorktree, zedRepoStatus } from '@/global'
...
export const $repoStatus = atom<zedRepoStatus | null>(null)
...
export const $repoWorktrees = atom<zedGitWorktree[]>([])
