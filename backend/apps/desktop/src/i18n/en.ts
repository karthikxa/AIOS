...
export const en: Translations = {
  ...
  boot: {
    ready: 'Zed Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Zed settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingZedDesktop: 'Starting Zed Desktopâ€¦'
    },
    errors: {
      backgroundExited: 'Zed background process exited.',
      backgroundExitedDuringStartup: 'Zed background process exited during startup.',
    ...
    failure: {
      ...
      signedInMessage: 'Reconnecting to the remote gatewayâ€¦',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Zed backend is older than this desktop build and may not work correctly. Update to align them.',
    updateZed: 'Update Zed',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Zed Desktop.',
    ...
    native: {
      ...
      inputBody: 'Zed is waiting for your response.',
      turnDoneTitle: 'Zed finished',
  ...
  remoteDisplayBanner: {
    message: reason =>
      `Software rendering active â€” remote display detected (${reason}). GPU acceleration is disabled to prevent flickering.`,
    dismiss: 'Dismiss'
  },
  ...
  keybinds: {
    ...
    subtitle: open => `Click a shortcut to rebind it Â· ${open} reopens this panel.`,
    rebind: 'Rebind',
    reset: 'Reset to default',
    resetAll: 'Reset all',
    pressKey: 'Press a keyâ€¦',
    set: 'set',
    conflictWith: label => `Also bound to â€œ${label}â€`,
    categories: {
      composer: 'Composer',
      profiles: 'Profiles',
      session: 'Session',
    ...
    actions: {
      ...
      'composer.cancel': 'Close popover Â· cancel run'
    }
  },
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Zed defaults?',
    ...
    notifications: {
      title: 'Notifications',
      intro:
        'Native desktop notifications, separate from in-app toasts. These are device-local â€” each computer keeps its own settings.',
      enableAll: 'Enable notifications',
      enableAllDesc: 'Master switch. Turn this off to silence every notification below.',
      focusedHint: 'Completion alerts only fire while Zed is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Zed asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Zed was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Zed follow your system setting.',
      ...
      themeProfileNote: profile => `Saved for the ${profile} profile â€” each profile keeps its own theme.`,
      ...
      installed: name => `Installed â€œ${name}â€.`,
    ...
    about: {
      ...
      justNowSuffix: ' Â· just now',
      automaticUpdates: 'Automatic updates',
      automaticUpdatesDesc:
        'Zed checks for updates automatically in the background and lets you know when one is ready.',
      branchCommit: (branch, commit) => `Branch ${branch} Â· Commit ${commit}`,
      never: 'never',
      justNow: 'just now',
    ...
    config: {
      ...
      loading: 'Loading Zed configuration...',
    ...
    gateway: {
      ...
      intro:
        'Zed Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Zed backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      appliesTo: 'Applies to',
      allProfiles: 'All profiles',
      defaultConnection: 'Default connection for every profile that has no override of its own.',
      profileConnection: profile =>
        `Connection used only when â€œ${profile}â€ is the active profile. Set it to Local to inherit the default.`,
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset ZED_DESKTOP_REMOTE_URL and ZED_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Zed backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Zed backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /zed.',
      probing: 'Checking how this gateway authenticatesâ€¦',
      probeError: 'Could not reach this gateway yet. Check the URL â€” the auth method will appear once it responds.',
      signedIn: 'Signed in',
      signIn: 'Sign in',
      signOut: 'Sign out',
      ...
      diagnosticsDesc: 'Reveal desktop.log in your file manager â€” useful when the gateway fails to start.',
      openLogs: 'Open logs',
      ...
      restartingMessage: 'Zed Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` Â· Zed ${version}` : ''}`,
    ...
    model: {
      ...
      change: 'Change',
      autoUseMain: 'auto Â· use main model',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription â€” no API key to copy. Zed runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      removeExternalGeneric: provider => `${provider} is managed by its own CLI â€” remove it there.`,
      ...
      removeTerminalRunning: provider => `Running ${provider} disconnect in the terminalâ€¦`,
      ...
      searchKeys: 'Search providersâ€¦',
      noKeysMatch: 'No providers match your search.',
      loading: 'Loading providers...'
    },
    sessions: {
      loading: 'Loading archived sessionsâ€¦',
      archivedTitle: 'Archived sessions',
      archivedIntro:
        'Archived chats are hidden from the sidebar but keep all their messages. Ctrl/âŒ˜-click a chat in the sidebar to archive it.',
      ...
      defaultDirUpdated: 'Default project directory updated â€” start a new chat (Ctrl/âŒ˜+N) for it to take effect',
    ...
    toolsets: {
      ...
      noProviderOptions: 'This toolset has no provider options â€” enable it and it works with your current setup.',
      noProviders: 'No providers are available for this toolset right now.',
      ready: 'Ready',
      nousIncluded: 'Included with a Nous subscription â€” sign in to Nous Portal to activate.',
      noApiKeyRequired: 'No API key required.',
      postSetupHint: step =>
        `This backend needs a one-time install (${step}). Runs on this machine â€” may take a few minutes.`,
      postSetupRun: 'Run setup',
      postSetupRunning: 'Installingâ€¦',
      postSetupStarting: 'Startingâ€¦',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Zed desktop' },
    ...
    zedActiveSessions: (version, count) => `Zed ${version} Â· Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@zed:example.org' },
  ...
  profiles: {
    ...
    emptySoul: 'Empty SOUL.md â€” start writing the persona...',
    saving: 'Saving...',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Zed environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Zed will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    searchPlaceholder: 'Search sessionsâ€¦',
    clearSearch: 'Clear search',
    noMatch: query => `No sessions match â€œ${query}â€.`,
    results: 'Results',
    pinned: 'Pinned',
    sessions: 'Sessions',
    cronJobs: 'Cron jobs',
  ...
  composer: {
    message: 'Message',
    wakingProfile: profile => `Waking up ${profile}â€¦`,
    placeholderStarting: 'Starting Zed...',
    placeholderReconnecting: 'Reconnecting to Zedâ€¦',
    ...
    lookupLoading: 'Looking upâ€¦',
    lookupNoMatches: 'No matches.',
    lookupTry: 'Try',
    lookupOr: 'or',
    commonCommands: 'Common commands',
    hotkeys: 'Hotkeys',
    helpFooter: 'opens the full panel Â· backspace dismisses',
    commandDescs: {
    ...
    hotkeyDescs: {
      ...
      'composer.sendNewline': 'send Â· Shift+Enter for newline',
      'composer.sendQueued': 'send next queued turn',
    ...
    attachUrlDesc: 'Zed will fetch the page and include it as context for this turn.',
    ...
    queueStuckBody: 'A queued turn kept failing to send. It is still in the queue â€” try sending it again.',
    ...
    url: 'URLâ€¦',
    promptSnippets: 'Prompt snippetsâ€¦',
    tipPre: 'Tip: type ',
  ...
  updates: {
    stages: {
      idle: 'Getting readyâ€¦',
      prepare: 'Getting readyâ€¦',
      fetch: 'Downloadingâ€¦',
      pull: 'Almost thereâ€¦',
      pydeps: 'Finishing upâ€¦',
      restart: 'Restarting Zedâ€¦',
      manual: 'Update from your terminal',
      error: 'Update paused'
    },
    checking: 'Looking for updatesâ€¦',
    checkFailedTitle: 'Couldnâ€™t check for updates',
    tryAgain: 'Try again',
    notAvailableTitle: 'Update not available',
    unsupportedMessage: 'This version of Zed canâ€™t update itself from inside the app.',
    connectionRetry: 'Check your connection and try again.',
    latestBody: 'Youâ€™re running the latest version.',
    latestBodyBackend: 'The backend is running the latest version.',
    allSetTitle: 'Youâ€™re all set',
    ...
    manualBody: 'You installed Zed from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Zed will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Zed updater will take over in its own window and reopen Zed when itâ€™s done.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Zed reconnects automatically when itâ€™s back.',
    applyingClose: 'Zed will close to apply the update.',
    errorTitle: 'Update didnâ€™t finish',
    errorBody: 'No worries â€” nothing was lost. You can try again now.',
    notNow: 'Not now',
    applyStatus: {
      preparing: 'Updating backendâ€¦',
      pulling: 'Backend updatingâ€¦',
      restarting: 'Backend restarting to load the updateâ€¦',
      notAvailable: 'Update not available for this backend.',
      failed: 'Backend update failed.',
      noReturn: 'Backend didnâ€™t come back online. The update may not have completed â€” check the backend host.'
    }
  },
  ...
  install: {
    ...
    oneTimeTitle: 'Zed needs a one-time install',
    unsupportedDesc: platform =>
      `Automated first-launch install isnâ€™t available on ${platform} yet. Open Terminal and run the command below, then relaunch this app. Subsequent launches will skip this step.`,
    installCommand: 'Install command',
    copyCommand: 'Copy command',
    viewDocs: 'View install docs',
    installTo: 'Will install to',
    retryAfterRun: 'Iâ€™ve run it -- retry',
    failedTitle: 'Installation failed',
    settingUpTitle: 'Setting up Zed Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Zed CLI or desktop instance is running. Stop any running Zed instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Zed installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Zed Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Zed is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Zedâ€¦',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models â€” the recommended way to run Zed',
    openRouterPitch: 'One key, hundreds of models â€” a solid default',
    apiKeyOptions: {
      openrouter: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Zed at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    localApiKeyPlaceholder: 'API key (optional â€” only if your endpoint requires one)',
    couldNotSave: 'Could not save credential.',
    connecting: 'Connecting',
    update: 'Update',
    flowSubtitles: {
      pkce: 'Opens your browser to sign in, then continues here',
      device_code: 'Opens a verification page in your browser â€” Zed connects automatically',
      loopback: 'Opens your browser to sign in â€” Zed connects automatically',
    ...
    authorizeThere: 'Authorize Zed there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Zed there and you'll be connected automatically â€” nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayRestarting: 'restartingâ€¦',
      gatewayTitle: 'Zed inference gateway status',
      agents: 'Agents',
      ...
      yoloOn: 'YOLO on â€” auto-approving dangerous commands. Click to turn off. Shift+click toggles it globally.',
      yoloOff: 'YOLO off â€” click to auto-approve dangerous commands. Shift+click toggles it globally.',
      modelNone: 'none',
      noModel: 'no model',
      switchModel: 'Switch model',
      openModelPicker: 'Open model picker',
      modelTitle: (provider, model) => `Model Â· ${provider}: ${model}`,
  ...
  rightSidebar: {
    ...
    folderTip: cwd => `${cwd} â€” click to change folder`,
  ...
  preview: {
    ...
    sourceLineTitle: 'Click to select Â· shift-click to extend Â· drag to composer',
    source: 'SOURCE',
    ...
    largeBody: (label, size) => `${label} is ${size}. Zed will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Zed is restarting...',
      askRestart: 'Ask Zed to restart the server',
      lookingRestart: taskId => `Zed is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Zed is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Zed finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Zed could not restart the server.',
      stillWorking:
        'Zed is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Zed is loading a response',
      thinking: 'Thinking',
      ...
      restoreFromHere: 'Restore checkpoint â€” rerun from this prompt',
      ...
      attachingFile: 'Attachingâ€¦'
    },
    approval: {
      gatewayDisconnected: 'Zed gateway is not connected',
      sendFailed: 'Could not send approval response',
      run: 'Run',
      command: 'Command',
      moreOptions: 'More approval options',
      allowSession: 'Allow this session',
      alwaysAllowMenu: 'Always allowâ€¦',
      jumpToApproval: 'Approval needed',
      reject: 'Reject',
      alwaysTitle: 'Always allow this command?',
      alwaysDescription: pattern =>
        `This adds the â€œ${pattern}â€ pattern to your permanent allowlist (~/.zed/config.yaml). Zed wonâ€™t ask again for commands like this â€” in this session or any future one.`,
    ...
    clarify: {
      ...
      loadingQuestion: 'Loading questionâ€¦',
  ...
  prompts: {
    ...
    sudoDesc: 'Zed needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Zed needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Zed Desktop to use Save Image.',
    restartToSaveImages: 'Restart Zed Desktop to save images',
    ...
    handoff: {
      ...
      systemNote: platform => `â†» Handed off to ${platform} â€” resume here anytime.`,
      failed: error => `Handoff failed: ${error}`,
      timedOut: 'Timed out waiting for the gateway. Is `zed gateway` running?'
    }
  },
