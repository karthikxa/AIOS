 ...
 * an installed theme shows up everywhere a built-in does â€” the Cmd-K palette,
 * the Appearance settings grid, and `/skin` â€” with no per-surface wiring.
 *
...
const USER_THEMES_KEY = 'zed-desktop-user-themes-v1'

// The minimal set of color keys a stored theme must carry to be usable. We keep
// this loose â€” `applyTheme` tolerates missing optionals via fallbacks â€” but a
