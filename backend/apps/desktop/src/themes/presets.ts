 ...
 * Add new themes here â€” no code changes needed elsewhere.
 */
...
/**
 * Nous â€” canonical Zed desktop identity. The palette keeps the current
...
/** Warm crimson and bronze â€” forge vibes. Matches the CLI ares skin. */
...
export const slateTheme: DesktopTheme = {
  name: 'slate',
  label: 'Slate',
  description: 'Cool slate blue â€” focused developer theme',
  colors: {
    background: '#0d1117',
    foreground: '#c9d1d9',
    card: '#161b22',
