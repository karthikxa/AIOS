...
PAIRING_DIR = get_zed_dir("platforms/pairing", "pairing")
...
class PairingStore:
    ...
    def approve_code(self, platform: str, code: str) -> Optional[dict]:
        ...
        with self._lock:
            ...
            # malformed entries â€” skip them rather than KeyError, so an
    ...
    def list_pending(self, platform: str = None) -> list:
        ...
        Codes are stored hashed â€” the ``code`` field is replaced with the
