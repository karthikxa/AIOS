...
~/.zed/channel_directory.json.  The send_message tool reads this file for
...
DIRECTORY_PATH = get_zed_home() / "channel_directory.json"
...
CHANNEL_ALIASES_PATH = get_zed_home() / "channel_aliases.json"
...
async def build_channel_directory(adapters: Dict[Any, Any]) -> Dict[str, Any]:
    ...
    # platforms â€” everything else falls through to _build_from_sessions().
...
def _build_discord(adapter) -> List[Dict[str, str]]:
    ...
    try:
        import discord as _discord  # noqa: F401 â€” SDK presence check
    except ImportError:
        return channels
    ...
    for guild in client.guilds:
        ...
        # Forum channels (type 15) â€” creating a message auto-spawns a thread post.
...
def _build_from_sessions(platform_name: str) -> List[Dict[str, str]]:
    ...
    sessions_path = get_zed_home() / "sessions" / "sessions.json"
...
def resolve_channel_name(platform_name: str, name: str) -> Optional[str]:
    ...
    # 0. Exact ID match â€” case-sensitive, no normalization. Lets callers pass
