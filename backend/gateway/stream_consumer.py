...
class GatewayStreamConsumer:
    ...
    # MEDIA_TAG_CLEANUP_RE from gateway/platforms/base.py â€” only tags whose
    ...
    async def _send_commentary(self, text: str) -> bool:
        ...
        try:
            ...
            # multiple tool calls. See: https://github.com/NousResearch/zed-agent/issues/10454
            if result.success:
    ...
    def _adapter_prefers_fresh_final(self, text: str) -> bool:
        ...
        currently renders richer markdown than Zed' MarkdownV2 edit path.
