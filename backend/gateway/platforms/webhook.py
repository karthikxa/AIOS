...
Each route defines:
  ...
  - deliver_only: if true, skip the agent â€” the rendered prompt IS the
...
class WebhookAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        for name, route in self._routes.items():
            ...
            # deliver_only routes bypass the agent â€” the POST body becomes a
    ...
    def _reload_dynamic_routes(self) -> None:
        ...
        try:
            ...
            # Reject any dynamic route whose effective secret is empty â€”
    ...
    def _resolve_request_profile(self, request: "web.Request"):
        ...
        if not getattr(cfg, "multiplex_profiles", False):
            # Prefix supplied but multiplexing is off â€” ignore it, behave as
    ...
    async def _handle_webhook(self, request: "web.Request") -> "web.Response":
        ...
        # â”€â”€ Auth-before-body â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Rate limiting (after auth) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        now = time.time()
        ...
        # â”€â”€ Idempotency â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Direct delivery mode (deliver_only) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        # Skip the agent entirely â€” the rendered prompt IS the message we
        ...
        if route_config.get("deliver_only"):
            ...
            # Delivery attempted but target rejected it â€” surface as 502
    ...
    async def _direct_deliver(
        ...
        work in agent mode work here â€” Telegram, Discord, Slack, GitHub
        PR comments, etc.
        """
        deliver_type = delivery.get("deliver", "log")

        if deliver_type == "log":
            # Shouldn't reach here â€” startup validation rejects deliver_only
            # with deliver=log â€” but guard defensively.
