...
async def delete_comment_reaction(
    ...
    *,
    ...
    Best-effort â€” errors are logged but not raised.
    """
    body = {
        "action": "delete",
        "reply_id": reply_id,
...
async def _reverse_lookup_wiki_token(
    ...
    # code != 0: either not a wiki doc or service error â€” log and return None
...
The quoted content is your primary anchor â€” insert/summarize/explain requests are about it.
