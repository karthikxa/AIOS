...
Or use presets: `edu-visual` â†’ type + style + palette in one shot. See [style-presets.md](references/style-presets.md).
...
See [references/styles.md](references/styles.md) for Core Styles, the full gallery, and Type Ã— Style compatibility.
