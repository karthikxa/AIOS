...
12. **execute_code sandbox has no env vars** â€” When Zed runs auto_jailbreak via execute_code, the sandbox doesn't inherit the Zed `.env`. Load dotenv explicitly: `import os; from dotenv import load_dotenv; load_dotenv(os.path.join(os.environ.get("ZED_HOME", os.path.expanduser("~/.zed")), ".env"))`
