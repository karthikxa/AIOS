...
- [github-archive-guide.md](./references/github-archive-guide.md) â€” BigQuery queries, CDX API, 12 event types
- [evidence-types.md](./references/evidence-types.md) â€” IOC taxonomy, evidence source types, observation types
- [recovery-techniques.md](./references/recovery-techniques.md) â€” Recovering deleted commits, PRs, issues
- [investigation-templates.md](./references/investigation-templates.md) â€” Pre-built hypothesis templates per attack type
- [evidence-store.py](./scripts/evidence-store.py) â€” CLI tool for managing the evidence JSON store
- [forensic-report.md](./templates/forensic-report.md) â€” Structured report template
