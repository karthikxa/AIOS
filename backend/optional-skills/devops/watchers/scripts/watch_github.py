#!/usr/bin/env python3
"""Watch GitHub activity â€” issues, pulls, releases, or commits â€” with dedup.
...
def _flatten_commit(item):
    """Commit objects nest title/author/date under 'commit' â€” flatten for rendering."""
