...
- [`path/to/main.py`](<link>) â€” <what runs when you start it>
- [`path/to/cli.py`](<link>) â€” <CLI surface>
...
- **<Component>** â€” <1-2 sentences>. See [`modules/<module>.md`](modules/<module>.md).
...
- [`<module>/<file>`](<link>) â€” <what it does>
...
1. **User input** â€” [`cli.py:ZedCLI.run_session`](<link>)
2. **Message dispatch** â€” [`run_agent.py:AIAgent.chat`](<link>)
````
