...
Data file: $ZED_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ZED_HOME = Path(os.environ.get("ZED_HOME", Path.home() / ".zed"))
DATA_DIR = _ZED_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
