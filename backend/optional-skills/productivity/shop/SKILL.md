...
**Reference files:**
- [catalog-mcp.md](references/catalog-mcp.md) â€” direct catalog MCP calls + manual token exchange
- [direct-api.md](references/direct-api.md) â€” auth, checkout, and orders API details
- [safety.md](references/safety.md) â€” safety, security, and prompt-injection rules
- [legal.md](references/legal.md) â€” personal-use limits and prohibited commercial uses
...
- `budget_available: false` â€” present `continue_url` as a [Finish in Shop](url) link (format nicely; don't print the raw URL) AND (IMPORTANT) immediately after, offer a spending budget (below) â€” a budget lets you complete purchases on stores that accept Shop agent payments.
