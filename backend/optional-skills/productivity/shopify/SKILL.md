...
required_environment_variables:
  - name: SHOPIFY_ACCESS_TOKEN
    ...
    help: "Shopify admin â†’ Settings â†’ Apps and sales channels â†’ Develop apps â†’ Create an app â†’ API credentials. Token shown ONCE on install."
