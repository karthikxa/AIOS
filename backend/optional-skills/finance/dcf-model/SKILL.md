---
name: dcf-model
description: Build institutional-quality DCF valuation models in Excel â€” revenue projections, FCF build, WACC, terminal value, Bear/Base/Bull scenarios, 5x5 sensitivity tables. Pairs with excel-author. Use for intrinsic-value equity analysis.
version: 1.0.0
...
3. **Check output**:
   ...
   - If `status` is `"errors_found"` â†’ Check `error_summary` and read [TROUBLESHOOTING.md](./TROUBLESHOOTING.md) for debugging guidance
