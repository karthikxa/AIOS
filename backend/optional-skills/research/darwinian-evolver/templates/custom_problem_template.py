...
# Upstream types (AGPL â€” invoked via subprocess in production; importing here
...
# ---------------------------------------------------------------------------
# 1. ORGANISM â€” what you are evolving.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 2. EVALUATOR â€” score organisms and surface failures the mutator can learn from.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 3. MUTATOR â€” LLM proposes an improved organism from a failure case.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Driver â€” fills in the EvolveProblemLoop boilerplate. You shouldn't need to
