...
Lifecycle:
  ...
  6. on_session_end() called at real session boundaries (CLI exit, /reset,
     gateway session expiry) â€” NOT per-turn
"""
...
class ContextEngine(ABC):
    ...
    def compress(
        ...
        DAG, or do anything else â€” as long as the returned list is a valid
    ...
    def has_content_to_compress(self, messages: List[Dict[str, Any]]) -> bool:
        ...
        Used by the gateway ``/compress`` command as a preflight guard â€”
    ...
    def on_session_start(self, session_id: str, **kwargs) -> None:
        ...
        kwargs may include zed_home, platform, model, etc.
        """
    ...
    def on_session_end(self, session_id: str, messages: List[Dict[str, Any]]) -> None:
        ...
        NOT called per-turn â€” only when the session truly ends.
        """
