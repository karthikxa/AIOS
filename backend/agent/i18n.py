"""Lightweight internationalization (i18n) for Zed static user-facing messages.

Scope (thin slice, by design): only the highest-impact static strings shown
to the user by Zed itself -- approval prompts, a handful of gateway slash
...
Language resolution order:
    ...
    2. ``ZED_LANGUAGE`` environment variable (for tests / quick override)
...
_LANGUAGE_ALIASES: dict[str, str] = {
    ...
    # Simplified Chinese â€” explicit codes route here; bare "chinese" / "mandarin"
    # also default to Simplified since that's the larger user base.
    "chinese": "zh", "mandarin": "zh", "zh-cn": "zh", "zh-hans": "zh", "zh-sg": "zh",
    # Traditional Chinese â€” distinct catalog.  Cover Taiwan / Hong Kong / Macau
    ...
    "spanish": "es", "espaÃ±ol": "es", "espanol": "es", "es-es": "es", "es-mx": "es", "es-ar": "es",
    "french": "fr", "franÃ§ais": "fr", "france": "fr", "fr-fr": "fr", "fr-be": "fr", "fr-ca": "fr", "fr-ch": "fr",
    "ukrainian": "uk", "ukrainisch": "uk", "ÑƒÐºÑ€Ð°Ñ—Ð½ÑÑŒÐºÐ°": "uk", "uk-ua": "uk", "ua": "uk",
    "turkish": "tr", "tÃ¼rkÃ§e": "tr", "tr-tr": "tr",
    # Afrikaans â€” South African Dutch-derived language; "af-ZA" is the common BCP-47 tag.
    "afrikaans": "af", "af-za": "af",
    # Korean
    "korean": "ko", "í•œêµ­ì–´": "ko", "ko-kr": "ko",
    # Italian
    "italian": "it", "italiano": "it", "it-it": "it", "it-ch": "it",
    # Irish (Gaeilge) â€” ga is the BCP-47 code
    "irish": "ga", "gaeilge": "ga", "ga-ie": "ga",
    # Portuguese â€” bare "portuguese" routes to European Portuguese; pt-br
    ...
    # Russian
    "russian": "ru", "Ñ€ÑƒÑÑÐºÐ¸Ð¹": "ru", "ru-ru": "ru",
    # Hungarian
...
def _locales_dir() -> Path:
    ...
    1. ``ZED_BUNDLED_LOCALES`` env var -- set by the Nix wrapper (or any
    ...
    """
    override = os.getenv("ZED_BUNDLED_LOCALES", "").strip()
    if override:
        candidate = Path(override)
        if candidate.is_dir():
            return candidate
        logger.warning(
            "ZED_BUNDLED_LOCALES points to a non-directory path (%s); "
...
def _load_catalog(lang: str) -> dict[str, str]:
    ...
    try:
        import yaml  # PyYAML is already a zed dependency
...
def reset_language_cache() -> None:
    ...
    Call after :func:`zed_cli.config.save_config` if a running process
...
def get_language() -> str:
    ...
    env_lang = os.environ.get("ZED_LANGUAGE")
    if env_lang:
