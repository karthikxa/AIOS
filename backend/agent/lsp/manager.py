...
The service is **off by default** â€” call :meth:`is_active` to check
...
class _BackgroundLoop:
    ...
    Provides :meth:`run` for synchronous callers â€” submits a coroutine
...
class LSPService:
    ...
    def __init__(
        ...
        *,
        ...
        # Delta baseline: file path â†’ snapshot of diagnostics taken
    ...
    def create_from_config(cls) -> Optional["LSPService"]:
        """Build a service from ``zed_cli.config`` settings.
    ...
    def enabled_for(self, file_path: str) -> bool:
        ...
        layer skips the LSP path entirely â€” no spawn attempts, no
        timeout cost â€” until the service is restarted (``zed lsp
    ...
    def snapshot_baseline(self, file_path: str) -> None:
        ...
        can filter out pre-existing errors.  Best-effort â€” failures
    ...
    def get_diagnostics_sync(
        ...
        *,
        ...
        different line numbers in the post-edit snapshot â€” without
    ...
    def _mark_broken_for_file(self, file_path: str, exc: BaseException) -> None:
        ...
        ``exc`` is whatever exception the outer wrapper caught â€” used
        ...
        if client is not None:
            try:
                # Fire-and-forget shutdown â€” give it a second to cleanup,
    ...
    # ------------------------------------------------------------------
    # status / introspection (used by ``zed lsp status``)
    # ------------------------------------------------------------------
...
def _diag_key(d: Dict[str, Any]) -> str:
    ...
    Includes the diagnostic's position range â€” when used together
