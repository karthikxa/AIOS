...
- ``set_secret_scope(mapping)`` installs the active profile's secrets for the
  ...
  via ``copy_context()`` exactly like the ZED_HOME override).
...
# â”€â”€ multiplex-active flag â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ the secret scope contextvar â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ genuinely-global env vars (NOT per-profile secrets) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# multiplex mode â€” routing them through the fail-closed path would wrongly
...
_GLOBAL_ENV_EXACT = frozenset({
    # Zed runtime / deployment
    "ZED_HOME", "ZED_PROFILE", "ZED_GATEWAY_LOCK_DIR",
    "ZED_MAX_ITERATIONS", "ZED_MAX_TOKENS", "ZED_API_TIMEOUT",
    "ZED_REDACT_SECRETS", "ZED_NOUS_TIMEOUT_SECONDS",
    "_ZED_GATEWAY",
    # OS / interpreter
    "PATH", "HOME", "USER", "LANG", "LC_ALL", "TZ", "PWD", "SHELL", "TMPDIR",
    "VIRTUAL_ENV", "PYTHONPATH", "SSL_CERT_FILE",
    # Kanban paths (per-board, not per-profile-secret)
    "ZED_KANBAN_DB", "ZED_KANBAN_WORKSPACES_ROOT", "ZED_KANBAN_BOARD",
})
_GLOBAL_ENV_PREFIXES = (
    "ZED_KANBAN_",
    "ZED_TELEGRAM_",   # tuning knobs (batch delays, fallback toggles) â€” NOT the token
...
def get_secret(name: str, default: Optional[str] = None) -> Optional[str]:
    ...
    2. When a secret scope is installed (multiplexed turn), read from it; an
       absent key returns ``default``. The scope is authoritative â€” we do NOT
...
def load_env_file(env_path: Path) -> Dict[str, str]:
    ...
    mutates the process environment â€” that isolation is the whole point.
    """
...
def build_profile_secret_scope(zed_home: Path) -> Dict[str, str]:
    ...
    """
    return load_env_file(Path(zed_home) / ".env")
