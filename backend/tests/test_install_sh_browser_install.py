...
Browser automation is optional. The installer should not leave Zed
...
def test_install_script_skips_playwright_download_when_system_browser_exists() -> None:
    ...
    assert "Skipping Playwright browser download; Zed will use the system browser." in text
...
def test_playwright_installs_are_timeout_guarded() -> None:
    ...
    # service users fall back to the browser-only install â€” see
