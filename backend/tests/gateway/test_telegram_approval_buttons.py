...
# ===========================================================================
# send_exec_approval â€” inline keyboard buttons
# ===========================================================================
...
# _handle_callback_query â€” approval button clicks
# ===========================================================================
...
class TestTelegramApprovalCallback:
    ...
    async def test_already_resolved(self):
        adapter = _make_adapter()
        # No state for approval_id 99 â€” already resolved
        ...
        # Should NOT resolve â€” already handled
        mock_resolve.assert_not_called()
