...
from zed_cli.goals import CONTINUATION_PROMPT_TEMPLATE
...
async def test_goal_status_notice_uses_adapter_send_with_thread_metadata():
    ...
    "âœ“ Goal achieved" status line being delivered to Discord/Telegram.
    """
    ...
    await runner._send_goal_status_notice(source, "âœ“ Goal achieved: done")

    assert adapter.calls == [
        {
            "chat_id": "parent-channel",
            "content": "âœ“ Goal achieved: done",
            "reply_to": None,
...
async def test_goal_status_notice_defers_until_post_delivery_callback():
    ...
    await runner._defer_goal_status_notice_after_delivery(source, "âœ“ Goal achieved: done")
