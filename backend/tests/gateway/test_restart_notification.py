"""Tests for /restart notification â€” the gateway notifies the requester on comeback."""
...
# â”€â”€ restart marker helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ _handle_restart_command writes .restart_notify.json â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async def test_restart_command_writes_notify_file(tmp_path, monkeypatch):
    ...
    assert "thread_id" not in data  # no thread â†’ omitted
...
async def test_sethome_updates_running_config_for_same_process_restart(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("zed_cli.config.save_env_value", _fake_save_env_value)
...
# â”€â”€ home-channel startup notifications â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async def test_send_home_channel_startup_notification_to_configured_home(tmp_path, monkeypatch):
    ...
    adapter.send.assert_called_once_with(
        "home-42",
        "â™»ï¸ Gateway online â€” Zed is back and ready.",
    )
...
# â”€â”€ _send_restart_notification â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async def test_send_restart_notification_logs_warning_on_sendresult_failure(
    ...
    logged "Sent restart notification to ..." at INFO â€” masking real
...
async def test_send_home_channel_startup_notification_default_flag_true(
    ...
    runner, adapter = make_restart_runner()
    # Sanity-check the dataclass default â€” guards against future refactors
...
async def test_send_restart_notification_skipped_when_flag_disabled(
    ...
    Slack used by end users â†’ flag off â†’ no "Gateway restarted" message even
...
async def test_shutdown_notifications_use_cached_live_thread_source_when_origin_missing():
    ...
    adapter.send.assert_awaited_once_with(
        "parent-42",
        "âš ï¸ Gateway shutting down â€” Your current task will be interrupted.",
