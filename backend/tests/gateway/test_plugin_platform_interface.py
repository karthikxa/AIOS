...
Discovers platforms dynamically under ``plugins/platforms/`` â€” no manual
enumeration â€” and verifies each one implements the required contract.
"""
...
class _MockPluginContext:
    """Minimal mock of zed_cli.plugins.PluginContext.
