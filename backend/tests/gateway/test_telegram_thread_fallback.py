...
Supergroup forum topics route with ``message_thread_id``. Zed-created
...
# â”€â”€ Fake telegram.error hierarchy â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async def test_send_typing_preserves_general_topic_thread_id():
    ...
    Regression guard for the d5357f816 refactor that mapped "1" â†’ None in
...
async def test_send_typing_attempts_api_call_for_dm_topic_reply_fallback():
    """Zed-created DM topic lanes should still attempt scoped typing.
...
@pytest.mark.asyncio
async def test_send_uses_reply_fallback_for_zed_dm_topics():
    """Zed-created Telegram DM topics route with thread id plus reply anchor."""
    adapter = _make_adapter()
    call_log = []
...
async def test_send_uses_metadata_reply_fallback_for_streaming_dm_topics():
    """Metadata-only sends still stay in Zed-created Telegram DM topics."""
    adapter = _make_adapter()
    call_log = []
