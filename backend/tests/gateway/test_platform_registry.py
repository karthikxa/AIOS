...
# â”€â”€ Platform enum dynamic members â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ PlatformRegistry â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestPlatformRegistry:
    ...
    def test_create_adapter_factory_exception(self):
        ...
        reg.register(entry)
        # factory raises â†’ create_adapter returns None instead of propagating
...
# â”€â”€ GatewayConfig integration â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Extended PlatformEntry fields â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestPlatformEntryExtendedFields:
    ...
    def test_custom_auth_fields(self):
        ...
        assert entry.emoji == "ðŸ’¬"


# â”€â”€ Cron platform resolution â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ platforms.py integration â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestPlatformsMerge:
    ...
    def test_get_all_platforms_includes_builtins(self):
        from zed_cli.platforms import get_all_platforms, PLATFORMS
        merged = get_all_platforms()
        for key in PLATFORMS:
            assert key in merged

    def test_get_all_platforms_includes_plugin(self):
        from zed_cli.platforms import get_all_platforms
        from gateway.platform_registry import platform_registry as _reg
    ...
    def test_platform_label_plugin_fallback(self):
        from zed_cli.platforms import platform_label
        from gateway.platform_registry import platform_registry as _reg
...
# â”€â”€ apply_yaml_config_fn (PlatformEntry field + load_gateway_config dispatch) â”€â”€


class TestApplyYamlConfigFnField:
    """The hook field itself â€” defaults, custom values, signature."""
...
class TestApplyYamlConfigFnDispatch:
    ...
    a tmp ZED_HOME, calls load_gateway_config(), and asserts the hook
    ...
    def _write_config(self, tmp_path, content: str):
        ...
        zed_home.mkdir()
        (zed_home / "config.yaml").write_text(content, encoding="utf-8")
        return zed_home
...
class TestPluginPlatformSharedKeyBridge:
    ...
    ``allow_from``, etc.) â€” defeating the hook's whole point of letting
    ...
    def test_shared_keys_bridged_for_plugin_platform(self, tmp_path, monkeypatch):
        ...
        try:
            ...
            assert extra.get("reply_prefix") == "â†’ "
...
class TestPluginEnablementGate:
    ...
    with no token â€” emitting noisy retry-forever errors on every fresh
    ...
    def test_plugin_without_is_connected_falls_back_to_check_fn(
        ...
        alone remains the contract â€” that's what callers without a
    ...
    def test_is_connected_raises_does_not_enable(self, tmp_path, monkeypatch):
        ...
        Treat a raising is_connected as "configuration unknown" â€” refuse to
    ...
    def test_yaml_enabled_true_overrides_is_connected_false(
        ...
        that â€” they may be using a credential mechanism the plugin's
        ...
        try:
            ...
            assert cfg.platforms[plat].enabled is True, (
                ...
                "is_connected=False â€” user has the final say"
            )
        finally:
    ...
    def test_is_connected_sees_env_seeded_extras(self, tmp_path, monkeypatch):
        ...
        try:
            ...
            assert plat in cfg.platforms, (
                "is_connected was called with empty extras â€” "
