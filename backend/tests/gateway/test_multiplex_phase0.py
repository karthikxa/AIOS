...
Covers the three Phase 0 deliverables:
  ...
  2. ``zed_cli.profiles.profiles_to_serve`` enumeration.
...
class TestSessionKeyNamespacedWhenOn:
    ...
    def test_positional_layout_preserved_for_parsers(self):
        ...
        assert parts[2] == "discord"  # platform â€” unchanged offset
        assert parts[3] == "group"  # chat_type â€” unchanged offset
        assert parts[4] == "g1"  # chat_id â€” unchanged offset
