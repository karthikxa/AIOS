"""Tests for gateway/pairing.py â€” DM pairing security system."""
...
class TestCodeGeneration:
    ...
    def test_stores_pending_entry(self, tmp_path):
        ...
        # list_pending no longer returns the original code â€” it returns a
...
class TestLegacyPendingFileCompat:
    ...
    those entries â€” they should be ignored and aged out at TTL.
    """
    ...
    def test_approve_code_ignores_legacy_entries(self, tmp_path):
        ...
        with patch("gateway.pairing.PAIRING_DIR", tmp_path):
            ...
            store = PairingStore()
            # The plaintext "code" used to be the key â€” under the new schema
...
class TestLockout:
    def test_lockout_after_max_failures(self, tmp_path):
        with patch("gateway.pairing.PAIRING_DIR", tmp_path):
            ...
            # Platform should now be locked out â€” can't generate new codes
    ...
    def test_lockout_blocks_code_approval(self, tmp_path):
        ...
        approve_code() never consulted it â€” so any valid code already
        ...
        with patch("gateway.pairing.PAIRING_DIR", tmp_path):
            ...
            # Simulate lockout expiry â€” the valid code is still in pending
