...
class TestGenerate:
    ...
    def test_successful_url_response(self):
        """xAI URL response is cached locally â€” #26942 contract.
        ...
        assert "imgen.x.ai" not in result["image"], (
            "ephemeral xAI URL must not leak into result.image â€” caller will 404"
        )
    ...
    def test_url_response_falls_back_to_bare_url_when_download_fails(self):
        ...
        provider must NOT hard-error â€” fall through to returning the bare
        ...
        assert result["success"] is True, (
            "Cache failure must not turn into a tool error â€” gateway gets a chance to retry"
        )
    ...
    def test_auth_header(self):
        ...
        assert "Zed-Agent" in headers["User-Agent"]
    ...
    def test_payload_resolution_is_literal_1k_or_2k(self):
        ...
        payload carries that literal â€” not a numeric mapping. See PR #18678.
        """
        from plugins.image_gen.xai import XAIImageGenProvider
