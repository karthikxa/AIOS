...
# 1Ã—1 transparent PNG â€” valid bytes for save_b64_image()
_PNG_HEX = (
...
def _tmp_zed_home(tmp_path, monkeypatch):
...
# â”€â”€ Model resolution â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestGenerate:
    ...
    def test_b64_saves_to_cache(self, provider, tmp_path):
        ...
        # gpt-image-2 rejects response_format â€” we must NOT send it.
    ...
    def test_url_response_falls_back_to_bare_url_when_download_fails(self, provider):
        """Cache failure must not turn into a tool error â€” symmetric with xAI."""
