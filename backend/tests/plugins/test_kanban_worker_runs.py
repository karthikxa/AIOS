...
def _load_plugin_router():
    ...
    mod_name = "zed_dashboard_plugin_kanban_worker_runs_test"
...
def test_inspect_run_dead_pid(client, monkeypatch):
    ...
    plugin_mod_name = "zed_dashboard_plugin_kanban_worker_runs_test"
...
def test_terminate_run_409_task_not_reclaimable(client, monkeypatch):
    ...
    try:
        ...
        # Task left in default 'ready' state with no claim_lock â€” task_run
