...
def _ensure_redaction_enabled(monkeypatch):
    """Ensure ZED_REDACT_SECRETS is not disabled by prior test imports."""
...
class TestDiscordMentions:
    ...
    secrets â€” they must pass through the redactor unchanged so multi-bot
...
class TestWebUrlsNotRedacted:
    """Web URLs (http/https/wss) pass through unchanged â€” magic-link
    ...
    def test_known_prefix_inside_url_still_redacted(self):
        ...
        _PREFIX_RE / _JWT_RE â€” the carve-out is for opaque tokens only."""
    ...
    def test_db_connstr_password_still_redacted(self):
        ...
        userinfo redaction via _DB_CONNSTR_RE â€” connection strings are
