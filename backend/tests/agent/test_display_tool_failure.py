...
specific reason in square brackets at the end of the completion line â€”
not a generic "[error]".
"""
...
class TestTrimError:
    ...
    def test_file_not_found_path_collapsed_to_filename(self):
        long_path = "File not found: /home/teknium/.zed/zed-agent/very/deep/path/foo.py"
...
class TestDetectToolFailureStructured:
    ...
    def test_dict_without_error_or_success_uses_generic_heuristic(self):
        # Plain successful dict â€” should pass through the generic
...
class TestGetCuteToolMessageFailureSuffix:
    ...
    def test_no_result_has_no_suffix(self):
        # No result passed at all â€” display function should not invent a
        # failure suffix.
