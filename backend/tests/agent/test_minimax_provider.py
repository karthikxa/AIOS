"""Tests for MiniMax provider hardening â€” context lengths, thinking, catalog, beta headers, transport."""
...
class TestMinimaxContextLengths:
    ...
    def test_minimax_m3_resolves_to_1m(self):
        ...
        # 1,048,576 (1024Â²). Either is correct â€” assert "â‰¥ 1M, not 204,800".
...
class TestMinimaxM3StaleCacheGuard:
    ...
    def test_stale_m3_cache_dropped_and_reresolves(self, tmp_path, monkeypatch):
        ...
        # registry currently reports 512,000) â€” both are large-context values
    ...
    def test_m2_cache_not_clobbered(self, tmp_path, monkeypatch):
        ...
        importlib.reload(mm)
        base = "https://api.minimaxi.com/anthropic"
        # 204,800 is the CORRECT value for M2.x â€” guard must not touch it.
...
class TestMinimaxAuxModel:
    ...
    tier â€” see ``test_minimax_profile.py`` for the per-provider split.
...
class TestMinimaxPreserveDots:
    ...
    hyphens â€” the endpoint expects the exact name with dots.
    """
