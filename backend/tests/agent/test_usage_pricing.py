...
def test_normalize_usage_openai_reads_top_level_anthropic_cache_fields():
    ...
    Regression guard for the bug fixed in cline/cline#10266 â€” before this fix,
...
def test_normalize_usage_openai_prefers_prompt_tokens_details_over_top_level():
    ...
    usage = SimpleNamespace(
        ...
        # Intentionally different values â€” proving we ignore these when details exist.
...
def test_nous_portal_pricing_preserves_vendor_prefixed_model_ids(monkeypatch):
    ...
    assert seen["base_url"] == "https://inference-api.zedteam.com/v1"
...
def test_deepseek_v4_pro_pricing_entry_exists():
    ...
    in zed insights because the _OFFICIAL_DOCS_PRICING table had no
...
def test_deepseek_v4_pro_estimate_usage_cost():
    ...
    # 1M input Ã— $1.74/M + 500K output Ã— $3.48/M = $1.74 + $1.74 = $3.48
