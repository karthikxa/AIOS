...
5. Full 429 rotation cycle: retry-same â†’ rotate â†’ exhaust â†’ fallback
"""
...
class TestCliTurnRoutePool:
    def test_resolve_turn_includes_pool(self):
        ...
        bound = ZedCLI._resolve_turn_agent_config.__get__(shell)
...
class TestPoolRotationCycle:
    """Verify the retry-same â†’ rotate â†’ exhaust flow in _recover_with_credential_pool."""
