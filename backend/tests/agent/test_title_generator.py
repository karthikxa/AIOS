"""Tests for agent.title_generator â€” auto-generated session titles."""
...
class TestGenerateTitle:
    ...
    def test_default_prompt_matches_user_language(self):
        ...
        with patch("agent.title_generator.call_llm", return_value=mock_response) as llm:
            generate_title("è³ªå•ã§ã™", "å›žç­”ã§ã™")
...
class TestAutoTitleSession:
    """Tests for auto_title_session() â€” the sync worker function."""
...
class TestMaybeAutoTitle:
    """Tests for maybe_auto_title() â€” the fire-and-forget entry point."""
