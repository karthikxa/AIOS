...
def test_metadata_as_dict_with_zed():
    """Normal case: metadata is a dict containing zed keys."""
    frontmatter = {
        "metadata": {
            "zed": {
...
# â”€â”€ skill_matches_platform on Termux â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestSkillMatchesPlatformTermux:
    ...
    in May 2026 â€” only 3 built-in skills appeared on Termux because every
    ...
    def test_no_platforms_field_matches_everywhere(self):
        # Backward-compat default â€” skills without a platforms tag load
    ...
    def test_linux_skill_loads_on_termux_linux_platform(self):
        # Pre-3.13 Termux reports sys.platform == "linux" already â€” this
    ...
    def test_explicit_termux_or_android_tag_matches(self):
        ...
        # platforms:[android] â€” both should match a Termux session.
        with patch("agent.skill_utils.sys.platform", "android"), patch(
            "agent.skill_utils.is_termux", return_value=True
        ):
    ...
    def test_non_termux_android_does_not_widen(self):
        ...
        # silently load Linux skills â€” Termux is the supported environment.
        fm = {"platforms": ["linux"]}
        with patch("agent.skill_utils.sys.platform", "android"), patch(
