"""Tests for network.force_ipv4 â€” the socket.getaddrinfo monkey-patch."""
...
def _reload_constants():
    """Reload zed_constants to get a fresh apply_ipv4_preference."""
...
class TestApplyIPv4Preference:
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "_zed_ipv4_patched", False) is True
