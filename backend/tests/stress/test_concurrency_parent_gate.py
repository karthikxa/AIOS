...
not 'done'. The claim_task gate added in zed_cli/kanban_db.py must
...
def run() -> int:
    home = tempfile.mkdtemp(prefix="zed_parent_gate_stress_")
    ...
    def racy_creator() -> None:
        ...
        This is the pre-fix _kanban_create behavior â€” the very race
