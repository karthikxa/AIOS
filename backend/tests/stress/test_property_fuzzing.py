...
def assert_invariants(conn, kb, ops_log):
    ...
    # I1: current_run_id â†’ run exists and not ended
    ...
    # I2: open run â†’ some task points at it
    ...
    # Skip â€” autoincrement guarantees it.
    ...
    # I9: if all parents done â†’ child not in todo
...
def main():
    ...
    for seq_idx in range(NUM_SEQUENCES):
        ...
        home = tempfile.mkdtemp(prefix=f"zed_fuzz_{seq_idx}_")
    ...
    if total_violations == 0:
        print("\nâœ” ALL INVARIANTS HELD ACROSS RANDOMIZED SEQUENCES")
    else:
        print("\nâœ— INVARIANT VIOLATIONS FOUND")
        sys.exit(1)
