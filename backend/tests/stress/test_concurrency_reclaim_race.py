...
(no, it should refuse â€” the claim was invalidated), OR succeed by
...
def main():
    home = tempfile.mkdtemp(prefix="zed_reclaim_race_")
    ...
    if reclaim_runs == 0:
        failures.append("NO RECLAIMS HAPPENED â€” test didn't stress what it was supposed to")
    ...
    if failures:
        ...
        print("\nâœ” RECLAIM RACE INVARIANTS HELD")
