...
or future reviews. Not a pass/fail test â€” records numbers so we know
...
def main():
    home = tempfile.mkdtemp(prefix="zed_bench_")
    ...
    for n in [100, 1000, 10000]:
        ...
        kb.init_db()
        conn = kb.connect()
        seed_tasks(conn, kb, n, assignee=None)  # no assignee â†’ won't spawn
        r = bench(
