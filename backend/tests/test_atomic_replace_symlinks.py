"""Regression tests for GitHub #16743 â€” atomic writes must preserve symlinks.

``os.replace(tmp, target)`` replaces whatever exists at ``target`` â€” including
symlinks, which it swaps for a regular file.  Managed deployments that
symlink ``~/.zed/config.yaml`` (and other state files) to a git-tracked
...
# â”€â”€â”€ Direct helper â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def test_atomic_replace_preserves_symlink(tmp_path: Path) -> None:
    ...
    # Follow the symlink â€” same content.
...
# â”€â”€â”€ atomic_json_write / atomic_yaml_write wiring â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€â”€ Broken-symlink edge case â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€â”€ EXDEV / EBUSY copy fallback â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def test_atomic_replace_real_cross_device(tmp_path: Path) -> None:
    ...
    other_fs_dir = shm / f"zed-exdev-test-{_uuid.uuid4().hex[:8]}"
    other_fs_dir.mkdir()
    try:
