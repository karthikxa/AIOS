...
class TestLoadMCPConfig:
    def test_no_config_returns_empty(self):
        ...
        with patch("zed_cli.config.load_config", return_value={"model": "test"}):
    ...
    def test_valid_config_parsed(self):
        ...
        with patch("zed_cli.config.load_config", return_value={"mcp_servers": servers}):
            from tools.mcp_tool import _load_mcp_config
            result = _load_mcp_config()
    ...
    def test_mcp_servers_not_dict_returns_empty(self):
        ...
        with patch("zed_cli.config.load_config", return_value={"mcp_servers": "invalid"}):
            from tools.mcp_tool import _load_mcp_config
            result = _load_mcp_config()
            assert result == {}
...
class TestSchemaConversion:
    def test_converts_mcp_tool_to_zed_schema(self):
    ...
    def test_convert_mcp_schema_with_none_inputschema(self):
        ...
        # Note: _make_mcp_tool(input_schema=None) falls back to a default â€”
...
class TestToolsetInjection:
    ...
    def test_server_toolset_skips_builtin_collision(self):
        ...
        fake_toolsets = {
            "zed-cli": {"tools": ["terminal"], "description": "CLI", "includes": []},
            # Built-in toolset named "terminal" â€” must not be overwritten
    ...
    def test_server_connection_failure_skipped(self):
        ...
        fake_toolsets = {
            "zed-cli": {"tools": [], "description": "CLI", "includes": []},
        }
...
class TestMCPBuiltinCollisionGuard:
    ...
    def test_mcp_tool_skipped_when_builtin_exists(self):
        ...
        # Server "abc", tool "search" â†’ mcp_abc_search
        builtin_schema = {
            "name": "mcp_abc_search",
        ...
        # The MCP tool should have been skipped â€” built-in preserved.
    ...
    def test_mcp_tool_allowed_when_collision_is_another_mcp(self):
        ...
        # MCP-to-MCP collision is allowed â€” the new server wins.
