...
tests -- see `zed-agent-dev` skill, "Why do subagents get their own
...
def test_cwd_only_override_collapses_to_default():
    ...
    container isolation â€” they should collapse to the shared 'default'
...
def test_env_type_override_keeps_own_id():
    """env_type is an isolation key â€” must trigger per-task container."""
    terminal_tool.register_task_env_overrides(
