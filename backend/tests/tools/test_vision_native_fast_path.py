...
# â”€â”€â”€ _supports_media_in_tool_results â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€â”€ _build_native_vision_tool_result â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€â”€ _vision_analyze_native â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestVisionAnalyzeNative:
    ...
    def test_oversized_image_resized_under_embed_cap(self, tmp_path):
        ...
        bad bytes can't be cleared by retrying â€” the session is permanently
        ...
        try:
            ...
            pytest.skip("Pillow not installed â€” proactive resize is a no-op")
        ...
        assert len(url) <= _EMBED_TARGET_BYTES, (
            ...
            f"{_EMBED_TARGET_BYTES / 1024 / 1024:.0f} MB â€” would wedge sessions on Anthropic"
        )


# â”€â”€â”€ _handle_vision_analyze fast-path gating â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestHandleVisionAnalyzeFastPath:
    ...
    def test_vision_capable_main_model_uses_fast_path(self, tmp_path, monkeypatch):
        """Main model supports native vision â†’ fast path returns multimodal."""
        img = tmp_path / "x.png"
        img.write_bytes(_TINY_PNG)
    ...
    def test_non_vision_main_model_falls_through_to_aux(self, tmp_path, monkeypatch):
        """Non-vision main model â†’ fast path skipped, aux LLM path attempted."""
        img = tmp_path / "x.png"
        img.write_bytes(_TINY_PNG)
    ...
    def test_fast_path_disabled_for_unsupported_provider(self, tmp_path, monkeypatch):
        """Even with vision-capable model, unknown provider â†’ fall through."""
        img = tmp_path / "x.png"
        img.write_bytes(_TINY_PNG)
