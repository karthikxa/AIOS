...
Coverage:
  _get_firecrawl_client() â€” configuration matrix, singleton caching,
  constructor failure recovery, return value verification, edge cases.
  _get_backend() â€” backend selection logic with env var combinations.
  _get_parallel_client() â€” Parallel client configuration, singleton caching.
  check_web_api_key() â€” unified availability check across all web backends.
"""
...
class TestFirecrawlClientConfig:
    ...
    def setup_method(self):
        ...
        # Enable managed tools by default for these tests â€” patch both the
    ...
    # â”€â”€ Configuration matrix â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

    def test_no_config_raises_with_helpful_message(self):
        """Neither key nor URL â†’ ValueError with guidance."""
    ...
    def test_tool_gateway_domain_builds_firecrawl_gateway_origin(self):
        ...
        with patch.dict(os.environ, {"TOOL_GATEWAY_DOMAIN": "zedteam.com"}):
            with patch("tools.web_tools._read_nous_access_token", return_value="nous-token"):
                with patch("tools.web_tools.Firecrawl") as mock_fc:
                    ...
                    mock_fc.assert_called_once_with(
                        api_key="nous-token",
                        api_url="https://firecrawl-gateway.zedteam.com",
                    )
    ...
    def test_tool_gateway_scheme_can_switch_derived_gateway_origin_to_http(self):
        ...
        with patch.dict(os.environ, {
            "TOOL_GATEWAY_DOMAIN": "zedteam.com",
            ...
            with patch("tools.web_tools._read_nous_access_token", return_value="nous-token"):
                with patch("tools.web_tools.Firecrawl") as mock_fc:
                    ...
                    mock_fc.assert_called_once_with(
                        api_key="nous-token",
                        api_url="http://firecrawl-gateway.zedteam.com",
                    )
                    assert result is mock_fc.return_value
    ...
    def test_nous_auth_token_respects_zed_home_override(self, tmp_path):
        """Auth lookup should read from ZED_HOME/auth.json, not ~/.zed/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".zed").mkdir(parents=True)
    ...
    # â”€â”€ Singleton caching â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    def test_empty_string_key_no_url_raises(self):
        """FIRECRAWL_API_KEY='' with no URL â†’ should raise."""
...
class TestBackendSelection:
    ...
    ``zed tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
    ...
    # â”€â”€ Config-based selection (web.backend in config.yaml) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

    def test_config_parallel(self):
        """web.backend=parallel in config â†’ 'parallel' regardless of keys."""
        from tools.web_tools import _get_backend
        with patch("tools.web_tools._load_web_config", return_value={"backend": "parallel"}):
            assert _get_backend() == "parallel"

    def test_config_exa(self):
        """web.backend=exa in config â†’ 'exa' regardless of other keys."""
        from tools.web_tools import _get_backend
    ...
    def test_config_firecrawl(self):
        """web.backend=firecrawl in config â†’ 'firecrawl' even if Parallel key set."""
        from tools.web_tools import _get_backend
    ...
    def test_config_tavily(self):
        """web.backend=tavily in config â†’ 'tavily' regardless of other keys."""
        from tools.web_tools import _get_backend
        with patch("tools.web_tools._load_web_config", return_value={"backend": "tavily"}):
            assert _get_backend() == "tavily"

    def test_config_tavily_overrides_env_keys(self):
        """web.backend=tavily in config â†’ 'tavily' even if Firecrawl key set."""
        from tools.web_tools import _get_backend
        with patch("tools.web_tools._load_web_config", return_value={"backend": "tavily"}), \
    ...
    def test_config_case_insensitive(self):
        """web.backend=Parallel (mixed case) â†’ 'parallel'."""
        from tools.web_tools import _get_backend
        with patch("tools.web_tools._load_web_config", return_value={"backend": "Parallel"}):
            assert _get_backend() == "parallel"

    def test_config_tavily_case_insensitive(self):
        """web.backend=Tavily (mixed case) â†’ 'tavily'."""
        from tools.web_tools import _get_backend
        with patch("tools.web_tools._load_web_config", return_value={"backend": "Tavily"}):
            assert _get_backend() == "tavily"

    # â”€â”€ Fallback (no web.backend in config) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

    def test_fallback_parallel_only_key(self):
        """Only PARALLEL_API_KEY set â†’ 'parallel'."""
        from tools.web_tools import _get_backend
    ...
    def test_fallback_tavily_only_key(self):
        """Only TAVILY_API_KEY set â†’ 'tavily'."""
        from tools.web_tools import _get_backend
        with patch("tools.web_tools._load_web_config", return_value={}), \
    ...
    def test_fallback_parallel_beats_firecrawl_direct(self):
        """Parallel + Firecrawl-direct â†’ parallel (parallel is the higher-priority
    ...
    def test_fallback_firecrawl_only_key(self):
        """Only FIRECRAWL_API_KEY set â†’ 'firecrawl'."""
        from tools.web_tools import _get_backend
        with patch("tools.web_tools._load_web_config", return_value={}), \
             patch.dict(os.environ, {"FIRECRAWL_API_KEY": "fc-test"}):
            assert _get_backend() == "firecrawl"
    ...
    def test_fallback_no_keys_defaults_to_firecrawl(self):
        """No keys, no config â†’ 'firecrawl' (will fail at client init)."""
        from tools.web_tools import _get_backend
        with patch("tools.web_tools._load_web_config", return_value={}), \
    ...
    def test_invalid_config_falls_through_to_fallback(self):
        """web.backend=invalid â†’ ignored, uses key-based fallback."""
        from tools.web_tools import _get_backend
    ...
    def test_managed_gateway_only_falls_through_to_firecrawl(self):
        ...
        gateway token still selects firecrawl â€” the convenience path is
...
class TestParallelClientConfig:
    ...
    def test_creates_client_with_key(self):
        """PARALLEL_API_KEY set â†’ creates Parallel client."""
    ...
    def test_no_key_raises_with_helpful_message(self):
        """No PARALLEL_API_KEY â†’ ValueError with guidance."""
        from tools.web_tools import _get_parallel_client
