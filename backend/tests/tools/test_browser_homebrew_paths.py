...
class TestDiscoverHomebrewNodeDirs:
    ...
    def test_excludes_plain_node(self):
        """'node' (unversioned) should be excluded â€” covered by /opt/homebrew/bin."""
...
class TestRunBrowserCommandPathConstruction:
    ...
    def test_subprocess_preserves_executable_path_with_spaces(self, tmp_path):
        ...
        browser_path = "/Users/test/Library/Application Support/zed/node_modules/.bin/agent-browser"
        zed_home = str(tmp_path / "zed-home")
 ...
 patch("tools.browser_tool._chromium_installed", return_value=True), \
        ...
        # "npx agent-browser" string â€” that's what Popen needs.
