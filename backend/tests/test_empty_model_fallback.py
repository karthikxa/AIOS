"""Tests for empty model fallback â€” when provider is configured but model is missing."""

from unittest.mock import patch


class TestGetDefaultModelForProvider:
    """Unit tests for zed_cli.models.get_default_model_for_provider."""
    ...
    def test_openrouter_returns_empty(self):
        ...
        from zed_cli.models import get_default_model_for_provider
        # OpenRouter is not in _PROVIDER_MODELS â€” it uses live fetching
    ...
    def test_custom_provider_returns_empty(self):
        """Custom provider has no model catalog â€” should return empty."""
        from zed_cli.models import get_default_model_for_provider
    ...
    def test_nous_silent_default_is_not_the_expensive_flagship(self):
        ...
        must NOT escalate to it â€” otherwise an unconfigured profile silently
