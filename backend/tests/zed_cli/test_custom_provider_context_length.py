...
Covers the fix for #15779 â€” mid-session /model switch to a named custom
...
class TestGetCustomProviderContextLength:
    ...
    def test_trailing_slash_insensitive(self):
        ...
        # config has trailing slash, runtime doesn't â€” must match
        assert (
            get_custom_provider_context_length(
    ...
    def test_returns_none_for_string_value(self):
        """'256K' string is not a valid int â€” skip silently.
...
class TestGetModelContextLengthHonorsOverride:
    ...
    custom_providers override at step 0b â€” before any probe, cache hit,
    ...
    def test_explicit_config_context_length_still_wins(self):
        ...
        Users who set both should see the top-level value â€” that's the
