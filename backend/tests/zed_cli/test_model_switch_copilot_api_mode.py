...
When switching models within the Copilot provider (e.g. GPT-5 â†’ Claude),
...
def test_same_provider_copilot_switch_recomputes_api_mode():
    """GPT-5 â†’ Claude on copilot: api_mode must flip to chat_completions."""
...
def test_copilot_gpt5_keeps_codex_responses():
    """GPT-5 â†’ GPT-5 on copilot: api_mode must stay codex_responses."""
    result = _run_copilot_switch(
    ...
    assert result.target_provider == "copilot"
    # gpt-5.4-mini is a GPT-5 variant â€” should use codex_responses
