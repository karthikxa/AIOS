...
confirmation prompt â€” "Always Approve" flips the key to False so future
...
class TestDestructiveSlashConfirmDefault:
    ...
    def test_default_is_true(self):
        # New installs confirm by default â€” destructive commands must not
    ...
    def test_shape_matches_other_approval_keys(self):
        ...
        # Sibling key shape sanity â€” same flat dict level as mcp_reload_confirm.
...
class TestUserConfigMerge:
    ...
    def test_existing_user_config_with_false_key_survives_merge(
        ...
        setting â€” the default-true value must not win on later loads.
        """
        import yaml
