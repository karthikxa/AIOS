"""Behavior tests for zed_cli.inventory.
...
- canonical_order keys on slug membership, not is_user_defined â€” section
...
# â”€â”€â”€ load_picker_context â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def test_load_picker_context_full_dict():
    ...
    # merges legacy list + v12+ keyed providers â€” both present here means
    # at least one row.
...
# â”€â”€â”€ with_overrides â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def test_with_overrides_truthy_only_strings():
    """Empty strings must NOT clobber disk config â€” TUI calls this with
...
# â”€â”€â”€ build_models_payload â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def test_build_models_payload_does_not_call_provider_model_ids():
    """``build_models_payload`` is a thin shape adapter â€” it delegates the
    ...
    """
    rows = [{"slug": "nous", "name": "Nous", "models": ["zed-4-405b"],
             "total_models": 1, "is_current": False, "is_user_defined": False,
             "source": "built-in"}]
    ctx = _empty_ctx()
    with _list_auth_returning(rows), \
         patch("zed_cli.models.provider_model_ids") as mock_pm:
...
def test_pricing_uses_cached_nous_tier_by_default():
    ...
    with (
        ...
        patch(
            "zed_cli.models.get_pricing_for_provider",
            return_value={
                "openai/gpt-5.5": {
                    "prompt": "0.000001",
                    "completion": "0.000002",
        ...
        patch("zed_cli.models.check_nous_free_tier", return_value=False) as mock_free,
    ):
...
# â”€â”€â”€ picker_hints â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def test_picker_hints_adds_warning_to_skeleton_rows():
    ...
    for row in skeleton_rows:
        ...
        assert (
            ...
            or row["warning"].startswith("run `zed model`")
        )
...
# â”€â”€â”€ canonical_order â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def test_canonical_order_uses_slug_not_is_user_defined_flag():
    ...
    canonical_order MUST key on slug membership, not the flag â€” otherwise
...
# â”€â”€â”€ Integration: end-to-end through real load_picker_context â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€â”€ Aggregator dedup (issue #45954) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def test_build_models_payload_no_max_models_returns_full_list():
    ...
    return the full model list â€” not truncate to the old default of 50.
    ...
    ctx = _empty_ctx()
    with _list_auth_returning(rows):
        # No max_models argument â€” should return all 100 models
        payload = build_models_payload(ctx)
...
# â”€â”€â”€ refresh flag (cache-bust) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def test_build_models_payload_forwards_refresh_flag():
    ...
    with patch("zed_cli.model_switch.list_authenticated_providers", side_effect=_capture):
...
def test_list_authenticated_providers_refresh_busts_cache():
    ...
    from zed_cli import model_switch

    with patch("zed_cli.models.clear_provider_models_cache") as clear:
