...
# The curated list in zed_cli/models.py defines the floor; models.dev only
...
def test_opencode_go_appears_when_api_key_set():
    ...
    # is reachable â€” that's the whole point of the models.dev-preferred merge
    ...
    # models.dev is reachable) or "zed" (from ZED_OVERLAYS fallback when
    # the API is unavailable, e.g. in CI).
    assert opencode_go["source"] in {"built-in", "zed"}
