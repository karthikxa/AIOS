...
_compute = ZedCLI._compute_model_picker_viewport
...
class TestPickerViewport:
    ...
    def test_long_list_caps_visible_to_chrome_budget(self):
        # 30 rows minus reserved_below=6 minus panel_chrome=6 â†’ max_visible=18.
    ...
    def test_offset_clamped_to_bottom(self):
        # Selected on the last item â€” offset must keep the visible window
