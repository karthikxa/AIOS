"""Tests for the interactive session browser (`zed sessions browse`).
...
# â”€â”€â”€ _session_browse_picker â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€â”€ Curses-based picker (mocked curses) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestCursesBrowse:
    ...
    def test_type_to_filter_then_enter(self):
        ...
        # Type "Beta" then Enter â€” should select s2
    ...
    def test_q_types_into_filter_when_filter_active(self):
        ...
        # Then type "q" â€” should add 'q' to filter (filter="seq"), NOT quit
        # "seq" still matches "the sequel" â†’ Enter selects it
        keys = [ord('s'), ord('e'), ord('q'), 10]
        result = self._run_with_keys(sessions, keys)
        assert result == "s1"  # "the sequel" matches "seq"


# â”€â”€â”€ Argument parser registration â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

class TestSessionBrowseArgparse:
    """Verify the 'browse' subcommand is properly registered."""

    def test_browse_subcommand_exists(self):
        """zed sessions browse should be parseable."""
...
# â”€â”€â”€ Integration: cmd_sessions browse action â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
