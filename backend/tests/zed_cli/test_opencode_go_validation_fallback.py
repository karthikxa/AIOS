...
def _patched(func):
    ...
    def wrapper(*args, **kwargs):
        with patch("zed_cli.models.fetch_api_models", return_value=None), \
             patch("zed_cli.models.probe_api_models", return_value=_UNREACHABLE_PROBE):
...
def test_opencode_go_typo_auto_corrected():
    ...
    entry."""
    # 'kimi-k2.55' vs 'kimi-k2.5' ratio â‰ˆ 0.95 â€” within the 0.9 cutoff.
...
def test_opencode_go_unknown_model_accepted_with_suggestion():
    ...
    # 'kimi-k3-preview' vs 'kimi-k2.6' â€” similar enough to suggest, not to auto-correct.
