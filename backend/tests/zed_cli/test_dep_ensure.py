...
def test_has_zed_agent_browser_windows_path(tmp_path):
    ...
    from hermes_cli.dep_ensure import _has_zed_agent_browser
    with patch("hermes_cli.dep_ensure._IS_WINDOWS", True), \
         patch("hermes_constants.get_zed_home", return_value=tmp_path):
...
def test_ensure_dependency_uses_powershell_on_windows(tmp_path):
    ...
    with patch("hermes_cli.dep_ensure._IS_WINDOWS", True), \
         ...
         patch("hermes_cli.dep_ensure.shutil") as mock_shutil, \
         patch("hermes_constants.get_zed_home", return_value=tmp_path / "fakehome"), \
