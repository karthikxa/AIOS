"""Tests for utils.atomic_json_write â€” crash-safe JSON file writes."""
...
class TestAtomicJsonWrite:
    ...
    def test_preserves_original_on_serialization_error(self, tmp_path):
        ...
        # Try to write non-serializable data â€” should fail
    ...
    def test_unicode_content(self, tmp_path):
        ...
        data = {"emoji": "ðŸŽ‰", "japanese": "æ—¥æœ¬èªž"}
        atomic_json_write(target, data)
    ...
    def test_mode_does_not_crash_without_fchmod(self, tmp_path):
        ...
        Previously this crashed in `zed memory setup` while saving the
