...
The main() function in zed_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `zed -c model`
...
def _build_parser():
    """Build a minimal replica of the zed top-level parser."""
