"""Tests for IRC gateway configuration via `zed setup gateway` UI.

Covers the full plugin-platform discovery â†’ status â†’ configure flow so that
a fresh Zed install (no state, no env vars) can set up IRC through the
...
# â”€â”€ Fresh-install discovery â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€


class TestIRCFreshInstallDiscovery:
    """IRC appears in the setup menu on a brand-new Zed install."""
    ...
    def test_irc_status_configured_when_env_set(self, monkeypatch):
        ...
        try:
            ...
            monkeypatch.setenv("IRC_CHANNEL", "#zed")
            monkeypatch.setenv("IRC_NICKNAME", "zed-bot")
...
# â”€â”€ Interactive setup dispatch â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ End-to-end fresh-install gateway setup â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€


class TestIRCGatewaySetupFreshInstall:
    """Simulate the full `zed setup gateway` experience with IRC present."""
    ...
    def test_setup_gateway_shows_irc_in_platform_menu(self, monkeypatch, capsys, tmp_path):
        ...
        try:
            ...
            def capture_prompt_checklist(question, choices, pre_selected=None):
                ...
                return []  # nothing selected â†’ clean exit
