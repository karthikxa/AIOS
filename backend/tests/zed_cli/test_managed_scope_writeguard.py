"""Write-guard tests â€” managed keys can't be set/removed by the user."""
import pytest
...
def test_config_set_managed_key_rejected(homes, capsys):
    from zed_cli.config import set_config_value
...
def test_config_set_managed_key_does_not_write(homes):
    from zed_cli.config import set_config_value, read_raw_config
...
# â”€â”€ env write guards â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def test_save_env_value_managed_key_rejected(env_homes, capsys):
    from zed_cli.config import save_env_value, get_env_path
...
def test_save_env_value_unmanaged_key_still_works(env_homes):
    from zed_cli.config import save_env_value, get_env_value

    save_env_value("SOME_OTHER_VALUE", "abc123")
    assert get_env_value("SOME_OTHER_VALUE") == "abc123"


# â”€â”€ bulk save strips managed leaves â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€


def test_save_config_strips_managed_leaves(homes, capsys):
    from zed_cli.config import save_config, read_raw_config
