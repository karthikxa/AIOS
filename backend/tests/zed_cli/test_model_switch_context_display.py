...
of the provider-aware resolver. The agent was actually running at 272K â€” Codex
OAuth's enforced cap â€” so the display was lying to the user.
...
class TestResolveDisplayContextLength:
    ...
    def test_custom_providers_override_honored(self):
        ...
        # Real resolver call â€” no mock â€” so the override path is exercised
