"""Tests for kb.decompose_triage_task â€” the DB-layer atomic fan-out
...
def test_decompose_creates_children_and_promotes_root(kanban_home):
    ...
    # First child has no internal parents â†’ ready on recompute_ready.
    assert c0.status == "ready"
    assert c0.assignee == "researcher"
    # Second child has parents=[0] â†’ stays in todo until c0 completes.
