...
Regression test for #13688: ``zed plugins`` crashes with
...
_SRC_ROOT = Path(__file__).parent.parent.parent / "zed_cli"
...
class TestSourceCodeGuardrails:
    ...
    These complement the behavioral tests above â€” they catch regressions
