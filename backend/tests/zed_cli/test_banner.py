...
def test_build_welcome_banner_title_is_hyperlinked_to_release():
    ...
    tag_url = ("v2026.4.23", "https://github.com/NousResearch/zed-agent/releases/tag/v2026.4.23")
    ...
    assert "Zed Agent v" in raw, "Version label missing from title"
...
def test_build_welcome_banner_disabled_mcp_shows_disabled_not_failed():
    """A disabled MCP server renders 'â€” disabled' (dim), not 'â€” failed' (red)."""
    with (
