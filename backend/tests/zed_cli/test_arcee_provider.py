"""Tests for Arcee AI provider support â€” standard direct API provider."""
...
class TestArceeProvidersModule:
    def test_overlay_exists(self):
        ...
        assert "arcee" in ZED_OVERLAYS
        overlay = ZED_OVERLAYS["arcee"]
...
# =============================================================================
# Auxiliary client â€” main-model-first design
# =============================================================================


class TestArceeAuxiliary:
    def test_main_model_first_design(self):
        """Arcee uses main-model-first â€” no entry in _API_KEY_PROVIDER_AUX_MODELS."""
