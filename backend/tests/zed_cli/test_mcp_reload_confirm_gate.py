...
class TestMcpReloadConfirmDefault:
    ...
    def test_default_is_true(self):
        # New installs confirm by default â€” this is the safe behavior.
...
class TestUserConfigMerge:
    ...
    def test_existing_user_config_without_key_gets_default(self, tmp_path, monkeypatch):
        ...
        # Force a fresh reimport of config.py so the ZED_HOME is honored.
        import importlib
    ...
    def test_existing_user_config_with_false_key_survives_merge(
        ...
        that setting across reloads â€” the default_true value must not win.
        """
        import yaml
