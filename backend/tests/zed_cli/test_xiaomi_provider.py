...
# =============================================================================
# Model catalog (dynamic â€” no static list)
# =============================================================================
...
class TestXiaomiModelCatalog:
    ...
    def test_static_model_list_fallback(self):
        ...
        We only assert the provider key is present â€” the specific model
...
class TestXiaomiNormalization:
    """Model name normalization â€” Xiaomi is a direct provider."""

    def test_vendor_prefix_mapping(self):
        from zed_cli.model_normalize import _VENDOR_PREFIXES
    ...
    def test_lowercase_subset_of_matching_prefix(self):
        ...
        Otherwise the .lower() code path is unreachable dead code â€” the
    ...
    def test_normalize_lowercases_mixed_case(self, input_name, expected):
        """Xiaomi's API requires lowercase model IDs â€” mixed case from docs must be lowered."""
        from zed_cli.model_normalize import normalize_model_for_provider
...
class TestXiaomiURLMapping:
    """Test URL â†’ provider inference for Xiaomi endpoints."""
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ZED_OVERLAYS
        overlay = ZED_OVERLAYS["xiaomi"]
...
class TestXiaomiAuxiliary:
    """Xiaomi auxiliary routing: vision â†’ omni, non-vision â†’ user's main model, never flash."""
...
class TestXiaomiDoctor:
    """Verify zed doctor recognizes Xiaomi env vars."""
