"""Tests for empty-session hygiene â€” gemini-cli#27770 port.
...
and `zed sessions list`. ``SessionDB.delete_session_if_empty`` removes
...
class TestCLIDiscardSessionIfEmpty:
    """Wiring tests for ZedCLI._discard_session_if_empty."""
