...
Zed state stays profile-scoped through ZED_HOME. Host subprocesses should
...
See: https://github.com/NousResearch/zed-agent/issues/25114
See: https://github.com/NousResearch/zed-agent/issues/36144
See: https://github.com/NousResearch/zed-agent/issues/29015
"""
...
class TestGetSubprocessHome:
    ...
    def _host_mode(self, monkeypatch):
        ...
        monkeypatch.delenv("ZED_REAL_HOME", raising=False)
    ...
    def test_host_auto_keeps_real_home_when_profile_home_exists(self, tmp_path, monkeypatch):
        ...
        zed_home = real_home / ".zed" / "profiles" / "coder"
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("ZED_HOME", str(base / "beta"))
...
class TestMakeRunEnvHomeInjection:
    ...
    def test_host_auto_preserves_real_home_when_profile_home_exists(self, tmp_path, monkeypatch):
        ...
        assert result["ZED_REAL_HOME"] == str(real_home)
    ...
    def test_profile_mode_injects_profile_home_when_profile_home_exists(self, tmp_path, monkeypatch):
        ...
        assert result["HOME"] == str(zed_home / "home")
        assert result["ZED_REAL_HOME"] == str(real_home)
    ...
    def test_no_injection_when_zed_home_unset(self, monkeypatch):
        monkeypatch.delenv("ZED_HOME", raising=False)
    ...
    def test_context_override_bridges_to_subprocess_env(self, tmp_path, monkeypatch):
        ...
        assert result["ZED_HOME"] == str(profile)
