...
code paths â€” not a copy of the try/except pattern.
"""
...
def _mock_runtime_provider(monkeypatch):
    ...
    since these tests don't care about provider resolution â€” the agent
    is mocked too."""
...
class TestCronJobCleanup:
    """cron/scheduler.py â€” end_session + close in the finally block."""
    ...
    def test_keyboard_interrupt_in_end_session_does_not_skip_close(self):
        ...
        with patch("zed_state.SessionDB", return_value=mock_db), \
