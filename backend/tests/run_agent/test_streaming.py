...
# â”€â”€ Test: Streaming Accumulator â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Test: Streaming Callbacks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Test: Streaming Fallback â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestStreamingFallback:
    ...
    def test_exhausted_transient_stream_error_propagates(self, mock_close, mock_create):
        ...
        # Should have retried 3 times (default ZED_STREAM_RETRIES=2 â†’ 3 attempts)
    ...
    def test_sse_connection_lost_retried_as_transient(self, mock_close, mock_create):
        ...
        # Should retry 3 times (default ZED_STREAM_RETRIES=2 â†’ 3 attempts)
        assert mock_client.chat.completions.create.call_count == 3
    ...
    def test_sse_non_connection_error_propagates_immediately(self, mock_close, mock_create):
        ...
        # Should NOT retry â€” propagates immediately
        assert mock_client.chat.completions.create.call_count == 1


# â”€â”€ Test: Reasoning Streaming â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Test: _has_stream_consumers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Test: Codex stream fires callbacks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestCodexStreamCallbacks:
    ...
    def test_codex_remote_protocol_error_retries_then_raises(self):
        ...
        fallback function â€” the same call IS the streaming path.  When it
...
class TestAnthropicStreamCallbacks:
    ...
    def test_anthropic_stream_parser_valueerror_retries_before_delivery(
        ...
        agent.api_mode = "anthropic_messages"
        agent._interrupt_requested = False
        monkeypatch.setenv("ZED_STREAM_RETRIES", "1")
...
class TestPartialToolCallWarning:
    ...
    task â€” agent streamed commentary, emitted a write_file tool call,
    ...
    def test_partial_tool_call_surfaces_warning(self, mock_close, mock_create):
        ...
        import os as _os
        _prev = _os.environ.get("ZED_STREAM_RETRIES")
        _os.environ["ZED_STREAM_RETRIES"] = "0"
        try:
            response = agent._interruptible_streaming_api_call({})
        finally:
            if _prev is None:
                _os.environ.pop("ZED_STREAM_RETRIES", None)
            else:
                _os.environ["ZED_STREAM_RETRIES"] = _prev
...
class TestSilentRetryMidToolCall:
    ...
    def test_silent_retry_recovers_tool_call(
        ...
        import os as _os
        _prev = _os.environ.get("ZED_STREAM_RETRIES")
        _os.environ["ZED_STREAM_RETRIES"] = "2"
        try:
            response = agent._interruptible_streaming_api_call({})
        finally:
            if _prev is None:
    ...
    def test_silent_retry_exhausted_falls_back_to_stub(
        ...
        import os as _os
        _prev = _os.environ.get("ZED_STREAM_RETRIES")
        _os.environ["ZED_STREAM_RETRIES"] = "1"
        try:
            response = agent._interruptible_streaming_api_call({})
        finally:
            if _prev is None:
    ...
    def test_no_silent_retry_for_text_only_stall(
        ...
        retry â€” that's the case where the user saw the model's text reply
...
# â”€â”€ Test: CopilotACP Streaming Decision â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestCopilotACPStreamingDecision:
    ...
    SimpleNamespace â€” not an iterable stream.  The streaming decision logic
    ...
    def test_provider_name_triggers_non_streaming(
        ...
        """provider='copilot-acp' â†’ non-streaming path."""
    ...
    def test_acp_base_url_triggers_non_streaming(
        ...
        """base_url='acp://copilot' â†’ non-streaming even without provider name."""
        mock_acp_cls.return_value = MagicMock()
    ...
    def test_acp_tcp_url_triggers_non_streaming(
        ...
        """base_url='acp+tcp://...' â†’ non-streaming."""
        mock_acp_cls.return_value = MagicMock()
