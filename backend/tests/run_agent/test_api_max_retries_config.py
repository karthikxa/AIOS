...
Closes #11616 â€” make the hardcoded ``max_retries = 3`` in the agent's API
...
def test_default_api_max_retries_is_three():
    """No config override â†’ legacy default of 3 retries preserved."""
    agent = _make_agent()
...
def test_api_max_retries_falls_back_on_invalid_value():
    """Garbage values in config don't crash agent init â€” fall back to 3."""
