...
# â”€â”€ _build_api_kwargs tests â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestBuildApiKwargsOpenRouter:
    ...
    def test_strips_codex_only_tool_call_fields_from_chat_messages(self, monkeypatch):
        ...
        # targets â€” strict providers like Fireworks 400 on it. The agent here
        ...
        # is sanitized) â€” Codex/Responses replay relies on these fields.
    ...
    def test_keeps_extra_content_for_gemini_target(self, monkeypatch):
        """Gemini-family targets must keep extra_content (thought_signature) â€”
    ...
    def test_sanitize_tool_calls_strips_extra_content_when_model_none(self, monkeypatch):
        """Default (no model) strips extra_content â€” safe for strict providers."""
        agent = _make_agent(monkeypatch, "openrouter")
        api_msg = self._api_msg_with_extra_content()
...
# â”€â”€ Message conversion tests â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestChatMessagesToResponsesInput:
    ...
    def test_assistant_multimodal_content_uses_output_text(self, monkeypatch):
        ...
        This is the fix for #15687 â€” the Responses API rejects input_text
...
# â”€â”€ Response normalization tests â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestChatMessagesToResponsesInputMessageItems:
    ...
    def test_skips_invalid_message_items(self, monkeypatch):
        ...
        items = _chat_messages_to_responses_input(messages)
        # All invalid â€” falls back to plain text reconstruction
        assert items == [{"role": "assistant", "content": "fallback text"}]


# â”€â”€ Chat completions response handling (OpenRouter/Nous) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Auxiliary client provider resolution â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestAuxiliaryClientProviderPriority:
    ...
    def test_custom_endpoint_when_no_nous(self, monkeypatch):
        ...
        longer consulted â€” base_url comes from config.yaml via
...
# â”€â”€ Provider routing tests â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Codex reasoning items preflight tests â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestCodexReasoningPreflight:
    ...
    def test_reasoning_item_passes_through(self, monkeypatch):
        ...
        # Note: "id" is intentionally excluded from normalized output â€”
...
# â”€â”€ Reasoning effort consistency tests â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
