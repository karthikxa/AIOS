...
1. GH #33163: fallback retains primary's base_url â†’ requests go to wrong endpoint
...
# â”€â”€ Test: _try_activate_fallback clears mismatched pool â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestFallbackCredentialIsolation:
    ...
    def test_fallback_clears_primary_pool(self):
        ...
        sys.path.insert(0, "/mnt/g/knowledge/project/zed-agent")
...
# â”€â”€ Test: _recover_with_credential_pool rejects mismatched pool â”€â”€â”€â”€â”€â”€
...
class TestRecoveryProviderGuard:
    ...
    def test_recovery_skips_mismatched_pool(self):
        ...
        # Pool still belongs to primary (openai-codex) â€” mismatch
        agent._credential_pool = _make_pool("openai-codex")
        ...
        assert should_skip is True, (
            f"Provider mismatch: agent={current_provider}, pool={pool_provider} â€” should skip"
        )
    ...
    def test_recovery_allows_matching_pool(self):
        ...
        assert should_skip is False, (
            "Same provider â€” should allow recovery"
        )
...
# â”€â”€ Test: base_url not overwritten after fallback â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestBaseUrlLeak:
    ...
    def test_swap_credential_does_not_restore_primary_url(self):
        ...
        assert pool is None, "Pool should be None â€” _swap_credential won't be reached"
