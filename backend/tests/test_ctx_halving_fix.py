...
The fix introduces:
  ...
  * get_context_length_from_provider_error() â€” accepts only concrete
...
class TestParseAvailableOutputTokens:
    ...
    # â”€â”€ Should detect and extract â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ Should NOT detect (returns None) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

    def test_prompt_too_long_is_not_output_cap_error(self):
        """'prompt is too long' errors must NOT be caught â€” they need context-overflow recovery."""
...
# ---------------------------------------------------------------------------
# Context-overflow recovery â€” only trust provider-reported limits
# ---------------------------------------------------------------------------
...
class TestContextOverflowLimitSelection:
    ...
    Zed what the actual maximum is.  In that case we may compress the
