...
def _make_cli():
    """Bare ZedCLI suitable for process_command() tests.
...
class TestExitDeleteFlag:
    ...
    def test_quit_alias_q_is_not_quit(self):
        ...
        that /q --delete does NOT arm session deletion â€” it would dispatch
        to /queue instead."""
        cli = _make_cli()
    ...
    def test_unknown_exit_argument_does_not_exit(self):
        """Unrecognised args should NOT exit the CLI â€” they surface an
