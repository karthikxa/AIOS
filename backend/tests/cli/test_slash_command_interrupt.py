...
class TestSlashCommandKeyboardInterrupt:
    ...
    def test_slash_command_returning_false_sets_exit(self):
        """The legitimate exit signal â€” process_command() returning False â€”
    ...
    def test_other_exceptions_propagate(self):
        ...
        with them â€” silently swallowing all exceptions would mask bugs."""
        cli = _make_cli()
        ...
        try:
            ...
            return  # expected â€” non-KBI exceptions propagate
