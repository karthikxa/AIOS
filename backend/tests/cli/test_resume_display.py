"""Tests for session resume history display â€” _display_resumed_history() and
...
def _make_cli(config_overrides=None, env_overrides=None, **kwargs):
    ...
    with (
        ...
        return ZedCLI(**kwargs)


# â”€â”€ Sample conversation histories for tests â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€


def _simple_history():
    """Two-turn conversation: user â†’ assistant â†’ user â†’ assistant."""
    return [
...
# â”€â”€ Tests for _display_resumed_history â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestDisplayResumedHistory:
    ...
    def test_long_user_message_truncated(self):
        ...
        assert 200 <= a_count <= 310  # roughly 300 chars (Â±panel padding)
...
# â”€â”€ Tests for _preload_resumed_session â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Tests for _handle_resume_command recap display â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestHandleResumeCommandRecap:
    ...
    def test_resume_command_displays_recap_when_messages_restored(self):
        ...
        with (
            patch("zed_cli.main._resolve_session_by_name_or_id", return_value="target_session"),
...
# â”€â”€ Integration: _init_agent skips when preloaded â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Config default tests â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestResumeDisplayConfig:
    ...
    def test_default_config_has_resume_display(self):
        """DEFAULT_CONFIG in zed_cli/config.py includes resume_display."""
