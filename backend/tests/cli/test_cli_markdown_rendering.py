...
def test_final_assistant_content_preserves_windows_hidden_dir_paths():
    renderable = _render_final_assistant_content(
        r"D:\Projects\SourceCode\zed-agent\.ai\skills" + "\\"
    )

    output = _render_to_text(renderable)
    assert r"D:\Projects\SourceCode\zed-agent\.ai\skills" + "\\" in output
...
def test_strip_mode_preserves_table_structure_while_cleaning_cell_markdown():
    ...
    # Every rendered table row shares the same pipe column offsets â€” the
