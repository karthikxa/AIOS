...
# â”€â”€ CLI tests â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

class TestCLIQuickCommands:
    """Test quick command dispatch in ZedCLI.process_command."""
...
# â”€â”€ Gateway tests â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestGatewayQuickCommands:
    ...
    async def test_exec_command_does_not_leak_credentials(self):
        """Quick command exec must sanitize env â€” API keys must not appear in output."""
        from gateway.run import GatewayRunner
        ...
        assert "sk-or-secret-12345" not in result, \
            "Quick command leaked OPENROUTER_API_KEY â€” exec runs without env sanitization"
    ...
    async def test_exec_command_output_is_redacted(self, monkeypatch):
        ...
        # Ensure redaction is active regardless of host ZED_REDACT_SECRETS state
        ...
        assert "supersecretkey1234567890" not in result, \
            "Quick command output not redacted â€” raw API key returned to user"
