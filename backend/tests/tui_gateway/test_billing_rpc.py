...
- billing.state serializes BillingState (Decimals â†’ strings) + fails open.
...
def test_billing_state_serializes_decimals_as_strings(monkeypatch):
    ...
    assert res["card"]["masked"] == "visa Â·Â·Â·Â·4242"
...
# ---------------------------------------------------------------------------
# billing.charge â€” typed error envelopes
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# billing.charge_status â€” the poll
# ---------------------------------------------------------------------------
