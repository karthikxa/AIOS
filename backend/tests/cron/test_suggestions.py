...
ZED_HOME so the real suggestions.json is never touched.
"""
...
def store(tmp_path, monkeypatch):
    """A cron.suggestions module bound to an isolated ZED_HOME."""
    home = tmp_path / ".zed"
    home.mkdir()
...
class TestCatalog:
    ...
    def test_monitor_entry_references_classifier_script(self):
        ...
        # at run time on any backend), never by a baked-in absolute path â€”
