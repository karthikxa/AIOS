# Port Notes â€” baoyu-infographic
...
| File operations | Bash commands | Zed file tools (write_file, read_file) |
...
Reference files can be overwritten directly (they're unchanged from upstream). SKILL.md must be manually merged since it contains Zed-specific adaptations.
