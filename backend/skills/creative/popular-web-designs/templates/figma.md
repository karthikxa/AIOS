...
- Negative letter-spacing throughout â€” even body text at -0.14px to -0.26px
...
### Gradient System
- **Hero Gradient**: A vibrant multi-stop gradient using electric green, bright yellow, deep purple, and hot pink. This gradient is the visual signature of the hero section â€” it represents the creative possibilities of the tool.
...
| Body Large | figmaSans | 20px (1.25rem) | 330â€“450 | 1.30â€“1.40 | -0.1px to -0.14px | Descriptions, intros |
| Body / Button | figmaSans | 16px (1rem) | 330â€“400 | 1.40â€“1.45 | -0.14px to normal | Standard body, nav, buttons |
...
### Principles
- **Variable font precision**: figmaSans uses weights that most systems never touch â€” 320, 330, 340, 450, 480, 540. This creates hierarchy through subtle weight differences rather than dramatic jumps. The difference between 330 and 340 is nearly imperceptible but structurally significant.
- **Light as the base**: Most body text uses 320â€“340 (lighter than typical 400 "regular"), creating an ethereal, airy reading experience that matches the design-tool aesthetic.
- **Kern everywhere**: Every text element enables OpenType `"kern"` feature â€” kerning is not optional, it's structural.
...
- **Mono for structure**: figmaMono in uppercase with positive letter-spacing (0.54pxâ€“0.6px) creates technical signpost labels.
...
### Do
- Use figmaSans with precise variable weights (320â€“540) â€” the granular weight control IS the design
- Keep the interface strictly black-and-white â€” color comes from product content only
- Use pill (50px) and circular (50%) geometry for all interactive elements
- Apply dashed 2px focus outlines â€” the signature accessibility pattern
...
### Don't
- Don't add interface colors â€” the monochrome palette is absolute
- Don't use standard font weights (400, 500, 600, 700) â€” use the variable font's unique stops (320, 330, 340, 450, 480, 540)
- Don't use sharp corners on buttons â€” pill and circular geometry only
- Don't use solid focus outlines â€” dashed is the signature
- Don't increase body font weight above 450 â€” the light-weight aesthetic is core
- Don't use positive letter-spacing on body text â€” it's always negative
...
| Tablet | 560â€“768px | Minor adjustments |
| Small Desktop | 768â€“960px | 2-column layouts |
| Desktop | 960â€“1280px | Standard layout |
| Large Desktop | 1280â€“1440px | Expanded |
| Ultra-wide | 1440â€“1920px | Maximum width |

### Collapsing Strategy
- Hero text: 86px â†’ 64px â†’ 48px
...
2. Interface is always black + white â€” never add colors to chrome
