...
### Accent Colors
- **Sentry Purple** (`#6a5fc1`): Primary interactive color â€” links, hover states, focus rings
...
### Font Families
- **Display**: `Dammit Sans` â€” brand personality font for hero headings
...
| Body Emphasis | Rubik | 16px (1.00rem) | 500â€“600 | 1.50 | normal | Bold body, nav items |
...
| Button Text | Rubik | 14px (0.88rem) | 500â€“700 | 1.14â€“1.29 (tight) | 0.2px | `text-transform: uppercase` |
| Caption | Rubik | 14px (0.88rem) | 500â€“700 | 1.00â€“1.43 | 0.2px | Often uppercase |
...
| Code | Monaco | 16px (1.00rem) | 400â€“700 | 1.50 | normal | Code blocks, technical text |
...
- **Uppercase as system**: Buttons, captions, labels, and micro-text all use `text-transform: uppercase` with subtle letter-spacing (0.2pxâ€“0.25px), creating a systematic "technical label" pattern throughout.
- **Weight stratification**: Rubik uses 400 (body), 500 (emphasis/nav), 600 (titles/strong), 700 (buttons/CTAs) â€” a clean four-tier weight system.
- **Tight headings, relaxed body**: All headings use 1.10â€“1.25 line-height; body uses 1.50; small captions expand to 2.00 for readability at tiny sizes.
...
- Text: `#ffffff`, uppercase, 14px, weight 500â€“700, letter-spacing 0.2px
...
- Responsive padding: 2rem (mobile) â†’ 4rem (tablet+)
...
| Small Tablet | 576â€“640px | Minor width adjustments |
| Tablet | 640â€“768px | 2-column begins |
| Small Desktop | 768â€“992px | Full nav visible |
| Desktop | 992â€“1152px | Standard layout |
| Large Desktop | 1152â€“1440px | Max-width content |

### Whitespace Philosophy
- **Dark breathing room**: Generous vertical spacing between sections (64pxâ€“80px+) lets the dark background serve as a visual rest.
...
- Comfortable (10pxâ€“12px): Larger containers, glass panels
...
**Shadow Philosophy**: Sentry uses a unique combination of inset shadows (buttons feel pressed INTO the surface) and ambient glows (content radiates from the dark background). The deep purple ambient shadow (`rgba(22, 15, 36, 0.9)`) is the signature â€” it creates a bioluminescent quality where content seems to emit its own purple-tinted light.

## 7. Do's and Don'ts

### Do
- Use deep purple backgrounds (`#1f1633`, `#150f23`) â€” never pure black (`#000000`)
- Apply inset shadows on primary buttons for the tactile pressed effect
- Use Dammit Sans ONLY for hero/display headings â€” Rubik for everything else
...
- Maintain the warm purple shadow tones â€” shadows should feel purple-tinted, not neutral gray
- Use Rubik's 4-tier weight system: 400 (body), 500 (nav/emphasis), 600 (titles), 700 (CTAs)

### Don't
- Don't use pure black (`#000000`) for backgrounds â€” always use the warm purple-blacks
- Don't apply Dammit Sans to body text or UI elements â€” it's display-only
- Don't use standard gray (`#666`, `#999`) for borders â€” use purple-tinted grays (`#362d59`, `#584674`)
- Don't drop the uppercase treatment on buttons â€” it's a system-wide pattern
- Don't use sharp corners (0px radius) â€” minimum 6px for all interactive elements
- Don't mix the lime-green accent with the coral/pink accents in the same component
- Don't use flat (non-inset) shadows on primary buttons â€” the tactile quality is signature
- Don't forget letter-spacing on uppercase text â€” 0.2px minimum
...
| Tablet | 576â€“768px | 2-column feature grids begin |
| Small Desktop | 768â€“992px | Full navigation, side-by-side layouts |
| Desktop | 992â€“1152px | Max-width container, full layout |
| Large | >1152px | Content max-width maintained, generous margins |

### Collapsing Strategy
- Hero text: 88px Dammit Sans â†’ 60px â†’ mobile scales
- Navigation: horizontal â†’ hamburger with slide-out
- Feature sections: side-by-side â†’ stacked cards
- Buttons: inline â†’ full-width stacked on mobile
- Container padding: 4rem â†’ 2rem
...
### Iteration Guide
1. Always start with the dark purple background â€” the color palette is built FOR dark mode
...
4. Lime green (#c2ef4e) is the "pop" color â€” use once per section maximum
5. Frosted glass for overlaid panels, solid purple for primary surfaces
6. Rubik handles 90% of typography â€” Dammit Sans is hero-only
