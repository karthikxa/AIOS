...
Coinbase's website is a clean, trustworthy crypto platform that communicates financial reliability through a blue-and-white binary palette. The design uses Coinbase Blue (`#0052ff`) â€” a deep, saturated blue â€” as the singular brand accent against white and near-black surfaces. The proprietary font family includes CoinbaseDisplay for hero headlines, CoinbaseSans for UI text, CoinbaseText for body reading, and CoinbaseIcons for iconography â€” a comprehensive four-font system.
...
- 1.00 line-height on display headings â€” ultra-tight
- Cool gray secondary surface (`#eef0f3`) with blue tint
- `text-transform: lowercase` on some button labels â€” unusual
...
### Font Families
- **Display**: `CoinbaseDisplay` â€” hero headlines
- **UI / Sans**: `CoinbaseSans` â€” buttons, headings, nav
- **Body**: `CoinbaseText` â€” reading text
- **Icons**: `CoinbaseIcons` â€” icon font
...
| Caption | CoinbaseSans | 14px | 600â€“700 | 1.50 | Metadata |
...
### Border Radius Scale
- Small (4pxâ€“8px): Article links, small cards
- Standard (12pxâ€“16px): Cards, menus
- Large (24pxâ€“32px): Feature containers
...
Minimal shadow system â€” depth from color contrast between dark/light sections.
...
### Don't
- Don't use the blue decoratively â€” it's functional only
- Don't use sharp corners on CTAs â€” 56px minimum
