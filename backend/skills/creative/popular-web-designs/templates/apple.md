...
> ```html
> <!-- No CDN needed â€” uses system fonts -->
> ```
...
Apple's website is a masterclass in controlled drama â€” vast expanses of pure black and near-white serve as cinematic backdrops for products that are photographed as if they were sculptures in a gallery. The design philosophy is reductive to its core: every pixel exists in service of the product, and the interface itself retreats until it becomes invisible. This is not minimalism as aesthetic preference; it is minimalism as reverence for the object.

The typography anchors everything. San Francisco (SF Pro Display for large sizes, SF Pro Text for body) is Apple's proprietary typeface, engineered with optical sizing that automatically adjusts letterforms depending on point size. At display sizes (56px), weight 600 with a tight line-height of 1.07 and subtle negative letter-spacing (-0.28px) creates headlines that feel machined rather than typeset â€” precise, confident, and unapologetically direct. At body sizes (17px), the tracking loosens slightly (-0.374px) and line-height opens to 1.47, creating a reading rhythm that is comfortable without ever feeling slack.

The color story is starkly binary. Product sections alternate between pure black (`#000000`) backgrounds with white text and light gray (`#f5f5f7`) backgrounds with near-black text (`#1d1d1f`). This creates a cinematic pacing â€” dark sections feel immersive and premium, light sections feel open and informational. The only chromatic accent is Apple Blue (`#0071e3`), reserved exclusively for interactive elements: links, buttons, and focus states. This singular accent color in a sea of neutrals gives every clickable element unmistakable visibility.

**Key Characteristics:**
- SF Pro Display/Text with optical sizing â€” letterforms adapt automatically to size context
...
- Product-as-hero photography on solid color fields â€” no gradients, no textures, no distractions
- Extremely tight headline line-heights (1.07-1.14) creating compressed, billboard-like impact
- Full-width section layout with centered content â€” the viewport IS the canvas
...
- **Light Gray** (`#f5f5f7`): Alternate section backgrounds, informational areas. Not white â€” the slight blue-gray tint prevents sterility.
...
- Use: "Learn more" and "Shop" links â€” the signature Apple inline CTA
...
- Hover: no standard hover state â€” cards are static, links within them are interactive
...
### Image Treatment
- Products on solid-color fields (black or white) â€” no backgrounds, no context, just the object
...
- Minimal chrome â€” the products speak for themselves
...
- Single-column for hero moments â€” one product, one message, full attention
- No visible grid lines or gutters â€” spacing creates implied structure

### Whitespace Philosophy
- **Cinematic breathing room**: Each product section occupies a full viewport height (or close to it). The whitespace between products is not empty â€” it is the pause between scenes in a film.
...
| Navigation Glass | `backdrop-filter: saturate(180%) blur(20px)` on `rgba(0,0,0,0.8)` | Sticky navigation bar â€” the glass effect |
...
**Shadow Philosophy**: Apple uses shadow extremely sparingly. The primary shadow (`3px 5px 30px` with 0.22 opacity) is soft, wide, and offset â€” mimicking a diffused studio light casting a natural shadow beneath a physical object. This reinforces the "product as physical sculpture" metaphor. Most elements have NO shadow at all; elevation comes from background color contrast (dark card on darker background, or light card on slightly different gray).
...
### Do
- Use SF Pro Display at 20px+ and SF Pro Text below 20px â€” respect the optical sizing boundary
- Apply negative letter-spacing at all text sizes (not just headlines) â€” Apple tracks tight universally
- Use Apple Blue (`#0071e3`) ONLY for interactive elements â€” it must be the singular accent
- Alternate between black and light gray (`#f5f5f7`) section backgrounds for cinematic rhythm
- Use 980px pill radius for CTA links â€” the signature Apple link shape
...
- Compress headline line-heights to 1.07-1.14 â€” Apple headlines are famously tight

### Don't
- Don't introduce additional accent colors â€” the entire chromatic budget is spent on blue
- Don't use heavy shadows or multiple shadow layers â€” Apple's shadow system is one soft diffused shadow or nothing
- Don't use borders on cards or containers â€” Apple almost never uses visible borders (except on specific buttons)
- Don't apply wide letter-spacing to SF Pro â€” it is designed to run tight at every size
- Don't use weight 800 or 900 â€” the maximum is 700 (bold), and even that is rare
- Don't add textures, patterns, or gradients to backgrounds â€” solid colors only
- Don't make the navigation opaque â€” the glass blur effect is essential to the Apple UI identity
- Don't center-align body text â€” Apple body copy is left-aligned; only headlines center
...
### Collapsing Strategy
- Hero headlines: 56px Display â†’ 40px â†’ 28px on mobile, maintaining tight line-height proportionally
- Product grids: 3-column â†’ 2-column â†’ single column stacked
- Navigation: full horizontal nav â†’ compact mobile menu (hamburger)
- Product hero modules: full-bleed maintained at all sizes, text scales down
- Section backgrounds: maintain full-width color blocks at all breakpoints â€” the cinematic rhythm never breaks
- Image sizing: products scale proportionally, never crop â€” the product silhouette is sacred
...
### Iteration Guide
1. Every interactive element gets Apple Blue (`#0071e3`) â€” no other accent colors
2. Section backgrounds alternate: black for immersive moments, `#f5f5f7` for informational moments
3. Typography optical sizing: SF Pro Display at 20px+, SF Pro Text below â€” never mix
4. Negative letter-spacing at all sizes: -0.28px at 56px, -0.374px at 17px, -0.224px at 14px, -0.12px at 12px
5. The navigation glass effect (translucent dark + blur) is non-negotiable â€” it defines the Apple web experience
6. Products always appear on solid color fields â€” never on gradients, textures, or lifestyle backgrounds in hero modules
7. Shadow is rare and always soft: `3px 5px 30px 0.22 opacity` or nothing at all
8. Pill CTAs use 980px radius â€” this creates the signature Apple rounded-rectangle-that-looks-like-a-capsule shape
