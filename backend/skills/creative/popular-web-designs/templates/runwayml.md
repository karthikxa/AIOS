...
- Zero shadows, minimal borders â€” the interface is intentionally invisible
...
- Weight 450 (unusual intermediate) for small uppercase text â€” precision craft
...
### Surface & Background
- **Near White** (`#fefefe`): The lightest surface â€” barely distinguishable from pure white.
- **Cool Cloud** (`#e9ecf2`): Light section backgrounds with a cool blue-gray tint.
- **Border Dark** (`#27272a`): The single dark-mode border color â€” barely visible containment.
...
- **Cool Slate** (`#767d88`): Secondary body text â€” a distinctly blue-gray cool neutral.
...
- **Dark Link** (`#0c0c0c`): Darkest link text â€” nearly black.
- **Footer Gray** (`#999999`): Footer links and deeply muted content.

### Gradient System
- **None in the interface.** Visual richness comes entirely from photographic content â€” AI-generated and enhanced imagery provides all the color and gradient the design needs. The interface itself is intentionally colorless.
...
| Section Heading | abcNormal | 40px (2.5rem) | 400 | 1.00â€“1.10 | -1px to 0px | Feature section titles |
...
| Body / Button | abcNormal | 16px (1rem) | 400â€“600 | 1.30â€“1.50 | -0.16px to normal | Standard body, nav links |
| Caption / Label | abcNormal | 14px (0.88rem) | 500â€“600 | 1.25â€“1.43 | 0.35px (uppercase) | Metadata, section labels |
...
- **Tight everywhere**: Nearly every size uses line-height 1.0â€“1.30 â€” even body text is relatively compressed. This creates a dense, editorial feel.
- **Weight 450 â€” the precision detail**: Some small uppercase labels use weight 450, an uncommon intermediate between regular (400) and medium (500). This micro-craft signals typographic sophistication.
...
- The button design is extremely restrained â€” no heavy fills or borders detected
- Interactive elements blend into the editorial flow

### Cards & Containers
- Background: transparent or Dark Surface (`#1a1a1a`)
- Border: `1px solid #27272a` (dark mode) â€” barely visible containment
- Radius: small (4â€“8px) for functional elements; 16px for alert-style containers
- Shadow: zero â€” no shadows on any element
- Cards are primarily photographic â€” the image IS the card

### Navigation
- Minimal horizontal nav â€” transparent over hero content
- Logo: Runway wordmark in white/black
- Links: abcNormal at 16px, weight 400â€“600
- Hover: text shifts to white or higher opacity
- Extremely subtle â€” designed to not compete with visual content
...
- The image is always cinematic quality â€” film-grade composition
...
- The emotional close â€” artistic and philosophical
...
- Section vertical spacing: generous (48â€“78px)
- Component gaps: 16â€“24px
...
- **Editorial grid asymmetry**: The image grid uses intentionally varied sizes â€” large hero images paired with smaller supporting images, creating visual rhythm.
...
| Level | Treatment | Use |
|-------|-----------|-----|
| Flat (Level 0) | No shadow, no border | Everything â€” the dominant state |
...
**Shadow Philosophy**: Runway uses **zero shadows**. This is a film-production design decision â€” in cinema, depth comes from lighting, focus, and composition, not drop shadows. The interface mirrors this philosophy: depth is communicated through dark/light section alternation, photographic depth-of-field, and overlay transparency â€” never through CSS box-shadow.

## 7. Do's and Don'ts

### Do
- Use full-bleed cinematic photography as the primary visual element
- Use abcNormal for all text â€” maintain the single-typeface commitment
...
- Maintain zero shadows â€” depth comes from photography and section backgrounds
- Use uppercase with letter-spacing for navigational labels (14px, 0.35px spacing)
- Apply small border-radius (4â€“8px) â€” the design is NOT pill-shaped
- Let visual content (photos, videos) dominate â€” the UI should be invisible
- Use weight 450 for micro labels â€” the precision matters

### Don't
- Don't add decorative colors to the interface â€” the only color comes from photography
- Don't use heavy borders or shadows â€” the interface must be nearly invisible
- Don't use pill-shaped radius â€” Runway's geometry is subtly rounded, not circular
- Don't use bold (700+) weight â€” 400â€“600 is the full range, with 450 as a precision tool
- Don't compete with the visual content â€” text overlays should be minimal and restrained
- Don't use gradient backgrounds in the interface â€” gradients exist only in photography
- Don't use more than one typeface â€” abcNormal handles everything
- Don't use body line-height above 1.50 â€” the tight, editorial feel is core
- Don't reduce image quality â€” cinematic photography IS the design
...
| Tablet | 640â€“768px | 2-column image grids begin |
| Small Desktop | 768â€“1024px | Standard layout |
| Desktop | 1024â€“1280px | Full layout, expanded hero |
| Large Desktop | 1280â€“1600px | Maximum cinema-width container |
...
- **Image grids**: Multi-column â†’ 2-column â†’ single column
- **Research articles**: Feature-size cards â†’ stacked full-width
...
### Iteration Guide
1. Visual content first â€” always include cinematic photography
2. Use abcNormal for everything â€” specify size and weight, never change the font
3. Keep the interface invisible â€” no heavy borders, no shadows, no bright colors
4. Use the cool slate grays (#767d88, #7d848e) for secondary text â€” not warm grays
5. Uppercase labels need letter-spacing (0.35px) â€” never tight uppercase
6. Dark sections should be truly dark (#000000 or #1a1a1a) â€” no medium grays as surfaces
