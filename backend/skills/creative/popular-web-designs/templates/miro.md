...
- Generous border-radius: 8pxâ€“50px range
...
### Font Families
- **Display**: `Roobert PRO Medium`, fallback: Placeholder â€” `"blwf", "cv03", "cv04", "cv09", "cv11"`
- **Display Variants**: `Roobert PRO SemiBold`, `Roobert PRO SemiBold Italic`, `Roobert PRO`
- **Body**: `Noto Sans` â€” `"liga" 0, "ss01", "ss04", "ss05"`
...
| Body Standard | Noto Sans | 16px | 400â€“600 | 1.50 | -0.16px |
...
### Cards: 12pxâ€“24px radius, pastel backgrounds
### Inputs: white bg, `1px solid #e9eaef`, 8px radius, 16px padding

## 5. Layout Principles
- Spacing: 1â€“24px base scale
- Radius: 8px (buttons), 10pxâ€“12px (cards), 20pxâ€“24px (panels), 40pxâ€“50px (large containers)
- Ring shadow: `rgb(224,226,232) 0px 0px 0px 1px`

## 6. Depth & Elevation
Minimal â€” ring shadow + pastel surface contrast
