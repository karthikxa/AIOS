...
**Key Characteristics:**
- Warm dark background â€” not cold black, but earthy near-black with warm gray undertones
- Warm Parchment (`#faf9f6`) text instead of pure white â€” subtle cream warmth
- Matter font family (Regular weight) â€” geometric but approachable, not the typical developer-tool typeface
- Nature photography interleaved with product screenshots â€” lifestyle meets developer tool
- Almost monochromatic warm gray palette â€” no bold accent colors
- Uppercase labels with wide letter-spacing (2.4px) for categorization â€” editorial signaling
- Pill-shaped dark buttons (`#353534`, 50px radius) â€” restrained, muted CTAs

## 2. Color Palette & Roles

### Primary
- **Warm Parchment** (`#faf9f6`): Primary text color â€” a barely-cream off-white that softens every surface
- **Earth Gray** (`#353534`): Button backgrounds, dark interactive surfaces â€” warm, not cold
- **Deep Void** (near-black, page background): The warm dark canvas derived from the body background

### Secondary & Accent
- **Stone Gray** (`#868584`): Secondary text, muted descriptions â€” warm mid-gray
- **Ash Gray** (`#afaeac`): Body text, button text â€” the workhorse reading color
- **Purple-Tint Gray** (`#666469`): Link text with subtle purple undertone â€” underlined links in content
...
### Semantic & Accent
- Warp operates as an almost monochromatic system â€” no bold accent colors
...
### Font Family
- **Display & Body**: `Matter Regular` â€” geometric sans-serif with soft character. Fallbacks: `Matter Regular Placeholder`, system sans-serif
- **Medium**: `Matter Medium` â€” weight 500 variant for emphasis. Fallbacks: `Matter Medium Placeholder`
- **Square**: `Matter SQ Regular` â€” squared variant for select display contexts. Fallbacks: `Matter SQ Regular Placeholder`
- **UI Supplement**: `Inter` â€” used for specific UI elements. Fallbacks: `Inter Placeholder`
- **Monospace Display**: `Geist Mono` â€” for code/terminal display headings
- **Monospace Body**: `Matter Mono Regular` â€” custom mono companion. Fallbacks: `Matter Mono Regular Placeholder`
...
### Principles
- **Regular weight dominance**: Nearly all text uses weight 400 (Regular) â€” even headlines. Matter Medium (500) appears only for emphasis moments like card titles and buttons. This creates a remarkably even, calm typographic texture
- **Uppercase as editorial signal**: Small labels and categories use uppercase transform with wide letter-spacing (1.4pxâ€“2.4px), creating a magazine-editorial categorization system
...
- **No bold display**: Zero use of bold (700+) weight anywhere â€” restraint is the philosophy

## 4. Component Stylings

### Buttons
- **Dark Pill**: `#353534` background, Ash Gray (`#afaeac`) text, pill shape (50px radius), `10px` padding. The primary CTA â€” warm, muted, understated
...
- **Hover**: Subtle opacity or brightness shift â€” no dramatic color changes

### Cards & Containers
- **Photography Cards**: Full-bleed nature imagery with overlay text, 8pxâ€“12px border-radius
- **Terminal Screenshot Cards**: Product UI embedded in dark containers with rounded corners (8pxâ€“12px)
- **Bordered Cards**: Semi-transparent border (`rgba(226, 226, 226, 0.35)`) for containment, 12pxâ€“14px radius
- **Hover**: Minimal â€” content cards don't dramatically change on hover, maintaining the calm aesthetic
...
- **CTA button**: Dark pill (#353534) at nav end â€” restrained, not attention-grabbing
- **Mobile**: Collapses to simplified navigation
- **Sticky**: Nav stays fixed on scroll

### Image Treatment
- **Nature photography**: Landscapes, forests, golden-hour scenes â€” completely unique for a developer tool
...
- **Vast and warm**: Generous spacing between sections â€” the dark background creates a warm void that feels contemplative rather than empty
- **Photography as whitespace**: Nature images serve as visual breathing room between dense product information
- **Editorial pacing**: The layout reads like a magazine â€” each section is a deliberate page-turn moment

### Border Radius Scale
- **4px**: Small interactive elements â€” buttons, tags
- **5pxâ€“6px**: Standard components â€” links, small containers
...
- **50px**: Pill buttons â€” primary CTAs
- **200px**: Progress bars â€” full pill shape
...
### Shadow Philosophy
Warp's elevation system is remarkably flat â€” almost zero shadow usage on the marketing site. Depth is communicated through:
- **Semi-transparent borders** instead of shadows â€” borders at 35% opacity create a ghostly containment
- **Photography layering** â€” images create natural depth without artificial shadows
- **Surface opacity shifts** â€” `rgba(255, 255, 255, 0.04)` overlays create barely-perceptible layer differences
- The effect is calm and grounded â€” nothing floats, everything rests
...
### Do
- Use warm off-white (`#faf9f6`) for text instead of pure white â€” the cream undertone is essential
- Keep buttons restrained and muted â€” dark fill (#353534) with muted text (#afaeac), no bright CTAs
- Apply Matter Regular (weight 400) for nearly everything â€” even headlines. Reserve Medium (500) for emphasis only
- Use uppercase labels with wide letter-spacing (1.4pxâ€“2.4px) for categorization
- Interleave nature photography with product screenshots â€” this is core to the brand identity
- Maintain the almost monochromatic warm gray palette â€” no bold accent colors
...
### Don't
- Use pure white (#ffffff) for text â€” it's always warm parchment (#faf9f6)
- Add bold accent colors (blue, red, green) â€” the system is deliberately monochromatic warm grays
- Apply bold weight (700+) to any text â€” Warp never goes above Medium (500)
- Use heavy drop shadows â€” depth comes from borders, photography, and opacity shifts
- Create cold or blue-tinted dark backgrounds â€” the warmth is essential
- Add decorative gradients or glow effects â€” the photography provides all visual interest
- Use tight, compressed layouts â€” the editorial spacing is generous and contemplative
...
| Tablet | 810pxâ€“1500px | 2-column features begin, photography scales, nav links partially visible |
| Desktop | >1500px | Full cinematic layout, 80px hero display, side-by-side photography + text |

### Touch Targets
- Pill buttons: 50px radius with 10px padding â€” comfortable touch targets
...
### Collapsing Strategy
- **Navigation**: Full horizontal nav â†’ simplified mobile navigation
- **Hero text**: 80px display â†’ 56px â†’ 48px across breakpoints
- **Feature sections**: Side-by-side photography + text â†’ stacked vertically
- **Photography**: Scales within containers, maintains cinematic aspect ratios
- **Section spacing**: Reduces proportionally â€” generous desktop â†’ compact mobile
...
- No art direction changes â€” same compositions across breakpoints
...
- "Build a category label using Matter Regular at 12px, uppercase transform, letter-spacing 2.4px, stone gray (#868584) color â€” editorial magazine style"
...
1. Verify text color is warm parchment (#faf9f6) not pure white â€” the warmth is subtle but essential
2. Ensure all buttons use the restrained dark palette (#353534) â€” no bright or colorful CTAs
3. Check that Matter Regular (400) is the default weight â€” Medium (500) only for emphasis
4. Confirm uppercase labels have wide letter-spacing (1.4pxâ€“2.4px) â€” tight uppercase feels wrong here
5. The overall tone should feel warm and calm, like a well-designed magazine â€” not aggressive or tech-flashy
