...
Color is used with extreme restraint â€” the interface is almost entirely black-and-white with cool gray borders (`#d9d9dd`, `#e5e7eb`). Purple-violet appears only in photographic hero bands, gradient sections, and the interactive blue (`#1863dc`) that signals hover and focus states. This chromatic restraint means that when color DOES appear â€” in product screenshots, enterprise photography, and the deep purple section â€” it carries maximum visual weight.

**Key Characteristics:**
- Bright white canvas with cool gray containment borders
- 22px signature border-radius â€” the distinctive "Cohere card" roundness
...
- **Near Black** (`#212121`): Standard body link color â€” slightly softer than pure black.
- **Deep Dark** (`#17171c`): A blue-tinted near-black for navigation and dark-section text.

### Secondary & Accent
- **Interaction Blue** (`#1863dc`): The primary interactive accent â€” appears on button hover, focus states, and active links. The sole chromatic action color.
- **Ring Blue** (`#4c6ee6` at 50%): Tailwind ring color for keyboard focus indicators.
- **Focus Purple** (`#9b60aa`): Input focus border color â€” a muted violet.
...
### Neutrals & Text
- **Muted Slate** (`#93939f`): De-emphasized footer links and tertiary text â€” a cool-toned gray with a slight blue-violet tint.
- **Border Cool** (`#d9d9dd`): Standard section and list-item borders â€” a cool, slightly purple-tinted gray.
- **Border Light** (`#e5e7eb`): Lighter border variant â€” Tailwind's standard gray-200.
...
### Principles
- **Serif for declaration, sans for utility**: CohereText carries the brand voice at display scale â€” its serif terminals give headlines the authority of published research. Unica77 handles everything functional with Swiss-geometric neutrality.
- **Negative tracking at scale**: CohereText uses -1.2px to -1.44px letter-spacing at 60â€“72px, creating dense, impactful text blocks.
...
- **Uppercase code labels**: CohereMono uses uppercase with positive letter-spacing (0.16â€“0.28px) for technical tags and section markers.
...
- The primary button style â€” invisible until interacted with
...
- Radius: **22px** â€” the signature Cohere radius for primary cards, images, and dialog containers. Also 4px, 8px, 16px, 20px for smaller elements
- Shadow: minimal â€” Cohere relies on background color and borders rather than shadows
...
- Focus shadow: red ring (`rgb(179, 0, 0) 0px 0px 0px 2px`) â€” likely for error state indication
...
- Creates a cloud-like, organic softness that's distinctive from the typical 8â€“12px
...
- Section vertical spacing: generous (56â€“60px between sections)
...
- 26 breakpoints detected â€” extremely granular responsive system
...
- Signature (22px): Primary cards, hero images, main containers â€” THE Cohere radius
...
### Do
- Use 22px border-radius on all primary cards and containers â€” it's the visual signature
...
### Don't
- Don't use border-radius other than 22px on primary cards â€” the signature radius matters
- Don't introduce warm colors â€” the palette is strictly cool-toned
- Don't use heavy shadows â€” depth comes from color contrast and borders
- Don't use bold (700+) weight on body text â€” 400â€“500 is the range
- Don't skip the serif/sans hierarchy â€” CohereText for headlines, Unica77 for body
- Don't use purple as a surface color for cards â€” purple is reserved for full-width sections
- Don't reduce section spacing below 40px â€” enterprise layouts need breathing room
- Don't use decoration on buttons by default â€” ghost/transparent is the base state
...
| Mobile | 425â€“640px | Single column, stacked cards |
| Large Mobile | 640â€“768px | Minor spacing adjustments |
| Tablet | 768â€“1024px | 2-column grids begin |
| Desktop | 1024â€“1440px | Full multi-column layout |
| Large Desktop | 1440â€“2560px | Maximum container width |

*26 breakpoints detected â€” one of the most granularly responsive sites in the dataset.*
...
- **Feature grids**: Multi-column â†’ 2-column â†’ single column
- **Hero text**: 72px â†’ 48px â†’ 32px progressive scaling
- **Purple sections**: Maintain full-width, content stacks
- **Card grids**: 3 â†’ 2 â†’ 1 column
...
2. Always use 22px radius for primary cards â€” "the Cohere card roundness"
3. Specify the typeface â€” CohereText for headlines, Unica77 for body, CohereMono for labels
4. Interactive elements use Interaction Blue (#1863dc) on hover only
5. Keep surfaces white with cool gray borders â€” no warm tones
