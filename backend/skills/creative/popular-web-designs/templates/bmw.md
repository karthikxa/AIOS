...
BMW's website is automotive engineering made visual â€” a design system that communicates precision, performance, and German industrial confidence. The page alternates between deep dark hero sections (featuring full-bleed automotive photography) and clean white content areas, creating a cinematic rhythm reminiscent of a luxury car showroom where vehicles are lit against darkness. The BMW CI2020 design language (their corporate identity refresh) defines every element.

The typography is built on BMWTypeNextLatin â€” a proprietary typeface in two variants: BMWTypeNextLatin Light (weight 300) for massive uppercase display headings, and BMWTypeNextLatin Regular for body and UI text. The 60px uppercase headline at weight 300 is the defining typographic gesture â€” light-weight type that whispers authority rather than shouting it. The fallback stack includes Helvetica and Japanese fonts (Hiragino, Meiryo), reflecting BMW's global presence.

What makes BMW distinctive is its CSS variable-driven theming system. Context-aware variables (`--site-context-highlight-color: #1c69d4`, `--site-context-focus-color: #0653b6`, `--site-context-metainfo-color: #757575`) suggest a design system built for multi-brand, multi-context deployment where colors can be swapped globally. The blue highlight color (`#1c69d4`) is BMW's signature blue â€” used sparingly for interactive elements and focus states, never decoratively. Zero border-radius was detected â€” BMW's design is angular, sharp-cornered, and uncompromisingly geometric.

**Key Characteristics:**
- BMWTypeNextLatin Light (weight 300) uppercase for display â€” whispered authority
- BMW Blue (`#1c69d4`) as singular accent â€” used only for interactive elements
- Zero border-radius detected â€” angular, sharp-cornered, industrial geometry
- Dark hero photography + white content sections â€” showroom lighting rhythm
- CSS variable-driven theming: `--site-context-*` tokens for brand flexibility
- Weight 900 for navigation emphasis â€” extreme contrast with 300 display
- Tight line-heights (1.15â€“1.30) throughout â€” compressed, efficient, German engineering
...
### Interactive States
- All links hover to white (`#ffffff`) â€” suggesting primarily dark-surface navigation
- Text links use underline: none on hover â€” clean interaction

### Shadows
- Minimal shadow system â€” depth through photography and dark/light section contrast
...
| Button Bold | BMWTypeNextLatin | 16px (1.00rem) | 700 | 1.20â€“2.88 | CTA buttons |
...
- **Universal uppercase display**: The 60px hero is always uppercase â€” creating a monumental, architectural quality.
- **Tight everything**: Line-heights from 1.15 to 1.30 across the entire system. Nothing breathes â€” every line is compressed, efficient, German-engineered.
- **Single font family**: BMWTypeNextLatin handles everything from 60px display to 16px body â€” unity through one typeface at different weights.

## 4. Component Stylings

### Buttons
- Text: 16px BMWTypeNextLatin, weight 700 for primary, 400 for secondary
- Line-height: 1.15â€“2.88 (large variation suggests padding-driven sizing)
- Border: white bottom-border on dark surfaces (`1px solid #ffffff`)
- No border-radius â€” sharp rectangular buttons

### Cards & Containers
- No border-radius â€” all containers are sharp-cornered rectangles
...
- **Compressed content**: Body text areas use tight line-heights and compact spacing â€” information-dense, no waste.

### Border Radius Scale
- **None detected.** BMW uses sharp corners exclusively â€” every element is a precise rectangle. This is the most angular design system analyzed.
...
**Shadow Philosophy**: BMW uses virtually no shadows. Depth is created entirely through the contrast between dark photographic sections and white content sections â€” the automotive lighting does the elevation work.

## 7. Do's and Don'ts

### Do
- Use BMWTypeNextLatin Light (300) uppercase for all display headings
- Keep ALL corners sharp (0px radius) â€” angular geometry is non-negotiable
- Use BMW Blue (`#1c69d4`) only for interactive elements â€” never decoratively
- Apply weight 900 for navigation emphasis â€” the extreme weight contrast is intentional
- Use full-bleed automotive photography for hero sections
- Keep line-heights tight (1.15â€“1.30) throughout
- Use `--site-context-*` CSS variables for theming

### Don't
- Don't round corners â€” zero radius is the BMW identity
- Don't use BMW Blue for backgrounds or large surfaces â€” it's an accent only
- Don't use medium font weights (500â€“600) â€” the system uses 300, 400, 700, 900 extremes
- Don't add decorative elements â€” the photography and typography carry everything
- Don't use relaxed line-heights â€” BMW text is always compressed
- Don't lighten the dark hero sections â€” the contrast with white IS the design
...
| Mobile | 375â€“480px | Single column |
| Mobile Large | 480â€“640px | Slight adjustments |
| Tablet Small | 640â€“768px | 2-column begins |
| Tablet | 768â€“920px | Standard tablet |
| Desktop Small | 920â€“1024px | Desktop layout begins |
| Desktop | 1024â€“1280px | Standard desktop |
| Large Desktop | 1280â€“1440px | Expanded |
| Ultra-wide | 1440â€“1600px | Maximum layout |

### Collapsing Strategy
- Hero: 60px â†’ scales down, maintains uppercase
- Navigation: horizontal â†’ hamburger
- Photography: full-bleed maintained at all sizes
- Content sections: stack vertically
- Footer: multi-column â†’ stacked
...
### Iteration Guide
1. Zero border-radius â€” every corner is sharp, no exceptions
2. Weight extremes: 300 (display), 400 (body), 700 (buttons), 900 (nav)
3. BMW Blue for interactive only â€” never as background or decoration
4. Photography carries emotion â€” the UI is pure precision
5. Tight line-heights everywhere â€” 1.15 to 1.30 is the range
