...
- WF Visual Sans Variable â€” custom variable font with weight 500â€“600
- Rich secondary palette: purple `#7a3dff`, pink `#ed52cb`, green `#00d722`, orange `#ff6b00`, yellow `#ffae13`, red `#ee1d36`
- Conservative 4pxâ€“8px border-radius â€” sharp, not rounded
- Multi-layer shadow stacks (5-layer cascading shadows)
- Uppercase labels: 10pxâ€“15px, weight 500â€“600, wide letter-spacing (0.6pxâ€“1.5px)
...
| Feature Title | 24px | 500â€“600 | 1.30 | normal | |
| Body | 20px | 400â€“500 | 1.40â€“1.50 | normal | |
| Body Standard | 16px | 400â€“500 | 1.60 | -0.16px | |
| Button | 16px | 500 | 1.60 | -0.16px | |
| Uppercase Label | 15px | 500 | 1.30 | 1.5px | uppercase |
| Caption | 14px | 400â€“500 | 1.40â€“1.60 | normal | |
| Badge Uppercase | 12.8px | 550 | 1.20 | normal | uppercase |
| Micro Uppercase | 10px | 500â€“600 | 1.30 | 1px | uppercase |
...
### Cards: `1px solid #d8d8d8`, 4pxâ€“8px radius
...
- Radius: 2px, 4px, 8px, 50% â€” conservative, sharp
- Breakpoints: 479px, 768px, 992px

## 6. Depth: 5-layer cascading shadow system

## 7. Do's and Don'ts
- Do: Use WF Visual Sans Variable at 500â€“600. Blue (#146ef5) for CTAs. 4px radius. translate(6px) hover.
