...
Revolut's website is fintech confidence distilled into pixels â€” a design system that communicates "your money is in capable hands" through massive typography, generous whitespace, and a disciplined neutral palette. The visual language is built on Aeonik Pro, a geometric grotesque that creates billboard-scale headlines at 136px with weight 500 and aggressive negative tracking (-2.72px). This isn't subtle branding; it's fintech at stadium scale.

The color system is built on a comprehensive `--rui-*` (Revolut UI) token architecture with semantic naming for every state: danger (`#e23b4a`), warning (`#ec7e00`), teal (`#00a87e`), blue (`#494fdf`), deep-pink (`#e61e49`), and more. But the marketing surface itself is remarkably restrained â€” near-black (`#191c1f`) and pure white (`#ffffff`) dominate, with the colorful semantic tokens reserved for the product interface, not the marketing page.

What distinguishes Revolut is its pill-everything button system. Every button uses 9999px radius â€” primary dark (`#191c1f`), secondary light (`#f4f4f4`), outlined (`transparent + 2px solid`), and ghost on dark (`rgba(244,244,244,0.1) + 2px solid`). The padding is generous (14px 32pxâ€“34px), creating large, confident touch targets. Combined with Inter for body text at various weights and positive letter-spacing (0.16pxâ€“0.24px), the result is a design that feels both premium and accessible â€” banking for the modern era.

**Key Characteristics:**
- Aeonik Pro display at 136px weight 500 â€” billboard-scale fintech headlines
...
- Inter for body text with positive letter-spacing (0.16pxâ€“0.24px)
- Rich semantic color system: blue, teal, pink, yellow, green, brown, danger, warning
- Zero shadows detected â€” depth through color contrast only
- Tight display line-heights (1.00) with relaxed body (1.50â€“1.56)
...
### Font Families
- **Display**: `Aeonik Pro` â€” geometric grotesque, no detected fallbacks
- **Body / UI**: `Inter` â€” standard system sans
...
### Principles
- **Weight 500 as display default**: Aeonik Pro uses medium (500) for ALL headings â€” no bold. This creates authority through size and tracking, not weight.
- **Billboard tracking**: -2.72px at 136px is extremely compressed â€” text designed to be read at a glance, like airport signage.
...
- No shadows â€” flat surfaces with color contrast
...
- Large section spacing: 80pxâ€“120px
...
| Level | Treatment | Use |
|-------|-----------|-----|
| Flat (Level 0) | No shadow | Everything â€” Revolut uses zero shadows |
...
- Apply 9999px radius to all buttons â€” pill shape is universal
...
### Don't
- Don't use shadows â€” Revolut is flat by design
- Don't use bold (700) for Aeonik Pro headings â€” 500 is the weight
- Don't use small buttons â€” the generous padding is intentional
- Don't apply semantic colors to marketing surfaces â€” they're for the product
...
| Mobile | 400â€“720px | Standard mobile |
| Tablet | 720â€“1024px | 2-column layouts |
| Desktop | 1024â€“1280px | Standard desktop |
| Large | 1280â€“1920px | Full layout |
...
### Iteration Guide
1. Aeonik Pro 500 for headings â€” never bold
2. All buttons are pills (9999px) with generous padding
3. Zero shadows â€” flat is the Revolut identity
