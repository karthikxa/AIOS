...
- Sharp 4px border-radius â€” near-rectangular buttons and elements
- Scale(1.1) hover with scale(0.85) active â€” physical button interaction
- SaansMono uppercase labels with wide tracking (0.6pxâ€“1.2px)
...
| Mono Label | SaansMono | 12px | 400â€“500 | 1.00â€“1.30 | 0.6pxâ€“1.2px uppercase |
...
- Apply 4px radius on buttons â€” sharp geometry is the identity
...
- Don't use cool gray borders â€” always warm oat tones
