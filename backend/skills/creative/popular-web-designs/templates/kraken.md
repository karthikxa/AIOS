...
- Subtle shadows (`rgba(0,0,0,0.03) 0px 4px 24px`) â€” whisper-level
...
- **Purple Subtle** (`rgba(133,91,251,0.16)`): Purple at 16% â€” subtle button backgrounds
...
| Button | Kraken-Product | 16px | 500â€“600 | 1.38 | normal |
| Caption | Kraken-Product | 14px | 400â€“700 | 1.43â€“1.71 | normal |
| Small | Kraken-Product | 12px | 400â€“500 | 1.33 | normal |
...
### Don't
- Don't use pill buttons â€” 12px is the max radius for buttons
