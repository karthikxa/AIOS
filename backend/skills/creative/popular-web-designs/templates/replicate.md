...
### Primary
- **Replicate Dark** (`#202020`): The primary text color and dark surface â€” a near-black that's the anchor of all text and borders. Slightly warmer than pure #000.
- **Replicate Red** (`#ea2804`): The core brand color â€” a vivid, saturated orange-red used in the hero gradient, accent borders, and high-signal moments.
...
- **Hero Gradient**: A dramatic orange â†’ red â†’ magenta â†’ pink gradient for the hero section. Transitions from warm (#ea2804 family) through hot pink.
...
### Gradient System
- **Hero Blaze**: A dramatic multi-stop gradient flowing through orange (`#ea2804`) â†’ red â†’ magenta â†’ hot pink. This gradient occupies the full hero section and is the most visually dominant element on the page.
...
| Section Heading | rb-freigeist-neue | 48px (3rem) | 400â€“700 | 1.00 (tight) | normal | Feature section titles |
...
| Body / Button | basier-square | 16â€“18px (1â€“1.13rem) | 400â€“600 | 1.50â€“1.56 | normal | Standard text, buttons |
| Caption | basier-square | 14px (0.88rem) | 400â€“600 | 1.43 | -0.35px to normal | Metadata, descriptions |
...
- **128px is a real size**: The closing manifesto "Imagine what you can build." uses 128px â€” bigger than most mobile screens. This is the design equivalent of shouting from a rooftop.
- **Negative tracking on hero**: -1.8px letter-spacing at 72px creates dense, impactful hero text.
- **Lowercase tags**: 12px basier-square uses `text-transform: lowercase` â€” an unusual choice that creates a casual, developer-friendly vibe.
- **Weight 600 as emphasis**: When basier-square needs emphasis, it uses 600 (semibold) â€” never bold (700), which is reserved for rb-freigeist-neue display text.
...
- Maximum emphasis â€” dark pill on light surface
...
- Text: Replicate Dark (`#202020`)
- Padding: 6px 56px 6px 28px (asymmetric â€” icon/search layout)
- Border: transparent
...
- Section vertical spacing: very generous (96â€“192px)
...
### Do
- Use pill-shaped (9999px) radius on EVERYTHING â€” buttons, images, badges, containers
- Use rb-freigeist-neue at weight 700 for display text â€” go big (72px+) or go home
- Use the orange-red brand gradient for hero sections
- Use Replicate Dark (#202020) as the primary dark â€” not pure black
- Apply dotted underline decoration on text links (#bbbbbb)
- Use Status Green (#2b9a66) for operational/success badges
- Keep body text in basier-square at 400â€“600 weight
- Use JetBrains Mono for all code content
- Create a "manifesto" section with 128px type for emotional impact

### Don't
- Don't use any border-radius other than 9999px â€” the pill system is absolute
- Don't use the brand red (#ea2804) as a surface/background color â€” it's for gradients and accent borders
- Don't reduce display text below 48px on desktop â€” the heavy display font needs size to breathe
- Don't use light/thin font weights on rb-freigeist-neue â€” 600â€“700 is the range
- Don't use solid underlines on links â€” dotted is the signature
- Don't add drop shadows â€” depth comes from borders and background color
- Don't use warm neutrals â€” the gray scale is purely neutral (#202020 â†’ #bbbbbb)
- Don't skip the code examples â€” they're primary content, not decoration
- Don't make the hero gradient subtle â€” it should be BOLD and vibrant

## 8. Responsive Behavior

### Breakpoints
*No explicit breakpoints detected â€” likely using fluid/container-query responsive system.*
...
### Collapsing Strategy
- **Hero text**: 128px â†’ 72px â†’ 48px progressive scaling
...
### Iteration Guide
1. Everything is pill-shaped â€” never specify any other border-radius
2. Display text is HEAVY â€” weight 700, sizes 48px+
3. Links use dotted underline (#bbbbbb) â€” never solid
4. The gradient hero is the visual anchor â€” make it bold
