...
Together AI's interface is a pastel-gradient dreamscape built for enterprise AI infrastructure â€” a design that somehow makes GPU clusters and model inference feel light, airy, and optimistic. The hero section blooms with soft pink-blue-lavender gradients and abstract, painterly illustrations that evoke clouds and flight, establishing a visual metaphor for the "AI-Native Cloud" proposition. Against this softness, the typography cuts through with precision: "The Future" display font at 64px with aggressive negative tracking (-1.92px) creates dense, authoritative headline blocks.

The design straddles two worlds: a bright, white-canvas light side where pastel gradients and stats cards create an approachable platform overview, and a dark navy universe (`#010120` â€” not gray-black but a deep midnight blue) where research papers and technical content live. This dual-world approach elegantly separates the "business" messaging (light, friendly, stat-driven) from the "research" messaging (dark, serious, academic).

What makes Together AI distinctive is its type system. "The Future" handles all display and body text with a geometric modernist aesthetic, while "PP Neue Montreal Mono" provides uppercase labels with meticulous letter-spacing â€” creating a "technical infrastructure company with taste" personality. The brand accents â€” magenta (`#ef2cc1`) and orange (`#fc4c02`) â€” appear sparingly in the gradient and illustrations, never polluting the clean UI.

**Key Characteristics:**
- Soft pastel gradients (pink, blue, lavender) against pure white canvas
- Deep midnight blue (`#010120`) for dark/research sections â€” not gray-black
...
- Sharp geometry (4px, 8px radius) â€” not rounded, not pill
...
### Primary
- **Brand Magenta** (`#ef2cc1`): The primary brand accent â€” a vivid pink-magenta used in gradient illustrations and the highest-signal brand moments. Never used as UI chrome.
- **Brand Orange** (`#fc4c02`): The secondary brand accent â€” a vivid orange for gradient endpoints and warm accent moments.
- **Dark Blue** (`#010120`): The primary dark surface â€” a deep midnight blue-black used for research sections, footer, and dark containers. Not gray, not black â€” distinctly blue.
...
- **Dark Blue** (`#010120`): Dark-section backgrounds â€” research, footer, technical content.
...
### Gradient System
- **Pastel Cloud Gradient**: Soft pink â†’ lavender â†’ soft blue gradients in hero illustrations. These appear in abstract, painterly forms â€” clouds, feathers, flowing shapes â€” that create visual warmth without literal meaning.
...
|------|------|------|--------|-------------|----------------|-------|
| Display / Hero | The Future | 64px (4rem) | 400â€“500 | 1.00â€“1.10 (tight) | -1.92px | Maximum impact, dense blocks |
...
| Body Large | The Future | 18px (1.13rem) | 400â€“500 | 1.30 (tight) | -0.18px | Descriptions, sections |
| Body / Button | The Future | 16px (1rem) | 400â€“500 | 1.25â€“1.30 | -0.16px | Standard body, nav, buttons |
| Caption | The Future | 14px (0.88rem) | 400â€“500 | 1.40 | normal | Metadata, descriptions |
| Mono Label | PP Neue Montreal Mono | 16px (1rem) | 500 | 1.00 (tight) | 0.08px | Uppercase section labels |
| Mono Small | PP Neue Montreal Mono | 11px (0.69rem) | 500 | 1.00â€“1.40 | 0.055â€“0.08px | Small uppercase tags |
...
- **Weight 500 as emphasis**: The system uses 400 (regular) and 500 (medium) â€” no bold. Medium weight marks headings and emphasis.
- **Tight line-heights throughout**: Even body text uses 1.25â€“1.30 line-height â€” tighter than typical, creating a dense, information-rich feel.
...
- Used on dark sections â€” subtle, glass-like
...
- Shadow: dark-blue-tinted (`rgba(1, 1, 32, 0.1) 0px 4px 10px`) â€” warm and subtle
...
- Section vertical spacing: generous (80â€“120px)
...
### Border Radius Scale
- Sharp (4px): Buttons, badges, tags, small interactive elements â€” the primary radius
- Comfortable (8px): Larger containers, feature cards

*This is a deliberately restrained radius system â€” no pills, no generous rounding. The sharp geometry contrasts with the soft pastel gradients.*
...
**Shadow Philosophy**: Together AI uses a single, distinctive shadow â€” tinted with Dark Blue (`rgba(1, 1, 32, 0.1)`) rather than generic black. This gives elevated elements a subtle blue-ish cast that ties them to the brand's midnight-blue dark mode. The shadow is soft (10px blur, 4px offset) and always downward â€” creating gentle paper-hover elevation.

## 7. Do's and Don'ts

### Do
- Use pastel gradients (pink/blue/lavender) for hero illustrations and decorative backgrounds
- Use Dark Blue (#010120) for dark sections â€” never generic gray-black
...
- Maintain the light/dark section duality â€” business (light) vs research (dark)
- Show enterprise stats prominently with large display numbers

### Don't
- Don't use Brand Magenta (#ef2cc1) or Brand Orange (#fc4c02) as UI colors â€” they're for illustrations only
- Don't use pill-shaped or generously rounded corners â€” the geometry is sharp
- Don't use generic gray-black for dark sections â€” always Dark Blue (#010120)
- Don't use positive letter-spacing on "The Future" â€” it's always negative
- Don't use bold (700+) weight â€” 400â€“500 is the full range
- Don't use warm-toned shadows â€” always dark-blue-tinted
- Don't reduce section spacing below 48px â€” the open feeling is core
- Don't mix in additional typefaces â€” "The Future" + PP Neue Montreal Mono is the pair
...
| Large Mobile | 479â€“767px | Single column, hamburger nav |
| Tablet | 768â€“991px | 2-column grids begin |
...
- **Stats bar**: Horizontal â†’ stacked vertical
...
- "Create a hero section on white with soft pastel gradients (pink â†’ lavender â†’ blue) as background. Headline at 64px 'The Future' weight 500, line-height 1.10, letter-spacing -1.92px. Pure Black text. Include a dark blue CTA button (#010120, 4px radius)."
...
### Iteration Guide
1. Always specify negative letter-spacing for "The Future" â€” it's scaled by size
...
5. Keep radius sharp (4px or 8px) â€” no pills, no generous rounding
