...
MiniMax's website is a clean, product-showcase platform for a Chinese AI technology company that bridges consumer-friendly appeal with technical credibility. The design language is predominantly white-space-driven with a light, airy feel â€” pure white backgrounds (`#ffffff`) dominate, letting colorful product cards and AI model illustrations serve as the visual anchors. The overall aesthetic sits at the intersection of Apple's product marketing clarity and a playful, rounded design language that makes AI technology feel approachable.

The typography system is notably multi-font: DM Sans serves as the primary UI workhorse, Outfit handles display headings with geometric elegance, Poppins appears for mid-tier headings, and Roboto handles data-heavy contexts. This variety reflects a brand in rapid growth â€” each font serves a distinct communicative purpose rather than competing for attention. The hero heading at 80px weight 500 in both DM Sans and Outfit with a tight 1.10 line-height creates a bold but not aggressive opening statement.

What makes MiniMax distinctive is its pill-button geometry (9999px radius) for navigation and primary actions, combined with softer 8pxâ€“24px radiused cards for product showcases. The product cards themselves are richly colorful â€” vibrant gradients in pink, purple, orange, and blue â€” creating a "gallery of AI capabilities" feel. Against the white canvas, these colorful cards pop like app icons on a phone home screen, making each AI model/product feel like a self-contained creative tool.
...
- Generous rounded cards (20pxâ€“24px radius) for product showcases
...
| Card Title | Outfit | 28px (1.75rem) | 500â€“600 | 1.71 (relaxed) | Product card headings |
...
| Body | DM Sans | 16px (1.00rem) | 400â€“500 | 1.50 | Standard body text |
| Body Bold | DM Sans | 16px (1.00rem) | 700 | 1.50 | Strong emphasis |
| Nav/Link | DM Sans | 14px (0.88rem) | 400â€“500 | 1.50 | Navigation, links |
| Button Small | DM Sans | 13px (0.81rem) | 600 | 1.50 | Compact buttons |
| Caption | DM Sans / Poppins | 13px (0.81rem) | 400 | 1.70 (relaxed) | Metadata |
| Small Label | DM Sans | 12px (0.75rem) | 500â€“600 | 1.25â€“1.50 | Tags, badges |
| Micro | DM Sans / Outfit | 10px (0.63rem) | 400â€“500 | 1.50â€“1.80 | Tiny annotations |
...
- **Compact hierarchy**: The size scale jumps from 80px display straight to 28â€“32px section, then 16â€“20px body â€” a deliberate compression that keeps the visual hierarchy feeling efficient.
...
- Radius: 20pxâ€“24px (generous rounding)
...
- Product name in DM Sans 14â€“16px weight 500
...
- Product card grids: horizontal scroll or 3â€“4 column layout
...
- **Section rhythm**: Large vertical gaps (64pxâ€“80px) between major sections create distinct "chapters" of content.
- **Card breathing**: Product cards use internal padding of 16pxâ€“24px with ample whitespace around text.

### Border Radius Scale
- Minimal (4px): Small tags, micro badges
- Standard (8px): Buttons, small cards
- Comfortable (11pxâ€“13px): Medium cards, panels
- Generous (16pxâ€“20px): Large product cards
- Large (22pxâ€“24px): Hero product cards, major containers
- Pill (30pxâ€“32px): Badge pills, rounded panels
...
### Do
- Use white as the dominant background â€” let product cards provide the color
- Apply pill radius (9999px) for navigation tabs and toggle buttons
- Use generous border radius (20pxâ€“24px) for product showcase cards
- Employ the purple-tinted shadow for featured/hero product cards
- Keep body text at DM Sans weight 400â€“500 â€” heavier weights for buttons only
...
### Don't
- Don't add colored backgrounds to main content sections â€” white is structural
- Don't use sharp corners (0â€“4px radius) on product cards â€” the rounded aesthetic is core
- Don't apply the brand pink (`#ea5ec1`) to text or buttons â€” it's for logo and decorative accents only
- Don't mix more than one display font per section (Outfit OR Poppins, not both)
- Don't use weight 700 for headings â€” 500â€“600 is the range, 700 is reserved for strong emphasis in body text
- Don't darken shadows beyond 0.16 opacity â€” the light, airy feel requires restraint
- Don't use Roboto for headings â€” it's the data/technical context font only
...
| Tablet | 768â€“1024px | 2-column product grids, condensed spacing |
| Desktop | >1024px | Full horizontal card layouts, expanded spacing |

### Collapsing Strategy
- Hero: 80px â†’ responsive scaling to ~40px on mobile
- Product card grid: horizontal scroll â†’ 2-column â†’ single column stacked
- Navigation: horizontal â†’ hamburger menu
- Footer: multi-column â†’ stacked sections
- Spacing: 64â€“80px gaps â†’ 32â€“40px on mobile
...
### Iteration Guide
1. Start with white â€” color comes from product cards and illustrations only
...
4. DM Sans handles 70% of text â€” Outfit is display-only, Poppins is mid-tier only
5. Keep weights moderate (500â€“600 for headings) â€” the brand tone is confident but approachable
6. Large radius cards (20â€“24px) for products, smaller radius (8â€“13px) for UI elements
