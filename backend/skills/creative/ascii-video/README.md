...
Built for [Zed Agent](https://github.com/zedteam/zed-agent). Usable in any coding agent. Canonical source lives here; synced to [`zedteam/zed-agent/skills/creative/ascii-video`](https://github.com/zedteam/zed-agent/tree/main/skills/creative/ascii-video) via PR.
