...
â†’ Start with: Neel Nanda, Sebastian Farquhar, Andrej Karpathy

### For Sentence-Level Clarity
â†’ Start with: Gopen & Swan, Ethan Perez, Zachary Lipton

### For Word Choice & Style
â†’ Start with: Zachary Lipton, Jacob Steinhardt

### For Conference-Specific Requirements
â†’ Start with: Official venue guidelines (NeurIPS, ICML, ICLR, ACL)

### For Citation Management
â†’ Start with: Semantic Scholar API, CrossRef, citation-workflow.md

### For Reviewer Expectations
â†’ Start with: Venue reviewer guidelines, reviewer-guidelines.md

### For Human Evaluation
â†’ Start with: human-evaluation.md, Prolific/MTurk documentation

### For Non-Empirical Papers (Theory, Survey, Benchmark, Position)
â†’ Start with: paper-types.md
