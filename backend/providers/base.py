...
def _profile_user_agent() -> str:
    """Return a ``zed-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from zed_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"zed-cli/{_ver}"
    except Exception:
        return "zed-cli"
...
class ProviderProfile:
    ...
    # â”€â”€ Human-readable metadata â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    display_name: str = ""       # e.g. "GMI Cloud" â€” shown in picker/labels
    description: str = ""        # e.g. "GMI Cloud (multi-model direct API)" â€” picker subtitle
    signup_url: str = ""         # e.g. "https://www.gmicloud.ai/" â€” shown during setup
    ...
    supports_health_check: bool = True  # False â†’ doctor skips /models probe for this provider

    # â”€â”€ Vision support â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ Model catalog â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    # fallback_models: curated list shown in /model picker when live fetch fails.
    # Only agentic models that support tool calling should appear here.
    fallback_models: tuple = ()

    # hostname: base hostname for URLâ†’provider reverse-mapping in model_metadata.py
    # e.g. "api.gmi-serving.com". Derived from base_url when empty.
    hostname: str = ""

    # â”€â”€ Client-level quirks (set once at client construction) â”€
    default_headers: dict[str, str] = field(default_factory=dict)

    # â”€â”€ Request-level quirks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ Hooks (override in subclass for complex providers) â”€â”€â”€
    ...
    def fetch_models(
        ...
        *,
        ...
        # zed-cli UA so the catalog endpoint is reachable.
