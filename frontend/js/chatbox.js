...
export function initChatBox(onSend) {
  ...
  function renderPopover() {
    ...
    filtered.forEach((item, i) => {
      ...
      row.innerHTML = `
        <span style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">${iconHtml}</span>
