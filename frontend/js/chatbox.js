...
export function initChatBox(onSend) {
  ...
  function renderPopover() {
    ...
    filtered.forEach((item, i) => {
      ...
      row.innerHTML = `
        <span style="width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">${iconHtml}</span>
